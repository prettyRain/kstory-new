...
<html lang="zh-cn">
  ...
  <body>
                 ...
                 <input type="hidden" value="searchForm" id="formId">
                  ...
                  <div class="form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="customerUsername" value="${pageBean.objectBean.customerUsername }">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon">真实姓名</span>
                      <input type="text" class="form-control" name="infoRealname" value="${pageBean.objectBean.infoRealname }">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="input-group">
                      <span class="input-group-addon">手机号</span>
                      <input type="text" class="form-control" name="infoMobile" value="${pageBean.objectBean.infoMobile }">
                    </div>
                  </div>
                  <div class="form-group">
		            <div class="input-group">
		           ...
		           <%--  <label class="control-label col-sm-7">手机验证：</label>
		            ...
		            <div class="input-group">
		            	...
		            	<select class="form-control cate_selector"  name="isMobile">
	                        <option value="" <c:if test="${empty pageBean.objectBean.isMobile }">selected="selected"</c:if>>是否手机验证</option>
	                        <option value="0" <c:if test="${not empty pageBean.objectBean.isMobile && pageBean.objectBean.isMobile==0 }">selected="selected"</c:if>>否</option>
	                        <option value="1" <c:if test="${not empty pageBean.objectBean.isMobile && pageBean.objectBean.isMobile==1 }">selected="selected"</c:if>>是</option>
	                    </select>
		            </div>
		          </div>
		          <div class="form-group">
		            ...
		            <div class="col-sm-15">
		             ...
		             <div class="input-group">
		            	...
		            	<select class="form-control cate_selector"  name="isEmail">
	                        <option value="" <c:if test="${empty pageBean.objectBean.isEmail }">selected="selected"</c:if>>是否邮箱验证</option>
	                        <option value="0" <c:if test="${not empty pageBean.objectBean.isEmail && pageBean.objectBean.isEmail==0 }">selected="selected"</c:if>>否</option>
	                        <option value="1" <c:if test="${not empty pageBean.objectBean.isEmail &&  pageBean.objectBean.isEmail==1 }">selected="selected"</c:if>>是</option>
	                    </select>
		            </div>
		          </div>
		          <div class="form-group">
		            ...
		            <div class="input-group">
		            	...
		            	<select class="form-control cate_selector"  name="isFlag">
	                        <option value="" <c:if test="${empty pageBean.objectBean.isFlag }">selected="selected"</c:if>>选择状态</option>
	                        <option value="0" <c:if test="${not empty pageBean.objectBean.isFlag && pageBean.objectBean.isFlag==0 }">selected="selected"</c:if>>正常</option>
	                        <option value="1" <c:if test="${not empty pageBean.objectBean.isFlag && pageBean.objectBean.isFlag==1 }">selected="selected"</c:if>>冻结</option>
	                    </select>
		            </div>
		          </div>
		          <div class="form-group">
		           <%--  <label class="control-label col-sm-7">账户类型：</label>
		            ...
		            <div class="input-group">
		            	...
		            	<select class="form-control cate_selector"  name="isSeller">
	                        <option value="" <c:if test="${empty pageBean.objectBean.isSeller }">selected="selected"</c:if>>选择类型</option>
	                        <option value="0" <c:if test="${not empty pageBean.objectBean.isSeller && pageBean.objectBean.isSeller==0 }">selected="selected"</c:if>>普通</option>
	                        <option value="1" <c:if test="${not empty pageBean.objectBean.isSeller && pageBean.objectBean.isSeller==1 }">selected="selected"</c:if>>商家</option>
	                    </select>
		            </div>
		          </div>
                  <div class="form-group">
            ...
            <div class="data_ctrl_area mb20">
              ...
              <div class="data_ctrl_brns pull-left">
                ...
                <!-- <button type="button" class="btn btn-info" onclick="$('#setMemberType').modal('show')">
                  ...
                  <button type="button" class="btn btn-info" onclick="addprovince()">
                      补入地址
                  </button>
                <div class="btn-group">
            ...
            <tbody>
              ...
              <c:forEach items="${pageBean.list}" var="customer" varStatus="i">
		            <tr>
		              ...
		              <td>
			              <img class="img_circle" src="<c:if test="${customer.customerImg!='' }">${customer.customerImg}</c:if><c:if test="${customer.customerImg==null||customer.customerImg==''}"><%=basePath %>images/default_head.jpg</c:if>"  height="50" width="50" />
		              </td>
		              <td>
		              ...
		              <td>
			              <a href="javascript:;">
				             <c:if test="${customer.isMobile ==0}">
								 <span class="label label-default" style="cursor: default;">否</span>
							</c:if>
							<c:if test="${customer.isMobile ==1}">
								  <span class="label label-success" style="cursor: default;">是</span>
							</c:if>
		              ...
		              <td>
                          ...
                          <c:if test="${customer.isSeller ==2}">
                                普通
							</c:if>
							<c:if test="${customer.isSeller ==1}">
								<span class="label label-success">商家</span>
							</c:if>
                            <c:if test="${customer.isSeller ==3}">
                                <span class="label label-success">商家</span>
                            </c:if>

						</td>
						 <fmt:formatDate value="${customer.loginTime }" pattern="yyyy-MM-dd HH:mm:ss" var="logindate" />
		              <td>${logindate }</td>
		              <td>${customer.province.provinceName}</td>
		              <td>
		                <div class="btn-group">
		                  <button type="button" class="btn btn-default" onclick="onedit(${customer.customerId});">编辑</button>
		                  <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
		                    <span class="caret"></span>
		                    <span class="sr-only">Toggle Dropdown</span>
		                  </button>
		                  <ul class="dropdown-menu" role="menu">
		                    <li><a href="javascript:;" onclick="queryCustomer(${customer.customerId});">查看</a></li>
		                    <li><a href="javascript:void(0);" onclick="delcustomer(${customer.customerId});">删除</a></li>
		                  </ul>
		                </div>
		              </td>
		            </tr>
            ...
            <form class="form-horizontal" id="cusForm" method="post" action=""  enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-8" >
                  ...
                  <input type="text" class="form-control required numandletter" maxlength="20" minlength="6" name="customerUsername" id="customerUsername" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8" >
                  ...
                  <input type="password" class="form-control required"  maxlength="16" minlength="6"  name="customerPassword" id="password" >
                </div>
                <div class="col-sm-3"></div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-8" >
                  ...
                  <input type="password" class="form-control required" equalTo="#password" name="repassword" id="repassword">
                </div>
                <div class="col-sm-3"></div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-1"></div>
                <div class="col-sm-4">
                      <P id="pointlevel" class="radio-inline"></P>
                    <label id="pointLevelTips" class="error">未找到默认的会员等级</label>
              ...
              <div class="form-group">
                ...
                <input name="customerImg" id="customerImg" type="hidden" value="">
                  <img alt="" id="img" src="<%=basePath %>images/default_head.jpg" height="50"> <input type="button" id="choose" value="选择"/>
                </div>
                  <div class="col-sm-3">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-1"></div>
                <div class="col-sm-4">
                  <input type="text" class="form-control isChineseandPonint"  name="infoRealname" id="realname">
                </div>
              </div>      
              <div class="form-group">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="" id="sendForm">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-1"></div>
                <div class="col-sm-10">
                  <textarea class="form-control required" rows="5" name="letterContent" id="letterContent"></textarea>
                </div>
              </div>
                <div class="form-group">
                    <label class="control-label col-sm-5">广告链接地址：</label>
                    <div class="col-sm-1"></div>
                    <div class="col-sm-11">
                        <div class="ww">
                                <span class="input-group-addon" id="basic-addon3" style="float:left;padding: 0px;width:117px;">
                                    <select style="height: 30px;" id="linkType" name="linkType" onchange="selectLinkType(this)">
                                      <option value="all">选择跳转类型</option>
                                      <option value="list-">商品列表-list</option>
                                      <option value="item-">商品详情-item</option>
                                      <option value="">新链接-url</option>
                                    </select></span>
                            <input type="text" id="up_adverHerf" name="hrefUrl" class="form-control" readonly style="width:156px;">
                        </div>
                        <div class="input-group" style="display:none;" id="pc_input">
                            <input type="text" name="pcUrl" id="pc_url" class="form-control" placeholder="pc端新链接url" style="width:156px;margin:2px 0 0 118px;">
                        </div>

                    </div>
                    <sapn></sapn>
                </div>
                <p style="padding-left: 130px;color: red;">注：请先选择点击广告后跳转类型。不选择跳转类型则只显示不做跳转；商品列表页填写商品分类ID；商品详情页填写货品ID；其它新页面填写链接地址以https或http开头。</p>
   ...
   <!-- Modal -->
    ...
    function  selectLinkType(n) {
        $("#up_adverHerf").val("");
        var linkType = $(n).val();
        if(linkType == "all"){
            $("#up_adverHerf").attr("readonly","readonly");
            $("#up_adverHerf").removeClass("required").removeAttr("placeholder");
            $("#pc_input").hide();
            $("#pc_url").removeClass("url required").val("");

        }else if(linkType == ""){
            $("#up_adverHerf").removeClass("digits");
            $("#up_adverHerf").addClass("required url");
            $("#up_adverHerf").removeAttrs("readonly");
            $("#up_adverHerf").attr("placeholder","移动端新链接url");
            $("#pc_input").show();
            $("#pc_url").addClass("url required");

        }else{
            $("#up_adverHerf").removeClass("url");
            $("#up_adverHerf").addClass("required digits");
            $("#up_adverHerf").removeAttrs("readonly");
            $("#up_adverHerf").removeAttr("placeholder");
            $("#pc_input").hide();
            $("#pc_url").removeClass("url required").val("");
        }
    }
	...
	//弹出添加会员
        function toaddcustomer(){
            ...
            $('#password').show();
            $('#customerUsername').addClass('numandletter');
            $('#repassword').show();
            $("#nameDiv").hide();
            $("#passDiv").hide();
            $("#emailDiv").hide();
       ...
       function onedit(customerId){
    	   ...
    	   modified =1;
    	   $('#customerUsername').removeClass('error');
           $('#customerUsername').removeClass('numandletter');
           $("#customerUsernametip").hide();
           $('#email').removeClass('error');
           $("#emailtip").hide();
           $("#pointLevelTips").hide();
      ...
      //.保存会员
        ...
        function savecustomer(){
            if($("#pointlevel").text().trim()==""||$("#pointlevel").text()==null||$("#pointlevel").text().trim()=="undefined" ){
                $("#pointLevelTips").show();
                return;
            }
            check();
            if(bValid && $("#cusForm").valid()&&c==0&&$("#pointlevel").text().trim()!=""&&$("#pointlevel").text()!=null&&$("#pointlevel").text().trim()!="undefined" ){
            	c=1;
                $("#cusForm").submit();
            }
              ...
              success:function(data){
                  $.each(data,function(i,result){
                      if(data[i].orders!=null&&data[i].orders!=""){
                          showTipAlert("批量删除的会员当中有订不允许删除单,!");
                          flag=false;
                          return ;
                      }
                  });
      ...
      function subSend(){
          if($("#sendForm").valid()){
              ...
              datas += "&hrefUrl=" + $("#up_adverHerf").val();
              datas += "&pcUrl=" + $("#pc_url").val();
              datas += "&linkType=" + $("#linkType").val();
	  			jQuery.ajax({
				...
				success:function(html){
                    if (html >= 1) {
					    $("#letterTitle").val('');
					    $("#letterContent").val('');
                        $("#up_adverHerf").val("").removeClass("required url digits");
                        $("#up_adverHerf").attr("readonly","readonly");
                        $("#up_adverHerf").removeAttr("placeholder");
                        $("#pc_url").removeClass("url required").val("");
                        $("#pc_input").hide();
    ...
    function exportCheck(){
        if (checkSelected("customerId")) {
            $("#delForm").attr("action","exportCustomerCheck.htm?CSRFToken=${token }&customerIds="+checkedList);
            $("#delForm").submit();
            $("#delForm").attr("action","deleteAllNewCustomer.htm?CSRFToken=${token }");
        }
        else {
            showTipAlert("请至少选择一条记录");
        }
    ...
    function addprovince(){
        $.ajax({
            type:"get",
            url:"addprovincetoCustomerinfo.htm?CSRFToken=${token }",
            success:function(data){
                data;
                console.log(data);
            }
