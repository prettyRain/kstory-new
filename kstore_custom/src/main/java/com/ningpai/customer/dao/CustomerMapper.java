...
public interface CustomerMapper {
     ...
     * @return 用户信息
     */
    Customer getCustomerByInput(String username);
    ...
    List<String> queryAllCustomerIp();
    /**
     * 删除会员 批量
     * 
     * @param paramMap
     ...
     * @return
     */
    List<CustomerAllInfo> queryListForExportByCustomerIds(Map<String,Object> paramMap);
     ...
     */
    Customer queryLoginInfoByCustomerId(Long costomerId);
     ...
     * @date 2015/11/17
     *
     * @param param {UTYPE:userame|mobile|email,username:username}
     * @return
     */
    Customer getCustomerByUsernameMap(Map<String, String> param);
     ...
     * @return 记录数
     * */
    int selectCustCount(Long customerId);
     ...
     * @return 返回街道信息
     */
    StreetBean queryStreetBeanById(String streetId);
     ...
     * @return
     */
    int auditImg(Map<String, Object> paramMap);

    /**
     * 需要审核的头像列表
     * @return
     */
    List<Object> queryAuditImg(Map<String, Integer> paramMap);

    int selectAuditImgCount();

    /**
     * 添加系统消息 头像审核是否通过的消息
     * @param avatarNotice
     */
    void addAvatarNatice(AvatarNotice avatarNotice);

    List<Integer> selectCustomerAllID(Map<String,Object> map);

    int countCustomerAllID(Map<String,Object> map);

    List<CustomerAllInfo> selectAllCustmerinfo(Map map);

    Long getProvinceIdByName(String name);
}
