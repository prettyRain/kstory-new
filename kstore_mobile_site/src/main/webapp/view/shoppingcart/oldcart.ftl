...
<#else>
    ...
    <style>
        ...
        .content-cart .pay-box .cart-money{
            float: right;
            padding-top: 6px;
        }
        .content-cart .pay-box .cart-pay{
            position: static;
            float: right;
        }
        .content-cart .pay-box{
        ...
        .content-cart .pay-box .select-all,.content-cart .pay-box.editable .goods-ctrl{
            padding-top: 6px;
        }
        i.select-box{
            top:6px!important;
        }
        .content-cart .cart-list li .list-item i.select-box {
            top: 30px!important;
        }
        /*zhx购物车head部分样式修改*/
        .cart-head{
                        ...
                        <li>
                            <div class="list-item cart-pro-item">
                                ...
                                <div class="prodesc">
                                    ...
                                    <div class="buy-num">
                                        <span class="reduce" name="${shop.shoppingCartId}" <#--onclick="minus(this,${shop.shoppingCartId});-->">&#8722</span>
                                        <input type="text" class="goodsNum goods-num"
                                               attr-maxnum="${shop.goodsDetailBean.productVo.goodsInfoStock}"
                                               onblur="opblur(this,${shop.shoppingCartId});" value="${shop.goodsNum}"/>
                                        <span class="add" name="${shop.shoppingCartId}" <#--onclick="plus(this,${shop.shoppingCartId});-->">&#43</span>
                                    </div>
                                    <#assign goodsNum=goodsNum+shop.goodsNum?number/>
