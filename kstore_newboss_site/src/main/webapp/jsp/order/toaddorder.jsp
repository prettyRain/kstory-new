          ...
          <div class="main_cont">
            ...
            <div class="add_order_1 common_form common_form_lg p20">
              <div class="form-horizontal">
                  ...
                  <label class="control-label col-sm-5"><span class="text-danger">*</span>会员用户名：</label>
                  <div class="col-sm-1"></div>
                  <div class="col-sm-8">
                    <input type="text" class="form-control required " id="customerName" name="customerName" onblur="checkUsername()">
                  </div>
                  <div class="col-sm-1"></div>
                  <div class="col-sm-3">
              ...
              <div class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-sm-17">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-18" >
                            <span><input type="radio" name="addressType" checked value="1"  onclick="showAndHideAdress()">社区店</span>
                            <span style="padding-left:15px;"><input type="radio" name="addressType" value="0" onclick="showAndHideAdress()">自选地址</span>
                        </div>
                    </div>
                    <div class="form-group community">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-18">
                            <select class="form-control inline" data-live-search="true" id="provincessId" name="provincess" onchange="queryCommCityByProvinceId(this)">
                                <option>选择省份</option>

                            </select>
                            <select class="form-control inline" data-live-search="true" name="citiess" id="citiessId" onchange="queryCommDistrictByCityId(this)">
                                <option>选择城市</option>

                            </select>
                            <select class="form-control inline" data-live-search="true" id="districtssId" name="districtss" onchange="queryCommCommunityByDistrictId(this)">
                                <option value="0">选择区县</option>

                            </select>
                            <select class="form-control inline" data-live-search="true" id="communityssId" name="communityStoreId" >
                                <option value="0">选择社区店</option>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group delivery">
                      <label class="control-label col-sm-5">送货方式：</label>
                      <div class="col-sm-1"></div>
                      <div class="col-xs-5">
                          <span> <input type="radio" name="deliveryName" value="0" checked>送货上门</span>
                          <span> <input type="radio" name="deliveryName" value="1">自提</span>
                      </div>
                  </div>
                <div class="form-group">
    ...
    <script>
        ...
        function saveOrder(){
            ...
            if($("#checkform").valid()&&payflag==1){
                ...
                $.ajax({
                    type: "post",
                    url: "<%=basePath %>ajaxsaveOrder.htm",
                    async: false,
        ...
        function checkUsername() {
            ...
            if (customerName == '' || customerName == null) {
                ...
                $.ajax({
                    type: "post",
                    url: "<%=basePath %>ajaxGetorderDetail.htm?CSRFToken=${token}",
                    async: false,
        ...
        function nextStep() {
            ...
            if(customerflag){
                ...
                $(".goodsPrice").each(function (index, item) {
                    ...
                    var goodsPrice = $(this).attr("attr_price");
                    //一件货品的价格
                    var singlepriceSum = accMul(goodsNum, goodsPrice);
        ...
        /*社区店根据省份ID查询城市*/
        function queryCommCityByProvinceId(province){
            provinceflag=$(province).val();
            //设置省份名称
            $.get("queryCityByProvinceId.htm?CSRFToken=${token}&provinceId="+($(province).val()),function(data){
                var provinces="<option value=''>选择城市</option>";
        ...
        /*社区店根据城市ID查询区县*/
        function queryCommDistrictByCityId(city){
        ...
        function queryCommCommunityByDistrictId(district){
        ...
        function addpro(obj){
            ...
            if(obj.checked==true){
                ...
                htm+='<td width="90"><input class="w50 text-center required goodsPrice" maxlength="3" onkeyup="this.value=this.value.replace(/\\D/g, \'\')" name="goodsNum" onafterpaste="this.value=this.value.replace(/\\D/g,\'\')" attr_price="'+goodsPrice+'" type="text" value="1"></td>';
