...
public class CouponMapperImpl extends BasicSqlSupport implements CouponMapper {
    ...
    @Override
    public List<Coupon> selectGoodsDetailCouponListByIdsNew(Map<String, Object> paramMap) {
        return this.selectList(
                "com.ningpai.web.dao.CouponMapper.selectGoodsDetailCouponListByIdsNew",
                paramMap);
    }
    @Override
    ...
    public void addIntegralUseRecord(CustomerPoint  customerPoint) {
        this.insert("com.ningpai.web.dao.CouponMapper.addIntegralUseRecord",
                customerPoint);
    }
    /**
     * 查询用户的所有未过期且未使用的优惠券
    ...
    public List<Coupon> selectCouponListByCustomerId(Long customerId) {
        return this.selectList(
                "com.ningpai.web.dao.CouponMapper.selectCouponListByCustomerId", customerId);
    }
    ...
    public void updateCouponNo(CouponNo couponNo) {
        this.update("com.ningpai.web.dao.CouponMapper.updateCouponNo",couponNo);
    }
     ...
     */
    @Override
    public void modifyCouponByOrderIdAndCustomerId(Map map) {
        this.update("com.ningpai.web.dao.CouponMapper.modifyCouponByOrderIdAndCustomerId",map);
    }
    ...
    public void cancelOrderCoupon(Long orderId) {
        this.update("com.ningpai.web.dao.CouponMapper.cancelOrderCoupon",orderId.toString());
    }
