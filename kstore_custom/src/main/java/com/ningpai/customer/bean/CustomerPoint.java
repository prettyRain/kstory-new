...
public class CustomerPoint {
     ...
     * 0 不减去  1减去
     */
    private String customerGradeType;
    /**
     * 积分数量
     * 
     * @see #getPoint()
    ...
    public String getCustomerGradeType() {
        return customerGradeType;
    }

    public void setCustomerGradeType(String customerGradeType) {
        this.customerGradeType = customerGradeType;
    }
