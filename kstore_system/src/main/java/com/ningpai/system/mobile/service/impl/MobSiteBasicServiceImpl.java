...
public class MobSiteBasicServiceImpl implements MobSiteBasicService 
{
    ...
    public int saveMobSiteBasic(MobSiteBasic record) {
    	redisAdapter.delete(CacheKeyConstant.CURRMOBSITEBASIC_KEY);
    ...
    public MobSiteBasic selectCurrMobSiteBasic(HttpServletRequest request) {
    	 ...
    	 MobSiteBasic msb = (MobSiteBasic) redisAdapter.get(CacheKeyConstant.CURRMOBSITEBASIC_KEY);
        ...
        msb = this.mobSiteBasicMapper.selectCurr();
        if (null == msb) {
            try {
        ...
        redisAdapter.put(CacheKeyConstant.CURRMOBSITEBASIC_KEY, msb);
