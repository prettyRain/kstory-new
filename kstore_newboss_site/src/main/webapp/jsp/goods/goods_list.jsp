                ...
                <div class="common_data p20">
                    <div class="filter_area">
                        ...
                        <form role="form" action="findAllGoods.htm" method="post"  id="adv_form" class="form-inline">
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-info batch_number" onclick="synUpdateGoods(this)">
                                    同步ERP所有商品信息
                                </button>
                            </div>--%>
                            <%--同步ERP商品信息END--%>
                    ...
                    <div class="data_ctrl_area mb20">
                        ...
                        <div class="data_ctrl_brns pull-left">
                            ...
                            <button type="button" class="btn btn-info" onclick="createNewIndex()">
                                <i class="glyphicon glyphicon-th-large"></i> 生成索引
                            </button>
                    ...
                    <form action="batchDelGoods.htm?CSRFToken=${token }" method="post" id="goodsList">
                        ...
                        <table class="table table-striped table-hover">
                            <thead>
                            <tr>
                                <th width="25"><input  onclick="allunchecked(this,'goodsIds')" type="checkbox"></th>
                                <th>图片</th>
                                <th>商品标题</th>
                                <th>商品编号</th>
                                <!--<th>库存</th>-->
                            ...
                            <c:forEach items="${pb.list}" var="goods" varStatus="sta">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${goods.goodsAdded==0&&goods.goodsAdded!=null}">
                                            <c:if test="${goods.auditStatus==2}">
                                            <a  title="点击上架" href="updateGoodsSta.htm?CSRFToken=${token }&goodsId=${goods.goodsId }&goodsAdded=0&auditStatus=1&pageNo=${pb.pageNo }"  href="javascript:;" class="label label-default">否</a>
                                            </c:if>
                                        </c:if>
                                        <c:if test="${goods.goodsAdded==1&&goods.goodsAdded!=null}">
                                            <c:if test="${goods.auditStatus==3}">
                                                <a title="点击下架" href="updateGoodsSta.htm?CSRFToken=${token }&goodsId=${goods.goodsId }&goodsAdded=0&auditStatus=2&pageNo=${pb.pageNo }" class="label label-success">是</a>
                                            </c:if>
                                        </c:if>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <button type="button" class="btn btn-default" id="${goods.goodsId}" onclick="openProduct(this);">查看货品</button>
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <c:if test="${goods.goodsAdded==0&&goods.goodsAdded!=null}">
                                                    <c:if test="${goods.auditStatus==1||goods.auditStatus==2}">
...
<!-- 查看货品form  -->
<form method="post" id="openProductForm" action="queryAllByGoodsId.htm">
    <input type="hidden" name="pageNos" value="${pb.pageNo}"/>
...
<div class="modal fade" id="jjly_id"  role="dialog">
    ...
    <script>
        ...
        function openProduct(obj){
            ...
            $("#openProductForm").find("input[name='goodsId']").val(goodsId);
            $("#openProductForm").submit();
        }
