...
public interface ReceivablesService {
    ...
    PageBean searchReceivables(PageBean pageBean,String searchText,String condition,String status,String startTime,String endTime);
     ...
     * @return
     */
    List<Receivables> getAllByOrderCode(Map<String,String> map);
