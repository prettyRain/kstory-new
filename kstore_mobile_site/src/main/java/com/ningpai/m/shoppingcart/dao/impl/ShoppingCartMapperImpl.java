...
public class ShoppingCartMapperImpl extends BasicSqlSupport implements
     ...
     * @return List
     */
    public List<ShoppingCart> shoppingCart(Map<String, Object> paramMap) {
    ...
    public Integer countByCustomerId(Long customerId) {
        return this.selectOne(
                "com.ningpai.web.dao.ShoppingCartMapper.countByCustomerId",customerId);
    }

    /**
     * 修改购物车的marketActivityId
     *
     * @param cart
     */
    @Override
    public void setShoppingCartActivityIdMapper(ShoppingCart cart) {
        this.update("com.ningpai.web.dao.ShoppingCartMapper.setShoppingCartActivityIdMapper",cart);
    }
