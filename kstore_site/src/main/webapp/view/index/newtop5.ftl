...
<div class="section-header">
    <div class="content">
        <h1 id="logo">
            <a href="${topmap.systembase.bsetAddress}"><img src="${topmap.systembase.bsetLogo}" alt="" style="height: 70px;width:165px;"/></a>
        ...
        <ul class="hd_menu">
            ...
            <li class="navCenter">
                <a href="${basePath}/customer/index.html" target="_blank">会员中心<s class="toB"></s></a>
                <div class="navInfo">
                    <div class="navPanel">
                        <a href="${basePath}/customer/myorder.html" target="_blank">我的订单</a>
                        <a href="${basePath}/customer/myfollw.html" target="_blank">我的收藏</a>
                    </div>
                </div>
            </li>
