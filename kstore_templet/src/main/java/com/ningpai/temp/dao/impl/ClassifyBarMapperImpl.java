...
public class ClassifyBarMapperImpl extends BasicSqlSupport implements ClassifyBarMapper {
    ...
    public List<ClassifyBarVo> selectClassifyBarByParamThirdSite(Map<String, Object> map) {
        return this.selectList("com.ningpai.temp.dao.ClassifyBarMapper.selectClassifyBarByParamThirdSite", map);
    }
    ...
    public List<ClassifyBarVo> getClassifyBarByProvinceId(String id) {
        return this.selectList("com.ningpai.temp.dao.ClassifyBarMapper.getClassifyBarByProvinceId", id);
    }
}
