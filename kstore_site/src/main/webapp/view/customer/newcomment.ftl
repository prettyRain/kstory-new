                                            ...
                                            <#if good.evaluateFlag == '0'>
                                                <div class="air-judgeBox"><b class="topArrow"><i></i></b>
                                                        ...
                                                        <div class="item clearfix">
                                                            ...
                                                            <div class="put">
                                                                <textarea id="complaincon${(good.orderGoodsId)!''}" name="commentContent" maxlength = "500" class="c_text" onfocus="focusFun($(this));" onblur="blurFun($(this));"></textarea>
                                                        ...
                                                        <div class="item clearfix">
                                                            ...
                                                            <div class="put">
                                                                ...
                                                                <ul class="imgList fl one" id="share_imgs${good.orderGoodsId}">
                                                                </ul>
                                                                    <div>

                                                                        <input class="addImg up_photo" style="width: 80px;cursor:default;height: 80px;border: 1px solid #efefef;margin-right: 10px;padding: 0;display: inline-block;"type="button" value="添加图片"/>
                                                                        <label style="cursor: pointer;width: 48px;margin-left: -77px;margin-right: 25px;" for="imageFile">
                                                                            <input type="file" class="upload_file" id="imageFile" order_goods_id="${good.orderGoodsId}" name="shareFile" style="cursor:pointer;width:65px;margin-left:-85px;margin-right:15px;filter:alpha(opacity=0);-moz-opacity:0.5;-khtml-opacity: 0;opacity: 0; ">
                                                                        </label>
                                                        ...
                                                        <div class="item clearfix">
                                                            ...
                                                            <div class="put">
                                                                <button class="subComm" type="button" onclick="saveShare(${good.orderGoodsId},1,${good.orderId})">评论并继续</button>
                                            ...
                                            <#elseif good.evaluateFlag == '1' && good.shareFlag=='0'>
                                                <div class="air-judgeBox"><b class="topArrow"><i></i></b>
                                                    ...
                                                    <div class="item clearfix">
                                                        ...
                                                        <div class="put">
                                                            <p id="content${good.orderGoodsId}" style="word-break: break-all;">声音有点大，恒温效果不错，总体满意</p>
                                                        </div>
                                                    </div>
                                                    <div class="item clearfix">
                                                        <div class="label">
                                                    ...
                                                    <div class="item clearfix">
                                                        ...
                                                        <div class="put">
                                                            <button class="subComm" type="button" onclick="saveShare(${good.orderGoodsId},2,${good.orderId})">晒单</button>
                                                        <#--<input class="niMin ml10" type="checkbox"/>-->
                                                        <#--<label>匿名评价</label>-->
                                                        </div>
                                                    </div>
    ...
    <div class="member-dialog-body">
        ...
        <div class="tc">
            ...
            <div class="que-delete clearfix">
                <div class="fl tl">
                    <p class="f16 new_p" id="errorT2">请先选择要删除的图片！</p>
                    <div class="m-btn ">
...
<div class="member-dialog dia3">
    <div class="member-dialog-body">
        ...
        <div class="tc">
            ...
            <div class="que-delete clearfix">
                <div class="fl tl">
                    <p class="f16 new_p" id="errorT">请先选择要删除的图片！</p>
                    <div class="m-btn">
                        <a  id="go_pay_01" href="javascript:;cls();" class="bnt_ok">确定</a>
                    </div>
                </div>
...
//查看评论晒单
    ...
    function check(){
        if($("textarea[name=commentContent]").val().trim().length>500){
            $("#errorT2").html("评论内容字数过多!字数在10-500之间！");
            /*$("#errorT2").append("<p></p>");*/
            dia(2);
