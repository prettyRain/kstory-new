...
import com.ningpai.goods.vo.Marketing;
import com.ningpai.searchplatform.annotation.ESField;
import com.ningpai.searchplatform.annotation.EnableSuggest;
 ...
 * 货品信息
 */
@EnableSuggest(suggestName = "suggest", analyzerType = ESAnalyzer.ik)
public class EsGoodsInfo extends EsGoodsInfoKey implements IESMappingType {
     ...
     * 货品价格
     */
    @ESField(analyzerType = ESAnalyzer.standard)
     ...
     * 销售类型，0零售，1批发，默认为0
     */
    @ESField(fieldType = ESFieldType.STRING)
    ...
    public String getGoodsInfoDiscount() {
        return goodsInfoDiscount;
    }

    public void setGoodsInfoDiscount(String goodsInfoDiscount) {
        this.goodsInfoDiscount = goodsInfoDiscount;
    }
    ...
    /**
     * 用作于商品列表中显示 1-直降 15-折扣 10-团购 11-抢购 促销类型是时显示的参与计算的优惠金额

     */
    private String goodsInfoDiscount;
...
//        private String output;
        ...
        public List<String> getInput() {
            return IkAnalzyerUtil.segmentPhraseByIk(goodsInfoName);
        }
    ...
    public void setInMarketing(String inMarketing) {
        this.inMarketing = inMarketing;
    }
     ...
     * @return
     */
    public EsGoodsInfo setCommentUtilBean(ProductCommentUtilBean commentUtilBean) {
     ...
     * @return
     */
    public EsGoodsInfo setCodeUtils(List<GoodsMarketingCodeUtil> codeUtils) {
