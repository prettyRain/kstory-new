...
public class RechargeController {
     ...
     * @return
     */
    @RequestMapping("/giftcard/rechargeviewNew")
    public ModelAndView rechargeViewNew(HttpServletRequest request){
        ...
        ModelAndView mav = new ModelAndView("giftcard/recharge");
        mav.addObject("customerId",customerId);
