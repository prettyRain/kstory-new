...
<#--<script src="https://res.wx.qq.com/open/js/jweixin-1.1.0.js" ></script>-->
    <style>
        .summary-list .details-list-p .p1{
            width: 50%;
            float: left;
        }
        .pro-desc .pro-desc-body img{
            width:100%;
            height:100%;
        }
        .sticky {
        ...
        .pro-parameters .pro-parameters-body{
        ...
        /*shf加减号调整*/
        .pro-chose .list-item .list-value .num .add{background:url(../images/v1/img/product-detail-sprites-mjs.png) no-repeat;background-position:-32px -67px;background-size:100px 100px;height:12px;width:12px;display:block;margin:9px}
        .pro-chose .list-item .list-value .num .reduce{background:url(../images/v1/img/product-detail-sprites-mjs.png) no-repeat;background-size:100px 100px;background-position:-32px -85px;height:12px;width:12px;display:block;margin:9px}
        .pro-desc { padding: 45px 0 0; }
        .pro-details{margin-top: 0; }
    </style>
...
<#else>
    ...
    <div class="summary-list">
        <div class="list-item clearfixed" >
        <#--shf零售价格批发数量-->
        <#--<p class="buyDetail">-->
    ...
    <#--shf商品明细信息-->
        <div class="list-item details-list-p clearfixed">
...
<div class="bar-bottom">
    ...
    <div class="half">
        ...
        <a class="btn buyNow addToCart check" href="javascript:;">立即购买</a>
    </div>
</div>
...
<div id="myvalue" hidden="hidden">
    <div class="bar-top" id="bar-top"  style="z-index:1000;"><a class="bar-item half active"
                                                                onclick="$(this).addClass('active').siblings().removeClass('active');$('.pro-desc').show();$('.pro-details').hide();$('.pro-brand').hide();$('.pro-parameters').hide();">商品介绍</a><a
            class="bar-item half"
            onclick="$(this).addClass('active').siblings().removeClass('active');$('.pro-desc').hide();$('.pro-details').hide();$('.pro-brand').hide();$('.pro-parameters').show();">规格参数</a>
    <#--<a-->
    <#--class="bar-item half"-->
    ...
    <div class="pro-desc" style="padding-top: 0px;">
        <div class="pro-desc-body">${map.detailBean.productVo.goods.mobileDesc!''}</div>
    </div>
