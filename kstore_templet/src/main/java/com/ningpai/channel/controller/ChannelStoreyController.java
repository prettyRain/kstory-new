...
public class ChannelStoreyController {
    ...
    @ResponseBody
    public int createChannelStorey(HttpServletRequest request, HttpServletResponse response, ChannelStorey channelStorey, BindingResult bindingResult, Long channelId,
            Long tempId) {
