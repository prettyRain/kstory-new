...
<div class="show-boxbb">
    ...
    <#--<a class="slide" href="${bigAdvert.adverHref}" style="background-image:url(http://tboss.ge960.com:80/upload/20170321/1490060983896.jpg);"></a>-->
        <a class="slide" href="javascript:void(0);" style="background-image:url(http://boss.ge960.com:80/upload/20170321/1490060983896.jpg);"></a>
    <#--</#list>
        ...
        <#list pb.list as rush>
            <li>
                <a href="${basePath}/item/${rush.goodsProductVo.goodsInfoId}.html">
                    ...
                    <span style="font-size: 14px"><#--${10*rush.marketing.rushs[0].rushDiscount?number}折/--> ${rush.goodsProductVo.productName}</span>
                </a>
                <div class="cx_qg">
                ...
                <#--<p style="margin-left:3px;color:black">剩余:</p>
                <span>281</span>
                <p>天</p>
                <span>12</span>
                <p>时</p>
