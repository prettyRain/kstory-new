...
public class PanicBuyingDaoImpl extends BasicSqlSupport implements PanicBuyingDao {
    ...
    @Override
    public GoodsProductVo queryProductByPidOrCidOrBid(Map map) {
        return this.selectOne("com.ningpai.m.panicbuying.dao.PanicBuyingDao.queryProductByPidOrCidOrBid",map);
    }
}
