...
public class InsideLetterMapperImpl extends BasicSqlSupport implements
    ...
    public List<Object> selectListNoPage(Map<String, Object> paramMap) {
        return this.selectList(
                "com.ningpai.customer.dao.InsideLetterMapper.selectListNoPage",
                paramMap);
    }

    @Override
    public void removeNoticeAll(Long customerId) {
        this.update("com.ningpai.customer.dao.InsideLetterMapper.removeNoticeAll",
                        customerId);
    }

    @Override
    public Long queryInsideCount(Long customerId) {
        return this.selectOne("com.ningpai.customer.dao.InsideLetterMapper.selectInsideCount",
                        customerId);
    }

    @Override
    public Long findNoticeCount(Long noticeId) {
        return this.selectOne("com.ningpai.customer.dao.InsideLetterMapper.findNoticeCount",
                noticeId);
    }
