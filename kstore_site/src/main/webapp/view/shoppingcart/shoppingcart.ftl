        ...
        function checkOne(obj){
            ...
            if(codexType!='0'){
                if(obj.checked){
                    ...
                    if(codexType=='1'){
                        ...
                        $(obj).parents(".marketgroup").find(".mjchecked").each(function(){
                            if(this.checked) {
                                ...
                                var oneweight = $(this).parents(".cart_goods").find("input[name=oneweight]").val();

                                youhui = accAdd(youhui, accMul(man, jian));
                                xiaoji = accAdd(onesumprice, xiaoji);
                                weight = accAdd(weight,accMul(oneweight,jian));
                            }
                        });
                        $(obj).parents(".marketgroup").find(".xiaojiweight").val(weight);
                        $(obj).parents(".marketgroup").find(".youhui").val(0);
                        $(obj).parents(".marketgroup").find(".xiaoji").val(xiaoji);

                    }else if(codexType=='10'){
                        var youhui = 0;
                        var xiaoji = 0;
                        var weight = 0;
                        $(obj).parents(".marketgroup").find(".mjchecked").each(function() {
                    ...
                    else if(codexType=='11'){//抢购 一次抢购活动只能添加一个商品
                        var youhui = 0 ;
                        var xiaoji = 0;
                        var weight = 0;
                        $(obj).parents(".marketgroup").find(".cart_goods").each(function(){
                            ...
                            xiaoji = accAdd(onesumprice,xiaoji);
                            //商品重量
                            var oneweight = $(this).find(".g_promotion").find("input[name=oneweight]").val();
                            weight = accAdd(weight,accMul(oneweight,jian));
                        });
                        $(obj).parents(".marketgroup").find(".xiaojiweight").val(weight);
                        $(obj).parents(".marketgroup").find(".youhui").val(0);
                        ...
                        $(obj).parents(".marketgroup").find(".mjchecked").each(function(){
                            ...
                            if($(this)[0].checked){
                                ...
                                //商品重量
                                //件数
                                var jian = $(this).parents(".cart_goods").find(".g_count").find(".count").find(".text").val();
                                var oneweight = $(this).parents(".cart_goods").find("input[name=oneweight]").val();
                                weight = accAdd(weight,accMul(oneweight,jian));
                        ...
                        //计算重量
                        var oneweight = $(obj).parents(".marketgroup").find("input[name=oneweight]").val();
                        var weight = accAdd(weight,accMul(oneweight,num));
                        $(obj).parents(".marketgroup").find(".xiaojiweight").val(weight);
                    ...
                    if(codexType=='1'){
                       ...
                       // $(obj).parents(".marketgroup").find(".youhui").val(youhui);
                        ...
                        $(obj).parents(".marketgroup").find(".xiaoji").val(xiaoji);
//                        计算重量
                        var thisweight=accMul($(obj).parents(".cart_goods").find("input[name=oneweight]").val(),jian);
                        var oldxiaojiweight = $(obj).parents(".marketgroup").find('.xiaojiweight').val();
                        var xiaojiweight = Subtr(oldxiaojiweight,thisweight);
                        $(obj).parents(".marketgroup").find(".xiaojiweight").val(xiaojiweight);
                    }else if(codexType=='15'){
                        //计算重量
                        var jian = $(obj).parents(".cart_goods").find(".text").val();
                        var thisweight=accMul($(obj).parents(".cart_goods").find("input[name=oneweight]").val(),jian);
...
//                        $(obj).parents(".marketgroup").find(".youhui").val(youhui);
                ...
                $(obj).parents(".marketgroup").find(".mjchecked").each(function(){
                    ...
                    if($(this)[0].checked){
                        ...
                        var oldxiaojiweight=$(obj).parents(".marketgroup").find('input[name=sumoneweight]').val();
                        $(obj).parents(".marketgroup").find(".xiaoji").val(oldxiaoji);
                        $(obj).parents(".marketgroup").find(".xiaojiweight").val(oldxiaojiweight);
                    }else{
                        $(obj).parents(".marketgroup").find(".xiaoji").val(0);
                        $(obj).parents(".marketgroup").find(".xiaojiweight").val(0);
                    }
                });
            }
            lastsum();
        ...
        function isHasGift(obj,nowAll){
            ...
            $(obj).parents(".marketgroup").find(".grades").each(function(){
                if(parseFloat(nowAll) >= parseFloat($(this).val())){
                    //如果这一级促销有赠品（主要是针对赠送优惠券但优惠券不满足条件时）
                    if($(this).parent(".gift").find(".light").length>0){
        ...
        function lastsum(){
            ...
            */
            ...
            for(var i=0 ; i<weightList.length ; i++){
                weightAll = accAdd(weightAll,weightList[i]);
            }
            $('.yuezhong').html(accDiv(weightAll,"1000")+'kg');
...
<#--<#if (topmap.temp)??>-->
    ...
    <#--</#if>-->
<#--</#if>-->
<input type="hidden" id="button_hide" value="去结算">
<div class="container">
    ...
    <#--&lt;#&ndash;<#if (topmap.temp)??>&ndash;&gt;-->
        <#--&lt;#&ndash;<#if (topmap.temp.tempId!=10)>&ndash;&gt;-->
    ...
    <div style="font-family: arial;">
        ...
        <div class="flow_title">
            <span>
                <a href="${basePath}/index.html" style="color:#666666;">首页&nbsp;&nbsp;</a>>
            </span>
            <span>购物车</span>
        	<span>
            <#if customerId??>
        ...
        <div class="cart_box">
                                ...
                                <#list cartMap.marketinglist as market>
                                    ...
                                    <#if market.businessId??&&market.businessId==third.thirdId>
                                        ...
                                        <#--抢购促销-->
                                                        ...
                                                        <div class="cart_item">
                                                                                        ...
                                                                                        <#--<#if fullGiftAllPrices?number gte fullprice?number>-->
                                                                                            <div class="gift mt10" style="display: none">
                                                                                                ...
                                                                                                <#list presentMarks.fullbuyPresentScopes as presentScopes>
                                                                                                   <#--赠送商品-->
                                                                                                    <#if presentScopes.scopeType?number == 0 >
                                                                                                        <#--全赠-->
                                                                                                    ...
                                                                                                    <#--赠送优惠券-->
                                                                                                    <#elseif presentScopes.scopeType?number == 1 && presentScopes.coupon??>
                                                                                                    <#--全赠-->
                                                                                                        <#if (presentMarks.presentMode?number == 0)>
                                                                                                            <p class="light">

                                                                                                                <input type="hidden" class="proName" value="${presentScopes.coupon.couponName}"/>
                                                                                                                <input type="hidden" class="presentScoId" value="${presentScopes.presentScopeId}"/>
                                                                                                                <input type="hidden" class="proNum" value="${presentScopes.scopeNum}"/>
                                                                                                                <span>[赠品]</span>
                                                                                                                <a href="javascript:void(0)">${presentScopes.coupon.couponName}</a>
                                                                                                                <span>X${presentScopes.scopeNum}</span>
                                                                                                            <div class="cb"></div>
                                                                                                            </p>
                                                                                                        </#if>
                                                                                                        ...
                                                                                                        <#if (presentMarks.presentMode?number == 1)>
                                                                                                            ...
                                                                                                            <#else>
                                                                                                                <p class="light" style="display: none">
                                                                                                                    ...
                                                                                                                    <input type="hidden" class="proNum" value="${presentScopes.scopeNum}"/>
                                                                                                                    <span>[赠品]</span>
                                                                                                                    ${presentScopes.coupon.couponName}
                                                                                                                    <span>X${presentScopes.scopeNum}</span>
                                                                                                                <div class="cb"></div>
                                                                                                                </p>
                                                                                                            </#if>
                                                            ...
                                                            <div class="cell g_price">
                                                                ...
                                                                <input type="hidden" name="" value="${price}">
                                                                    <#if market.codexType=='11'&& market.customerbuynum !=0 >
                                                                        <#if market.customerbuynum??>
                                                                            <#if cars.goodsNum?number gt market.customerbuynum>
                                                                                <span class="towspan">
                                                                                    ￥${cars.goodsPrice?number?string('0.00')}&nbsp;&nbsp;x<em class="gn">${(cars.goodsNum?number-market.customerbuynum?number)?string('0')}</em>
                                                                                </span>
                                                                                <span class="onespan">
                                                                                <#setting number_format="0.00">
                                                                                <#--后台已经处理过的实际金额-->
                                                                                    ￥${price?string('0.00')}&nbsp;&nbsp;x<em class="gn">${(market.customerbuynum!1)?string('0')}</em>
                                                                               </span>
                                                                            <#else>
                                                                                <span class="onespan">
                                                                                    ￥${price?string('0.00')}&nbsp;&nbsp;x<em class="gn">${(cars.goodsNum)?string('0')}</em>
                                                                               </span>
                                                                            </#if>
                                                                        </#if>
                                                                    <#else>
                                                            ...
                                                            <div class="cell g_promotion">
                                                                ...
                                                                <#assign activeFlag="0"/>
                                                                <#assign oneprice="0"/>
                                                                <#assign rushoneprice="0"/>
                                                                <#assign oneweight="${cars.goodsDetailBean.productVo.goodsInfoWeight}">
                                                                <#assign sumoneweight="${cars.goodsNum?number*cars.goodsDetailBean.productVo.goodsInfoWeight?number}"/>
                                                                <#assign xiaojiweight="${xiaojiweight?number+sumoneweight?number}">
                                                                <input type="hidden" name="oneweight" value="${oneweight}">
                                                                <input type="hidden" name="sumoneweight" value="${sumoneweight}">
                                                                <!--判断参与的促销-->
                                                                    ...
                                                                    <#if cars.marketingList??&&cars.marketingList?size!=0>
                                                                        ...
                                                                        <#--抢购促销-->
                                                                            <#if market.codexType=='11'&&cars.marketingActivityId==market.marketingId>
                                                                                ...
                                                                                <#---->
                                                                                <#assign rushoneprice="${cars.goodsPrice?number}">
                                                                                <#if cars.goodsNum?number gt market.customerbuynum && market.customerbuynum!=0>
                                                                                     <#assign manPrice="${rushoneprice?number*(cars.goodsNum?number-(market.customerbuynum)?number)}">
                                                                                     <#assign manPrice="${manPrice?number+price?number*(market.customerbuynum!1)?number}">
                                                                                     <#assign marPrice="${marPrice?number+manPrice?number}">
                                                                                <#else>
                                                                                     <#assign manPrice="${price?number*cars.goodsNum}"/>
                                                                                     <#assign marPrice="${marPrice?number+manPrice?number}">
                                                                            ...
                                                                            <#if market.codexType=='15'&&cars.marketingActivityId==market.marketingId>
                                                                                <#assign oneprice="${price?number}"/>
                                                                                <#assign manPrice="${price?number*cars.goodsNum}"/>
                                                                                <#assign marPrice="${marPrice?number+manPrice?number}">
                                                                                <#assign smprice="${manPrice}"/>
                                                                ...
                                                                <input type="hidden" value="${rushoneprice}" class="rushoneprice"/>
                                                            ...
                                                            <div class="cell g_stock">
                                                                ...
                                                                <#--<input type="hidden" class="sell-type" value="${cars.goodsDetailBean.sellType!'0'}"/>-->
                                                                <#if cars.goodsDetailBean.productVo.productName??&&cars.goodsDetailBean.productVo.productName?index_of("零售")!=-1><input type="hidden" class="sell-type" value="0"/></#if>
                                                                <#if cars.goodsDetailBean.productVo.productName??&&cars.goodsDetailBean.productVo.productName?index_of("批发")!=-1><input type="hidden" class="sell-type" value="1"/></#if>
                                                            </div>
                                                            ...
                                                            <div class="cell g_count">
                                                                ...
                                                                <#--抢购-->
                                                                    <#if market.codexType=='11'&&cars.marketingActivityId==market.marketingId>
                                                                        ...
                                                                        <#--抢购原价-->
                                                                        <input type="hidden" value="${cars.goodsPrice?number}" class="rushYprice"/>
                                                                        <#assign isrushing="1">
                                                                    </#if>
                                                                ...
                                                                <#--购物车传过来的货品数量-->
                                                                    ...
                                                                    <#--抢购限制数量-->
                                                                        ...
                                                                        <#if market.customerbuynum ?? && cars.goodsDetailBean.productVo.goodsInfoStock?number &gt;market.customerbuynum >
                                                                            ...
                                                                            <#--抢购限购数量-->
                                                                            <#assign newrushflag="${market.customerbuynum!1}">
                                                                    ...
                                                                    <input type="text" class="text w30 goods-num"  oldgoodsnum="${cars.goodsNum}" value="${rushnum}" attr-maxnum="${rushflag}"
                                                                           onblur="opblur(this,${cars.shoppingCartId});" rush-maxnum="${newrushflag}"/>
                                            ...
                                            <input type="hidden"  class="xiaojiweight" value="${xiaojiweight}"/>
                                            <!--判断满减-->
                                    ...
                                    <#if cars.fitId??&&cars.thirdId==third.thirdId>
                                        ...
                                        <div attr-codexType="-1" class="marketgroup carts_${cars.shoppingCartId}" attr-group="1">
                                            <div class="cart_goods">
                                                        ...
                                                        <#if pro.productDetail??>
                                                            <div class="cart_item mb10 cart_item_goods">
                                                                ...
                                                                <div class="cell g_goods">
                                                                    ...
                                                                    <div class="name">
                                                                       ...
                                                                       <#-- <span style="margin:8px;border:1px solid #dcbb19;border-radius: 4px;font-size:14px;padding:0px 3px;color:#dcbb19;line-height: 18px;">
                                                                        ...
                                                                        <#--<input type="hidden" class="sell-type" value="${pro.productDetail.sellType!'0'}"/>-->
                                                                        <#if pro.productDetail.goodsInfoName??&&pro.productDetail.goodsInfoName?index_of("零售")!=-1><input type="hidden" class="sell-type" value="0"/></#if>
                                                                        <#if pro.productDetail.goodsInfoName??&&pro.productDetail.goodsInfoName?index_of("批发")!=-1><input type="hidden" class="sell-type" value="1"/></#if>
                                                                    </div>
                                                                    <div class="cb"></div>
                                                                </div>
                                                                <div class="cell g_price">
                                                                ...
                                                                <div class="cell g_promotion">
                                                                    ...
                                                                    <#assign oneweight="${oneweight?number+pro.productDetail.productVo.goodsInfoWeight?number*productNum?number}">
                                                                ...
                                                                <div class="cell g_count">
                                                                    ...
                                                                    ${productNum}件/套 X<span class="buyNum">${cars.goodsNum}</span>
                                                                        <input type="hidden" class="goods-num group-goods-num" value="${cars.goodsNum}"/>
                                                                    </div>
                                                                </div>
                                                                <div class="cell g_action">
                                                                    <div>
                                                ...
                                                <#setting number_format="0.00">
                                                <#assign tzxiaojiweight="${oneweight?number*cars.goodsNum?number}">
                                                ...
                                                <input type="hidden" class="xiaojiweight" value="${tzxiaojiweight}"/>
                                                <input type="hidden" name="oneweight" value="${oneweight}"/>
                                                ...
                                                <#assign  weight="${weight?number+tzxiaojiweight?number}">
                                            </div><!-- /cart_goods -->
                                            ...
                                            <div attr-codexType="0" class="marketgroup carts_${cars.shoppingCartId}" attr-group="0">
                                                ...
                                                <div class="cart_goods" id="cart_goods_${cars.shoppingCartId}">
                                                    <div class="cart_item">
                                                        ...
                                                        <div class="cell g_price">
                                                            <#setting number_format="0.00">
                                                            <#assign oneweight="${cars.goodsDetailBean.productVo.goodsInfoWeight?number}">
                                                            <#assign sumoneweight="${cars.goodsDetailBean.productVo.goodsInfoWeight?number*cars.goodsNum?number}">
                                                            <#--后台进行过金额处理-->
                                                            <#assign price=cars.goodsDetailBean.productVo.goodsInfoPreferPrice>
                                                        ...
                                                        <div class="cell g_count">
                                                            <div class="count">
                                                                <a href="javascript:void(0);" class="decrement" onclick="mit(this,${cars.shoppingCartId});">-</a>
                                                                <input type="text" class="text w30 goods-num" value="${cars.goodsNum}" attr-maxnum="${cars.goodsDetailBean.productVo.goodsInfoStock}" onblur="opblur(this,${cars.shoppingCartId});"/>
                                                                <#assign sumcount="${sumcount?number+cars.goodsNum?number}">
                                                                <a href="javascript:void(0);" class="increment" onclick="add(this,${cars.shoppingCartId});">+</a>
                                                ...
                                                <#assign xiaojiweight="${cars.goodsDetailBean.productVo.goodsInfoWeight?number*cars.goodsNum?number}">
                                                <#setting number_format="0.00">
                                                <input type="hidden" class="xiaojiweight" value="${sumoneweight}">
            ...
            <div class="cart_tools p10 lh180">
                <div class="fr w200">
                    ...
                    <p><span class="fr yuezhong">${(weight!'')?number/1000}kg</span>约重：</p>
                    <input type="hidden" id="weight" value="${(weight!'')?number/1000}"/>
                </div>
                <div class="fr mr10">
        ...
        <div class="cart_btn mt10">
            <a class="check_btn fr" id="go_accounts" onclick="_czc.push(['_trackEvent', '首页', '查看购物车', '去结算',  'go_accounts']);onpay();" style="background: #00991D;border-radius: 4px;font-weight:lighter;text-indent: 0px;text-align: center; font-family: '微软雅黑';font-size:15px;font-weight: bold;letter-spacing: 0.5px;">去结算</a>
            <a class="continue_shopping" id="to_continue_shopping" href="${basePath}/index.html" onclick="_czc.push(['_trackEvent', '首页', '查看购物车', '继续购物',  'to_continue_shopping']);">继续购物</a>
        </div><!-- /cart_btn -->
        ...
        <span class="dialog-bg dialog-bg-nw">
            ...
            <div class="dialog-inner">
                ...
                <div class="dialog-content clearfix">
                    ...
                    <div class="tc w200" id="diaText" style="margin-top:20px;width:480px;font-size: 15px;color: #000000;letter-spacing: 0.54px;font-weight: bold;">
                        确认从购物车中删除此商品？
                    </div>
...
<div class="dialog s_dia dia2" style="text-align: center;background: #f2f2f2">
    ...
    <div class="dia_cont">
        ...
        <div class="dia_ops mt50 tc" style="text-align: center; margin-top: 40px!important;">
...
<div class="dialog s_dia dia55" style="text-align: center;background: #f2f2f2">
    ...
    <div class="dia_cont">
        ...
        <div class="dia_ops mt50 tr"  style="text-align: center; margin-top: 40px!important;">
            <a class="go_pay" id="go_pay_00" href="javascript:cls();">确定</a>
        <#--<a class="go_shopping" href="javascript:cls();">取消</a>-->
        </div><!--/dia_ops-->
    </div><!--/dia_cont-->
...
<div class="dialog s_dia dia555" style="text-align: center;background: #f2f2f2">
    <div class="dia_tit clearfix">
        <h4 class="fl"></h4>
        <a class="dia_close fr" href="javascript:;" onclick="closeDia()"></a>
    </div><!--/dia_tit-->
    <div class="dia_cont" style="min-height: 10px;;">
        <div class="dia_intro no_tc">
            <em>尊敬的用户：</em>
            <em>此订单中不含批发商品，服务人员会尽快帮您把商品配送到您选择的社区店，确认请点击去结算哦！</em>
        </div>
        <div class="dia_ops mt10 tr"  style="text-align: center;">
            <a class="go_shopping" id="go_pay_00" href="javascript:;" onclick="onpay()" >去结算</a>
            <a class="go_pay" href="javascript:;" onclick="closeDia()" style="background:#76b700;border-radius: 4px;font-weight:lighter;border-color:#76b700!important">调整购物车</a>
        </div><!--/dia_ops-->
    </div><!--/dia_cont-->
</div>

<div class="dialog s_dia dia666" style="text-align: center;background: #f2f2f2">
    <div class="dia_tit clearfix">
        <h4 class="fl"></h4>
        <a class="dia_close fr" href="javascript:;" onclick="cls()"></a>
    </div><!--/dia_tit-->
    <div class="dia_cont" style="min-height: 120px;">
        <div class="dia_intro no_tc " style="text-align:left;padding-top:12px;">
            <em>尊敬的用户：</em>
            <em> 因商城优惠多，无法单个配送，零售商品的总数量须满足10个及以上，请及时调整，给您带来的不便，请谅解！</em>
        </div>
        <div class="dia_ops mt50 tr"  style="margin-top:20px;text-align: right;">
            <a class="go_shopping" href="javascript:;" onclick="cls()">调整购物车</a>
        </div><!--/dia_ops-->
    </div><!--/dia_cont-->
</div>
...
<div class="dialog s_dia dia4"  style="text-align: center;background: #f2f2f2">
    ...
    <div class="dia_cont">
        <div class="dia_intro no_tc " style="text-align: center;">
            <em>是否一键下单？</em>
        </div>
  ...
  /*  $(function () {
            ...
            if($(this).attr("attr-codextype") == "6"){
                ...
                $(this).find(".fullGiftAllPrices").each(function(){
                    if(parseFloat($(this).val()) >= parseFloat($(this).next(".grades").val())){
                        //满足赠送条件并且有赠品
                        if($(this).parent('.gift').children('p.light').length>0){
                            $(this).parent(".gift").show();
                        }
                    }
                })
    ...
    function mit(obj,cartId){
        if($(obj).parents(".marketgroup").attr("attr-codextype")!="-1"){
            var newrushnum = $(obj).next().attr('rush-maxnum');
            //获取 可用的最大库存和最小
            var minNum = 1;
            ...
            //抢购时的数量运算
            if(newrushnum != '0' && !!newrushnum){
                $(obj).next().val(setNum);
                /*抢购价*/
                var onePrice = $(obj).parents(".cart_goods").find(".oneprice").val();
                /*原价*/
                var rushonePrice = $(obj).parents(".cart_goods").find(".rushoneprice").val();
                //商品数量大于抢购限购数量时
                if(SubtrInt(setNum,Number(newrushnum))>0){
                   var ca = SubtrInt(setNum,newrushnum);
                    $(obj).parents(".cart_goods").find('.cell.g_price').find('.towspan').find('.gn').html(ca);
                   var xiaoji1 = accMul(onePrice,newrushnum);
                   var xiaoji2 = accMul(rushonePrice,ca);

                   var xiaoji = accAdd(xiaoji1,xiaoji2);
                }else if(SubtrInt(setNum,newrushnum)==0){
                    $(obj).parents(".cart_goods").find('.cell.g_price').find('.towspan').remove();
                    var xiaoji = accMul(onePrice,setNum);
                }else{
                    $(obj).parents(".cart_goods").find('.cell.g_price').find('.onespan').find('.gn').html(setNum);
                    var xiaoji = accMul(onePrice,setNum);
                }
                ...
                $(obj).next().val(setNum);
                $(obj).parents(".cart_goods").find('.cell.g_price').find('.threespan').find('.gn').html(setNum)
                var onePrice = $(obj).parents(".cart_goods").find(".oneprice").val();
                var xiaoji = accMul(onePrice,setNum);
                $(obj).parents(".cart_goods").find(".smprice").val(xiaoji);
                $(obj).parents(".cart_goods").find(".pv_smprice").text(xiaoji);
            }
            var oneweight = $(obj).parents(".cart_goods").find("input[name=oneweight]").val();
            var sumoneweight = accMul(oneweight,setNum);
            $(obj).parents(".cart_goods").find("input[name=sumoneweight]").val(sumoneweight);
            var num = $(obj).parents(".cart_goods").find(".text").val();
            var nowAll;
            //赠送类型0金额1件数
            var presentType = $(obj).parents(".marketgroup").attr("attr-pretype");
            ...
            if(flag == 0 ){
                ...
                $(obj).parents(".marketgroup").find(".cart_item_goods").each(function(){
                    ...
                    $(this).find(".group-goods-num").val(nowNum);
        ...
        updateCookie(obj,cartId,setNum);
    }

    function updateCookie(obj,cartId,setNum){
        //及时更新cookie中购物车信息(_npstore_shopcar)(,7553-1&8e,7361-1&8e)
        var newCookie = "";
        var split = getCookie("_npstore_shopcar").split("e");
        for(var i=0;i<split.length;i++) {
            if (split[i].length > 3) {
                var product = split[i].substring(1);
                if (product.split("-")[0] == cartId) {
                    var distinct = $(".ch_distinctId").val();
                    //var goodsNum = $(obj).parent().find(":input").val();
                    var goodsNum = setNum;
                    newCookie += "," + cartId + "-" + goodsNum + "&"+product.split("-")[1].split("&")[1]+"e";
                } else {
                    var np = product.split("-")[1];
                    newCookie += "," + product.split("-")[0] + "-" + np.split("&")[0] + "&" + np.split("&")[1] + "e";
                }
            }
        }
        setCookie("_npstore_shopcar",newCookie);
    }

    function opblur(obj,cartId){

        if($(obj).parents(".marketgroup").attr("attr-codextype")!="-1"){
            var newrushnum = $(obj).attr('rush-maxnum');
            ...
            if(newrushnum != '0' && !!newrushnum){
                ...
                var rushonePrice = $(obj).parents(".cart_goods").find(".rushoneprice").val();
                    ...
                    if(SubtrInt(setNum,Number(newrushnum))>0){
                        var ca = SubtrInt(setNum,newrushnum);
                        if($(obj).parents(".cart_goods").find('.cell.g_price').find('.towspan').length>0){
                            $(obj).parents(".cart_goods").find('.cell.g_price').find('.towspan').html('￥'+rushonePrice+'&nbsp;&nbsp;'+'x<em class="gn">'+ca+'</em>');
                        }else{
                            $(obj).parents(".cart_goods").find('.cell.g_price').prepend($('<span class="towspan">￥'+Number(rushonePrice).toFixed(2)+'&nbsp;&nbsp;x<em class="gn">'+ca+'</em></span>'));
                        }
                        var xiaoji1 = accMul(onePrice,newrushnum);
                        var xiaoji2 = accMul(rushonePrice,ca);
                        var xiaoji = accAdd(xiaoji1,xiaoji2);
    ...
    function add(obj,cartId){
        ...
        if($(obj).parents(".marketgroup").attr("attr-codextype")!="-1"){
            ...
            setNum = Math.min(99,setNum);
            var newrushnum = $(obj).prev().attr('rush-maxnum');
            //抢购时的数量运算
            if(newrushnum != '0' && !!newrushnum){
                $(obj).prev().val(setNum);
                var onePrice = $(obj).parents(".cart_goods").find(".oneprice").val();
                var rushonePrice = Number($(obj).parents(".cart_goods").find(".rushoneprice").val());
                if(SubtrInt(setNum,Number(newrushnum))>0){
                    $(obj).parents(".cart_goods").find('.cell.g_price').find('.onespan').find('.gn').html(newrushnum);
                    var ca = SubtrInt(setNum,newrushnum);
                    /*如果有就直接给内容  如果不存在就加一个   表示抢购以外的价格*/
                    if(!$(obj).parents(".cart_goods").find('.cell.g_price').find('.towspan').length>0){
                        $(obj).parents(".cart_goods").find('.cell.g_price').prepend($('<span class="towspan">￥'+rushonePrice.toFixed(2)+'&nbsp;&nbsp;x<em class="gn">'+ca+'</em></span>'));
                    }else{
                        $(obj).parents(".cart_goods").find('.cell.g_price').find('.towspan').html('￥'+rushonePrice.toFixed(2)+'&nbsp;&nbsp;x<em class="gn">'+ca+'</em>')
                    }
                    var xiaoji1 = accMul(onePrice,newrushnum);
                    var xiaoji2 = accMul(rushonePrice,ca);
                    var xiaoji = accAdd(xiaoji1,xiaoji2);
    ...
    function jisuan(obj){
        ...
        $(obj).parents(".marketgroup").find(".mjchecked").each(function(){
            ...
            if($(this)[0].checked){
                ...
                var thisweight = $(this).parents(".cart_goods").find("input[name=sumoneweight]").val();
                weight = accAdd(thisweight,weight);
            }
...
//        }
    ...
    function onpay(){
        cls();
        if ($(".check_btn").hasClass('loadingtwo')) return;
        if( myBrowser() == "Safari"){
            $(".check_btn").html("正在结算...");
        }else {
            $(".check_btn").addClass('loadingtwo').html("");
        }
        //提交时关闭弹窗，防止多个重叠
        ...
        $(".mjchecked").each(function(){
            if($(this)[0].checked){
                ...
                if ($(this).parents(".cart_goods").find(".sell-type").val() == '1') {
                    $(this).parents(".cart_goods").find(".goods-num").each(function () {
                        pifaCount = pifaCount + parseInt($(this).val());
                    });
//                    pifaCount = pifaCount + parseInt($(this).parents(".cart_goods").find(".goods-num").val());
                }
                if ($(this).parents(".cart_goods").find(".sell-type").val() == '0') {
                    $(this).parents(".cart_goods").find(".goods-num").each(function () {
                        lingshouCount = lingshouCount + parseInt($(this).val());
                    });
//                    lingshouCount = lingshouCount + parseInt($(this).parents(".cart_goods").find(".goods-num").val());;
                }
            }
        });
        ...
        if(onpayCount<1 && pifaCount<1 && lingshouCount>0) {
            onpayCount ++;
            /*dia(555);
            return;*/
        } else {
                ...
                if(limit==1){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            $("#subForm").submit();
                            if(myBrowser() == "Safari"){
                                $(".check_btn").removeClass('loadingtwo').html($("#button_hide").val());
                            }
                        }
                    });
                }
