...
public class ProductWareServiceImpl extends BasicSqlSupport implements
     ...
     * @return
     */
    public List<ProductWare> queryGoodsStock(Long productId){
        Map map = new HashMap();
        try{
            map.put("productId",productId);
            return  this.productWareMapper.queryGoodsStock(map);
        }finally {
            map = null;
        }
    }
    ...
    public ProductWare queryAllInfoByProductIdAndWareId(Map map) {
        return productWareMapper.queryAllInfoByProductIdAndWareId(map);
    }
    ...
    public int updateByProductIdAndWareId(Map map) {
        return productWareMapper.updateByProductIdAndWareId(map);
    }

    public int updateByPrimaryKeySelective(ProductWare productWare){
        return productWareMapper.updateByPrimaryKeySelective(productWare);
    }
