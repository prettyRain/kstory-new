            ...
            if(codexType!='0'){
                if(obj.checked){
                    ...
                    if(codexType=='1'){
                        ...
                        var xiaoji = 0;
                        $(obj).parents(".marketgroup").find(".mjchecked").each(function(){
                            var onesumprice = $(obj).parents(".cart_goods").find(".smprice").val();
                            xiaoji = accAdd(onesumprice,xiaoji);
                        })
                        $(obj).parents(".marketgroup").find(".youhui").val(0);
                        $(obj).parents(".marketgroup").find(".xiaoji").val(xiaoji);
...
<div class="container">
    ...
    <div style="font-family: arial;">
                                        ...
                                        <#--折扣促销-->
                                            <#if market.codexType=='15'>
                                                <div class="activity">
                                                    <div class="fl w500 ml15"   style="height:31px; line-height:31px;overflow:hidden;">
                                                    ${market.marketingName}
                                                    ${(market.preDiscountMarketings[0].discountInfo*10)?string('0.#')}折抢购
                                                    </div>
                                                    <div class="fl">
                                                    </div>
                                                </div>
        ...
        <div class="cart_btn mt10">
            <a class="check_btn fr" href="javascript:void(0);" onclick="onpay();" style="background:#76b700;border-radius: 4px;font-weight:lighter;">去结算></a>
...
<div class="dialog s_dia dia666" style="text-align: center;background: #f2f2f2">
    ...
    <div class="dia_cont" style="min-height: 120px;">
        <div class="dia_intro no_tc pt30" style="text-align:left;padding-top:12px;">
            <em>尊敬的用户：</em>
...
<script type="text/javascript">
    ...
    function mit(obj,cartId){
        ...
        updateCookie(obj,cartId);
    }

    function updateCookie(obj,cartId){
