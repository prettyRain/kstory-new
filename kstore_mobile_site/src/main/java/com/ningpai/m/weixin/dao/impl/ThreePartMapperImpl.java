...
public class ThreePartMapperImpl extends BasicSqlSupport implements ThreePartMapper {
     ...
     */
    @Override
    public void deleteThreepart(String openid) {
        this.delete("com.ningpai.web.dao.ThreePartMapper.deleteThreepart",openid);
    }
     ...
     */
    @Override
    public ThreePart queryPartByMobile(Map map) {
        return this.selectOne("com.ningpai.web.dao.ThreePartMapper.queryPartByMobile",map);
    }
