...
<title><#if (map.cInfoType??)>${map.cInfoType.name}-<#else >资讯中心-</#if>${topmap.systembase.bsetName}</title>
								...
								<#list infoType.childs as infoT2 >
									<#if (infoT2.infos??)>
										<#list infoT2.infos as info2 >
                                            <li ><a href="${basePath}/information/${info2.infoId}">
											${info2.title?default("")}</a></li>
										</#list>
									</#if>
										<#--<li <#if (map.cInfoType??
										&& infoT2.infoTypeId == map.cInfoType.infoTypeId)>class="cur"</#if>><a href="${basePath}/information/list/${infoT2.infoTypeId}">
										${infoT2.name?default("")}</a></li>-->
								</#list>
							</#if>
							<#if (infoType.infos??)>
								<#list infoType.infos as info1 >
                                    <li ><a href="${basePath}/information/${info1.infoId}">
                            	...
                            	<table class="orders common_table">
	                                <tr>
									    ...
									    <tr>
									    	...
									    	<#--<td>${info.author}</td>-->
									    	<td>${info.createDate?string("yyyy-MM-dd")}</td>
