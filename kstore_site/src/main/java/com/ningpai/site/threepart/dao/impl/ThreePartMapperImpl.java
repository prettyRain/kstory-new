...
public class ThreePartMapperImpl extends BasicSqlSupport implements ThreePartMapper {
    ...
    @Override
    public ThreePart selectThreePartByUidAndType(Map<String, Object> paramMap) {
        return this.selectOne("com.ningpai.web.dao.ThreePartMapper.selectThreePartByUidAndType", paramMap);
    }
}
