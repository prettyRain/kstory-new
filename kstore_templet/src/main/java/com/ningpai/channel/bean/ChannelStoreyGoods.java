...
public class ChannelStoreyGoods implements Serializable{
    ...
    public String getPromationinfo() {
        return promationinfo;
    }

    public void setPromationinfo(String promationinfo) {
        this.promationinfo = promationinfo;
    }
    //促销信息
    private  String promationinfo;
    /**
     * 商品IＤ
     * 
     * @return Long
