                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);"
                                               onclick="previewGoods(${product.goodsInfoId});">预览</a>
                                        </li>
                                    </ul>
                                </div>--%>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" onclick="previewGoods(${product.goodsInfoId});">预览</button>
                                        <%--<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                            <span class="caret"></span>
                                            <span class="sr-only">Toggle Dropdown</span>
                                        </button>
...
<script>
    function previewGoods(goodsInfoId){
        $("#mainFrame").attr("src",'previewGoods.htm?CSRFToken=${token}&goodsInfoId='+goodsInfoId);
