...
public class EmailUtils {
    ...
    public int sendEmails(HttpServletRequest request, String infoEmail, GoodsProduct goodsProduct) {
        ...
        try {
            ...
            String a = "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>邮箱验证</title></head><body><div style='width:800px;margin:20px auto;padding:0;'><table style='width:100%;'><tr><td style='text-align:left;'>"
                    + HTMLTAG + url + "'><img alt=''src='http://img01.ningpai.com/1420353506813.jpg'/></a></td><td style='text-align:right;'>";
            a += HTMLTAG
                    + url
                    + "/customer/index.html'style='font-family:microsoft YaHei;font-size:14px;color:#555;background:url(images/member_center.png) no-repeat left center;padding-left:20px;text-decoration:none;margin-left:10px;'>个人中心</a>"
                    + HTMLTAG
                    + url
                    + "/help/135.html'style='font-family:microsoft YaHei;font-size:14px;color:#555;background:url(images/help_center.png) no-repeat left center;padding-left:20px;text-decoration:none;margin-left:10px;'>帮助中心</a></td></tr></table>"
                    + "<div style='margin-top:10px;overflow:hidden;text-align:center'><a href='www.ge960.com'><img alt=''src='http://youtuding.b0.upaiyun.com/1405417459486.jpg'/></a></div><div style='margin:0;padding:20px;'><h1 style='font-family:microsoft YaHei;font-size:18px;color:#333;font-weight:500;margin:0 0 10px;padding:0;'>";

            if (null != goodsProduct.getOfollowPrice()) {
                a += "尊敬的960用户，您好:</h1><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'>您好亲！您所关注的" + goodsProduct.getDisName()
                        + "地区的,商品名为：" + goodsProduct.getGoodsInfoName() + "的商品，由" + goodsProduct.getOfollowPrice() + "元,降到了" + goodsProduct.getNfollowPrice() + "元,快来选购吧!</p>";
            } else {
                a += "尊敬的960用户，您好:</h1><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'>我们的" + goodsProduct.getGoodsInfoName()
                        + "商品降价啦，快来选购吧!</p>";
            }
            a += "<p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'><br/>如有任何疑问，请拔打热线：400-808-8880</p></div><div style='font:18px microsoft YaHei;color:#0054a7;height:44px;line-height:44px;text-align:center;background:#dbedff;'>感谢您使用中国960官方商城，祝您购物愉快</div><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:20px;line-height:180%;'>收到此邮件，说明您已是960尊贵的会员。<br/>为确保您接受的服务信息不被当做垃圾邮件处理，请将<a href='javascript:;'style='color:#005aa0;'>service@ge960.com</a>添加为联系人。</p><div style='font:14px tahoma,arial,\5b8b\4f53;color:#999;text-align:center;margin-top:10px;'>Copyright©2015，中国960官方商城  版权所有</div></div></body></html>";
     ...
     * @return
     */
    public int sendANPosts(HttpServletRequest request, GoodsProductVo goodsProductVo, String[] mobile) {
        Sms sms = mapper.selectSms();
        if (sms == null) {
            return 0;
        }
        try {
            SmsPosts.sendANPost(sms, goodsProductVo, mobile);
        } catch (IOException e) {
            LOGGER.error(""+e);
            Customer cust = (Customer) request.getSession().getAttribute("cust");
            OperaLogUtil.addOperaException(cust.getCustomerUsername(), e, request);
     ...
     * @return
     */
    public int sendANEmails(HttpServletRequest request, GoodsProductVo goodsProductVo, String infoEmail) {
        Session session = getSession();
        session.setDebug(true);
        MimeMessage message = new MimeMessage(session);
        try {
            ...
            url = url.substring(0, url.lastIndexOf("/"));
            String a = "<!DOCTYPE html><html><head><meta charset='UTF-8'><title>邮箱验证</title></head><body><div style='width:800px;margin:20px auto;padding:0;'><table style='width:100%;'><tr><td style='text-align:left;'>"
                    + HTMLTAG + url + "'></a></td><td style='text-align:right;'>";
            a += HTMLTAG
                    + url
                    + "/customer/index.html'style='font-family:microsoft YaHei;font-size:14px;color:#555;background:url(images/member_center.png) no-repeat left center;padding-left:20px;text-decoration:none;margin-left:10px;'>个人中心</a>"
                    + HTMLTAG
                    + url
                    + "/help/135.html'style='font-family:microsoft YaHei;font-size:14px;color:#555;background:url(images/help_center.png) no-repeat left center;padding-left:20px;text-decoration:none;margin-left:10px;'>帮助中心</a></td></tr></table>"
                    + "<div style='margin-top:10px;overflow:hidden;text-align:center'><a href='www.ge960.com'></a></div><div style='margin:0;padding:20px;'><h1 style='font-family:microsoft YaHei;font-size:18px;color:#333;font-weight:500;margin:0 0 10px;padding:0;'>";

            a += "尊敬的960用户，您好:</h1><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'>您好亲！您所关注的商品名为：" + goodsProductVo.getGoodsInfoName() + "的商品到货了,快来选购吧!</p>";
            a += "<p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:0;line-height:180%;'><br/>如有任何疑问，请拔打热线：400-808-8880</p></div><div style='font:18px microsoft YaHei;color:#0054a7;height:44px;line-height:44px;text-align:center;background:#dbedff;'>感谢您使用中国960官方商城，祝您购物愉快</div><p style='font:14px tahoma,arial,\5b8b\4f53;color:#555;margin:0;padding:20px;line-height:180%;'>收到此邮件，说明您已是960尊贵的会员。<br/>为确保您接受的服务信息不被当做垃圾邮件处理，请将<a href='javascript:;'style='color:#005aa0;'>service@ge960.com</a>添加为联系人。</p><div style='font:14px tahoma,arial,\5b8b\4f53;color:#999;text-align:center;margin-top:10px;'>Copyright©2015，中国960官方商城   版权所有</div></div></body></html>";
            message.setContent(a, "text/html;charset=utf-8");
            // HTMLTAG + str+"'>亲爱的用户，请点击验证邮箱</a>","text/html;charset=utf-8"
            Transport.send(message);
