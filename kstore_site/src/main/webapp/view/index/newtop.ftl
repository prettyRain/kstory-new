    	...
    	<div class="top_wp clearfix">
            ...
            <!--	<#if cust??>
                ...
                <li class="my_store pr">
                    ...
                    <a class="m_store" href="${basePath}/customer/index.html" target="_blank">我的${topmap.systembase.bsetName}<b></b></a>
                   ...
                   <li><span class="t_line">|</span><a href="${basePath}/help/92" target="_blank">帮助中心</a></li>
            </ul><!--/top_nav-->
            <#if cust??>
