...
public class CustomerAddressMapperImpl extends BasicSqlSupport implements CustomerAddressMapper {
    ...
    @Override
    public List<Object> queryCustomerAddressByType(Map<String,Object> map) {
        return this.selectList("com.ningpai.m.customer.mapper.CustomerAddressMapper.selectByTypes", map);
    }
    ...
    @Override
    public int cancelDefaultAddress(Long customerId) {
        return this.update("com.ningpai.m.customer.mapper.CustomerAddressMapper.cancelDefaultAddress", customerId);
    }

    @Override
    public int setDefaultAddress(Map<String,Long> map) {
        return this.update("com.ningpai.m.customer.mapper.CustomerAddressMapper.setDefaultAddress", map);
    }
