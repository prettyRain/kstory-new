...
<#assign subjectId="${subject.subjectId}">
...
$(function(){
    ...
    $(".navLinks ul").find("li").each(function(){
        $(this).find("a").removeClass("on");
        console.log($(this).find("a").attr("data-subjectId"));
        console.log($(this).find("a").attr("data-subjectId")==${subjectId});
        if($(this).find("a").attr("data-subjectId")==${subjectId}){
            $(this).find("a").addClass("on");
		}
    });
});
