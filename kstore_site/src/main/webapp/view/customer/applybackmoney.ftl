...
<head>
    ...
    <style>
        ...
        .voucher-imgs .cur img {padding: 0px;border-width: 2px;border-style: solid; border-color: red;}
        .voucher-imgs .cur img {
                ...
                <form id="upload-form" name="upload-form" method="post" enctype="multipart/form-data" target="hidden_frame">
                    ...
                    <div class="back-orders">
                                ...
                                <div class="form-group">
                                    <#--<div class="form-item" style="display:none">
                                        ...
                                        <div class="controls return-choose">
                                            ...
                                            &lt;#&ndash;<label class="choose-label"><input name="isBack" class="isBack" type="radio" value="2"/>退款</label>&ndash;&gt;
                                        </div>
                                    </div>-->
                                    <div class="form-item">
                                        <label class="control-label"><span style="color:red;">*</span>是否退货：</label>
                                        <div class="controls">
                                            <p><label class="choose-label"><input class="type-pics" type="radio" name="returnType" value="0" checked/>退货退款</label></p>
                                            <p><label class="choose-label"><input class="type-pics" type="radio" name="returnType" value="1"/>仅退款</label></p>
                                        </div>
                                    </div>
                                    <div class="form-item">
                                    ...
                                    <div class="form-item" id="returnPrice01">
                                        ...
                                        <input type="hidden" id="maxBackPrice"/>
                                        <div class="controls">
                                            <#if  isUseCoupon??&&isUseCoupon=='0'>
                                                <input type="text" value="0.00" class="form-control" name="backPrice" id="backPrice" maxlength="9"/>
                                            <#else>
                                                <input type="text" value="${price}" class="form-control" name="backPrice"  id="backPrice" maxlength="9"/>
                                            </#if>
                                    ...
                                    <div class="form-item">
                                        ...
                                        <div class="controls">
                                            <label class="choose-label"><input name="backWay" id="backWay" type="radio" value="0" checked="checked"/><#--快递-->上门取件</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <h3><span style="color:red;">*</span>选择退货商品</h3>
                                ...
                                <div class="item-cont">
                                    <table class="order-table">
                                        <thead>
                                        <tr>
                                            <#if  isUseCoupon??&&isUseCoupon=='0'><th><input type="checkbox" id="chooseAll" onclick="selectAll(this)"/></th></#if>
                                        ...
                                        <tbody>
                                            ...
                                            <#list backorder.goods as border>
                                                ...
                                                <#--<#if  staCheck??&staCheck='0'> <td><input type="checkbox" name="backGoodsId" id="${border.goodsId!''}_back" onclick="getprice(${border.goodsId},${border.goodsInfoSumPrice},${border.goodsNum})" value="${border.goodsId!''}" class="back_goods_id"/></td></#if>-->
                                                    <#if border.goodsCouponPrice??>
                                                        <#assign goodsCouponPrice = border.goodsCouponPrice>
                                                    <#else>
                                                        <#assign goodsCouponPrice = 0>
                                                    </#if>
                                                    <#assign giftCard=0>
                                                    <#if border.goodsName??&& (border.goodsName?index_of("电子卡")!=-1 || border.goodsName?index_of("实体卡")!=-1)><#assign giftCard=giftCard+1></#if>

                                                    <#if  isUseCoupon??&&isUseCoupon=='0'> <td><#if giftCard == 0><input type="checkbox" name="backGoodsId" id="${border.goodsId!''}_back" onclick="getprice(${border.goodsId},${border.orderGoodsId},${border.goodsInfoSumPrice?string('0.00')},<#if border.returnMoney??>${border.returnMoney?string('0.00')}<#else>0.00</#if>,${border.goodsNum},this)" value="${border.goodsId!''}" class="back_goods_id"/></#if></td></#if>
                                                    ...
                                                    <td>
                                                        ...
                                                        ${border.goodsPrice?string('0.00')}&nbsp;&nbsp;x${border.goodsNum}
                                                        </#if>-->
                                                            <#if border.countRush?? && border.countRush?number!=0>
                                                                <#if border.goodsNum?number gt border.countRush?number>
                                                                    <span class="doubleprice"><#if border.goodsPrice??>
                                                                        ￥${border.goodsPrice?string('0.00')}
                                                                    </#if>
                                                                        <#if border.countRush??>
                                                                            x${border.countRush}
                                                                        </#if></span>
                                                                    <span class="doubleprice"><#if border.oldGoodsPrice??>
                                                                        ￥${border.oldGoodsPrice?string('0.00')}
                                                                    </#if>
                                                                        <#if border.goodsNum??>
                                                                            x${border.goodsNum?number-border.countRush?number}
                                                                        </#if></span>
                                                                <#else>
                                                                    <span class="doubleprice"><#if border.goodsPrice??>
                                                                        ￥${border.goodsPrice?string('0.00')}
                        ...
                        <div class="operation-box">
                            ...
                            <button class="btn btn-default" type="button" onclick="location.href='${basePath}/customer/myorder.html'">取消</button>
                        </div>
                    </div>

                    <input type="hidden" value="${staCheck}" id="staCheck"/>
                    <input type="hidden" value="${isUseCoupon}" id="isUseCoupon"/>
                    <input type="hidden" name="orderId" value="${order.orderId}"/>
                    <input type="hidden" name="orderCode" value="${order.orderCode}"/>
                    <input type="hidden" name="backPrice" value="${backorder.moneyPaid}"/>
                    <input type="hidden" id="paidMoney" value="${backorder.moneyPaid}"/>
                </form>
    ...
    <div class="member-dialog-body">
        ...
        <div class="tc">
            <div class="que-delete clearfix">
                <img src="${basePath}/images/images_l6.png"/>
                <div class="fl tl">
                    <p class="f16 red" id="titleerr">上传图片格式不正确！</p>
    ...
    <div class="member-dialog-body">
        ...
        <div class="tc">
            <div class="que-delete clearfix">
                <img src="${basePath}/images/images_l6.png"/>
                <div class="fl tl">
                    <p class="f16 red" id="titleerr">每张图片不超过4M！</p>
...
<script type="text/javascript" src="${basePath}/js/customer/applybackmoney.js?v=1212"></script>
...
//申请退单时，放大的图片点击收起
    $(".photo_viewer").find("img").click(function(){
        $(".photo_viewer").hide().width(0).height(0);
        $(this).attr("src","").width(0).height(0);
        $(".voucher-imgs").find(".cur").removeClass("cur");
    });
})
</script>
</body>
