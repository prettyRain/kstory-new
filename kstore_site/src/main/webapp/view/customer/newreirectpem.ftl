                    ...
                    <div class="new_order_list">
                        ...
                        <div class="s-amend">
                            <div class="amend-step">
                                ...
                                <form method="post" action="${basePath}/validate/modifypem.htm" id="upMobile" onsubmit="return false;">
                                        ...
                                        <#if (type=='pwd' )>
                                            <div class="n_password ml30">
                                                <div class="n_item clearfix mb20">
                                                    ...
                                                    <div class="fl">
                                                        <input type="password"tabindex="1" name="newStr" id="npwd" class="text mr20">
                                                ...
                                                <div class="n_item clearfix mb20">
                                                    ...
                                                    <div class="fl">
                                                        <input type="password" tabindex="2" id="repwd" class="text mr20">
                                                ...
                                                <div class="n_item clearfix mb20">
                                                    ...
                                                    <input type="button" class="nw-submit" onclick="updatepem('${type}')"  value="提交" disabled="true" style="background-color:#999999;">
                                                    <script>
                                        ...
                                        <#elseif (type == 'mobile')>
                                            <div class="n_password ml30">
                                                ...
                                                <div class="n_item clearfix mb20">
                                                    <span class="label fl"><span class="tip-d">*</span>验证码：</span>
                                                    <div class="fl">
                                                        <input type="text" id="code" name="code" placeholder="请输入验证码" class="short_text mr20">
                                                        <img id="checkCodeImg" class="vm ml5" src="${basePath}/patchca.htm" alt="验证码" style="cursor:pointer;" onclick="this.src=this.src+'?'+Math.random(); " />
                                                        <a id="checkCodeA" href="javascript:void(0)" class="ml20 ju_s f14"><span class="col6">看不清？</span ">换一张</a>
                                                        <div class="ne_tips hide code_tip">您输入的验证码有误</div>
                                                    </div>
                                                ...
                                                <div class="n_item clearfix mb20">
                                                    ...
                                                    <div class="fl">
                                                        <input class="short_text mr20" name="newStr" maxLength="11" id="mobile" type="text" <#--onkeyup="checkM($(this))"-->/>
                                                        <a class="hq_code" id="sendCode" onclick="getCode()" disabled="disabled">发送短信验证码</a>
                                                ...
                                                <div class="n_item clearfix mb20">
                                                    ...
                                                    <div class="fl">
                                                        <input class="short_text yz_text" id="mcode" type="text" style="width:110px;" disabled="disabled" />
                                        ...
                                        <#elseif (type == 'email')>
                                            <div class="n_password ml30">
                                                <div class="n_item clearfix mb20">
                                                    ...
                                                    <div class="fl">
                                                        <input class="text mr20" id="email" type="text" <#--onkeyup="checkE($(this))"-->/>
                                                ...
                                                <div class="n_item clearfix mb20">
                                                    <span class="label fl">&nbsp;</span>
                                                    <div class="fl">
                                                        <input id="sendValidEmail" type="button" class="send-mail-yj" onclick="updatepem('${type}')" value="发送验证邮件" disabled="true" style="background-color:#999999;">
                                                    </div>
                                                </div>
                                                <script>
                                                    document.onkeydown=function(event){
