...
public class ChannelStorey implements Serializable{
    ...
    /** 楼层商品 */
    private List<ChannelStoreyGoods> channelStoreyGoods;

    public List<ChannelStoreyGoods> getChannelStoreyGoods() {
        return channelStoreyGoods;
    }

    public void setChannelStoreyGoods(List<ChannelStoreyGoods> channelStoreyGoods) {
        this.channelStoreyGoods = channelStoreyGoods;
    }
