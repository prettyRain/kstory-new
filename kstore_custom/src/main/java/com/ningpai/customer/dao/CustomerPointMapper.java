...
public interface CustomerPointMapper {
     ...
     * @return 返回会员的所有积分记录
     */
    List<CustomerPoint> queryCustomerAllPoints(String customerId);
     ...
     * @return
     */
    int updateOrderPoint(Map<String, Object> params);
     ...
     * @return  返回会员的所有积分总和
     */
    Integer queryCustomerAllPointsSimple(String customerId);
    /**
     * 获得订单取消或退货退款的返回的积分和退货扣除的订单消费系统赠送积分
     */
    Integer queryCustomerOrderSubtractPoint(String customerId);
}
