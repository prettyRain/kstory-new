...
public class ChannelStoreyAdverController {
    ...
    public ModelAndView queryChannelStoreyAdverByPageBean(PageBean pb, Long storeyId, HttpServletRequest request) {
        ...
        return new ModelAndView("jsp/channel/channel_storey_adver_list", "pb", channelAdverService.selectchannelAdverByParam(pb, null, null, storeyId, null, ATID, ADVERTTYPE,
                null, null,null)).addObject("channelStorey", channelStorey);
    }
    ...
    @ResponseBody
    public Map<String, Object> queryChannelStoreyAdverByPageBeanAjax(PageBean pb, Long storeyId,Long channelId,Long navId, HttpServletRequest request) {
        // 声明Map
        Map<String, Object> map = new HashMap<String, Object>();
        // 查询频道页广告
        map.put("pb", channelAdverService.selectchannelAdverByParam(pb, channelId, null, storeyId, null, ATID, ADVERTTYPE, null, null,navId));
        return map;
    }
     ...
     * @return Map
     */
    @RequestMapping("/querychannelslideadverbypagebeanajax")
    @ResponseBody
    public Map<String, Object> queryChannelSlideAdverByPageBeanAjax(PageBean pb,Long channelId,Long navId, HttpServletRequest request) {
        // 声明Map
        Map<String, Object> map = new HashMap<String, Object>();
        // 查询频道页广告
        map.put("pb", channelAdverService.selectchannelAdverByParam(pb, channelId, null, null, null, null, ADVERTTYPE, null, null,navId));
        return map;
    }
    /**
     * 查看频道楼层广告
