...
public class OrderNoticeMapperImpl extends BasicSqlSupport implements
    ...
    @Override
    public void updateNoticeRead(Long customerId) {
        this.update("com.ningpai.m.customer.dao.OrderNoticeMapper.updateNoticeRead", customerId);
    }

    @Override
    public void removeNoticeAll(Long customerId) {
        this.update("com.ningpai.m.customer.dao.OrderNoticeMapper.removeNoticeAll", customerId);
    }
