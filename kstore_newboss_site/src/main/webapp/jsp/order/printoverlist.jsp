        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
            ...
            <div class="main_cont">
				  ...
				  <c:if test="${order.orderLinePay eq 0}">货到付款</c:if></span> </p>
                    ...
                    <div class="btns">
                      ...
                      <b> - </b>
                        ...
                        <a href="javascript:;" onclick="pickingOrderIdTwo(${order.orderId },'2');">打印</a>
                        </c:if>
                        <%--已出库--%>
                        <c:if test="${status eq 0}">
                        <a href="javascript:;" onclick="pickingOrderIdTwo(${order.orderId },'3');">打印</a>
                        </c:if>
                        <%--已拣货--%>
                ...
                <tr>
                  ...
                  <td align="center">
                      <c:if test="${order.orderStatus eq 0}"><span class="label label-danger">未付款</span></c:if>
                      ...
                      <c:if test="${order.orderStatus eq 7}"><span class="label label-danger">退单审核中</span></c:if>
                      <c:if test="${order.orderStatus eq 8}"><span class="label label-info">同意退货</span></c:if>
                      <c:if test="${order.orderStatus eq 9}"><span class="label label-info">拒绝退货</span></c:if>
                      <c:if test="${order.orderStatus eq 10}"><span class="label label-info">待商家收货</span></c:if>
                      <c:if test="${order.orderStatus eq 11}"><span class="label label-info">退单结束</span></c:if>
                      <c:if test="${order.orderStatus eq 12}"><span class="label label-danger">退款审核中</span></c:if>
                      <c:if test="${order.orderStatus eq 13}"><span class="label label-info">拒绝退款</span></c:if>
                      <c:if test="${order.orderStatus eq 14}"><span class="label label-info">已提交退货审核 </span></c:if>
                      <c:if test="${order.orderStatus eq 15}"><span class="label label-info">已提交退款审核</span></c:if>
                      <c:if test="${order.orderStatus eq 16}"><span class="label label-info">收货失败</span></c:if>
                      <c:if test="${order.orderStatus eq 17}"><span class="label label-info">已退款</span></c:if>
                  </td>
                  <td align="center">
    ...
    <div class="modal-dialog modal-lg" id="updatexcy">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="doPrint5();">打印</button>
