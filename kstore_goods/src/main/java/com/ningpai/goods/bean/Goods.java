...
public class Goods {
     ...
     *pc 商品规格详情
     */
    private String goodsSpecsificationDesc;
    /**
     * pc商品包装详情
     */
    private String goodsWarpDesc;
    /**
     * pc商品品牌故事
     */
    ...
    public String getGoodsSpecsificationDesc() {
        return goodsSpecsificationDesc;
    }

    public void setGoodsSpecsificationDesc(String goodsSpecsificationDesc) {
        this.goodsSpecsificationDesc = goodsSpecsificationDesc;
    }

    public String getGoodsWarpDesc() {
        return goodsWarpDesc;
    }

    public void setGoodsWarpDesc(String goodsWarpDesc) {
        this.goodsWarpDesc = goodsWarpDesc;
    }

    public String getGoodsBrandDesc() {
        return goodsBrandDesc;
    }

    public void setGoodsBrandDesc(String goodsBrandDesc) {
        this.goodsBrandDesc = goodsBrandDesc;
    }
    ...
    public void addStyleForSpecsificationDesc(){
        if(StringUtils.isNotEmpty(this.goodsSpecsificationDesc)){
            this.goodsSpecsificationDesc = this.goodsSpecsificationDesc.replaceAll("<p>", "<p style=\"word-break: break-all;\">");
        }
    }
    public void addStyleForWarpDesc(){
        if(StringUtils.isNotEmpty(this.goodsWarpDesc)){
            this.goodsWarpDesc=this.goodsWarpDesc.replaceAll("<p>", "<p style=\"word-break: break-all;\">");
        }
    }
    public void addStyleForBrandDesc(){
        if(StringUtils.isNotEmpty(this.goodsBrandDesc)){
            this.goodsBrandDesc=this.goodsBrandDesc.replaceAll("<p>", "<p style=\"word-break: break-all;\">");
        }
    }
