            ...
            <div class="main_cont">
                ...
                <div class="common_info common_tabs mt20">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" onclick="changeStatus(0)" class="active" data="1"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">单品促销</a></li>
                        <li role="presentation" onclick="changeStatus(1)" data="2"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">类目促销</a></li>
                        <li role="presentation" onclick="changeStatus(2)" data="3"><a href="#tab3" aria-controls="tab2" role="tab" data-toggle="tab">品牌促销</a></li>
                    </ul>
                            ...
                            <div class="common_form common_form_lg p20">
                                ...
                                <form class="form-horizontal" action="doaddcouponnew.htm?CSRFToken=${sx}"    id="subFormOne" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control required specstr"  name="couponName" maxlength="20">
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <span id="ps1" class="spanweight"></span>
                                        </div>
                                        <div class="col-sm-1"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <span id="ps2" class="spanweight"></span>
                                        </div>
                                        <div class="col-sm-1"></div>
                                    </div>
                                    ...
                                    <%--</div>--%>
                                    <div class="form-group">
                                        <label class="control-label col-sm-4">领取方式：</label>
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-12">
                                            <div class="checkbox">
                                                <label><%--0领取  1购物赠送--%>
                                                    <input type="checkbox" value="0" name="couponGetType" checked>
                                                    是否直接从商品页领取
                                                </label>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-4"><span style="color: red;">*</span>活动时间：</label>
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-18">
                                            <div class="col-sm-9">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="timeType" id="optionsRadios1" value="0" checked>
                                                        起止时间
                                                    </label>
                                                </div>
                                                <div>
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-4"><span style="color: red;">*</span>开始：</label>
                                                        <div class="col-sm-1"></div>
                                                        <div class="col-sm-9">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-sm-4"><span style="color: red;">*</span>结束：</label>
                                                        <div class="col-sm-1"></div>
                                                        <div class="col-sm-9">
                                            ...
                                            <div class="col-sm-10 col-md-offset-5">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="timeType" id="optionsRadios2" value="1">
                                                        固定时间
                                                    </label>
                                                </div>
                                                <div class="form-inline" style="display:inline-block;">
                                                    <label ><input type="text" name="couponDays" class="form-control integer" id="coupon_days" placeholder="多少天" style="width:100px;margin-left:5px;">&nbsp;天</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-12">
                                                <input  name="couponGetNo" style="width: 164px"type="text" class="form-control required integer" onblur="checkNum(this);" id="couponGetNo">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1"></div>
                                        <div class="col-sm-5">
                                            <input name="downPrice" class="form-control required cash" maxlength="7">
                                        </div>
                                    </div>
                                    </div>
                                    <%--<div class="form-group">--%>
            ...
            <div class="modal-body">
                <div class="mb10">
                    <form class="form-inline" id="searchGoodsInfo" action="" method="post" >
                        ...
                        <input type="hidden" name="marketType" id="marketType" value="99"/>
                        <div class="form-group">
