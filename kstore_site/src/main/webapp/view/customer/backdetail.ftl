...
<#if backorder.orderGoodsList?? && backorder.orderGoodsList?size gt 0>
    <#list backorder.orderGoodsList as list>
        <#if list.orderGoodsStatus == '4' || list.orderGoodsStatus == '5' || list.orderGoodsStatus == '6'>
            <#assign backFlag = backFlag + 1>
        </#if>
    </#list>
</#if>
                                ...
                                <#if backOrderLog.backLogStatus??>
                                    ...
                                    <#if backOrderLog.backLogStatus == '1'>
                                        <p class="latest-track">
                                            <span class="track-date">${backOrderLog.backLogTime?string("yyyy-MM-dd HH:mm:ss")}</span>
                                            <i></i>
                                            <span class="track-cont">申请退单审核(操作：顾客)<#if backOrderLog.backRemark??>留言：<#if backOrderLog.backRemark?length gt 36><b title="${backOrderLog.backRemark}" style="font-weight: normal">${backOrderLog.backRemark?substring(0,35)}...</b><#else>${backOrderLog.backRemark}</#if></#if></span>
                                        </p>
                                    </#if>
                    ...
                    <div class="item-cont">
                        <div class="form-group">
                            <div class="form-item">
                                ...
                                <div class="controls">
                                        <#if (backFlag=0)>退货退款</#if>
                                        <#if (backFlag>0)>仅退款</#if>
                                </div>
                            </div>
                            <div class="form-item">
                                ...
                                <div class="controls">
                                    <#if bOrder.backReason??>
                                        ...
                                        <#if bOrder.backReason=='5'>商品质量问题</#if>
                                        <#if bOrder.backReason=='6'>商品与描述不符</#if>
                                    </#if>
                                </div>
                            </div>
                            <#--<div class="form-item">
                                ...
                                <table class="order-table">
                                    ...
                                    <#if backorder.orderGoodsList?? && backorder.orderGoodsList?size gt 0>
                                        <#list backorder.orderGoodsList as list>
                                            ...
                                            <tr>
                                                <td class="tl">
                                                    <a class="od-img" href="${basePath}/item/${list.goodsInfoId}.html"><img alt="" src="${list.goodsImg}" style="width:30px;height:30px;"/></a>
                                                ...
                                                <td><#--&yen;${list.goodsInfoPrice}&nbsp;x${list.goodsInfoNum!''}-->
                                                ...
                                                <#assign sumPrice="${list.goodsInfoPrice?number*(list.goodsInfoNum?number)}">
                                                <td>
                                                    <#if list.goodsBackPrice??>
                                                        &yen;${list.goodsBackPrice}
                                                    <#else>
                                                        &yen;${sumPrice}
                                                    </#if>
                                                </td>
