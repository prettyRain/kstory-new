...
public class CustomerMapperImpl extends BasicSqlSupport implements CustomerMapper {
    ...
    public Long queryProvinceIdByProvinceName(String provinceName) {
        return selectOne("com.ningpai.m.customer.mapper.CustomerMapper.queryProvinceIdByProvinceName",provinceName);
    }
    ...
    @Override
    public Customer selectCustomermByPrimaryKey(Long customerId) {
        return this.selectOne("com.ningpai.m.customer.mapper.CustomerMapper.selectCustomermByPrimaryKey",customerId);
    }
    ...
    @Override
    public Customer selectCustomerByNamePwdNoMD5(Map<String, Object> paramMap) {
        return this
                .selectOne(
                        "com.ningpai.m.customer.mapper.CustomerMapper.selectCustomerByNamePwdNoMD5",
                        paramMap);
    }
    ...
    public int updCustLevel(Map<String, Object> map) {
        return this.update("com.ningpai.m.customer.mapper.CustomerMapper.updCustLevel",map);
    }
