...
public class GoodsProductMapperImpl extends BasicSqlSupport implements
    ...
    public List<Object> queryProductForApp(Map<String, Object> map) {
        return this
                .selectList(
                        "com.ningpai.goods.dao.GoodsProductMapper.queryProductForApp",
                        map);
    }
    ...
    public List<Object> queryProductListForPresent(Map<String, Object> map) {
        return this
                .selectList(
                        "com.ningpai.goods.dao.GoodsProductMapper.queryProductListForPresent",
                        map);
    }
    ...
    public int queryCountForApp(Map<String, Object> map) {
        return this.selectOne(
                "com.ningpai.goods.dao.GoodsProductMapper.queryProductCountForApp",
                map);
    }
    ...
    public int queryCountForPresent(Map<String, Object> map) {
        return this.selectOne(
                "com.ningpai.goods.dao.GoodsProductMapper.queryCountForPresent",
                map);
    }
    ...
    public List<GoodsProductVo> queryProductsForPreview(Long goodsId) {
        return this
                .selectList(
                        "com.ningpai.goods.dao.GoodsProductMapper.queryProductsForPreview",
                        goodsId);
    }
    ...
    public int queryTotalCountArrival(Map<String, Object> map) {
        return this.selectOne(
                "com.ningpai.goods.dao.GoodsProductMapper.queryTotalCountArrival", map);
    }

    @Override
    public List<Object> queryByParamArrival(Map<String, Object> map) {
        return this.selectList(
                "com.ningpai.goods.dao.GoodsProductMapper.queryByParamArrival",
                map);
    }
    // 修改商品为上架状态的时候把货品信息页修改为上架状态  待审核
    @Override
    public void updateProductAddedWithGoodsIdUp(Map<String, String> upProMap) {
        this.update("com.ningpai.goods.dao.GoodsProductMapper.updateProductAddedWithGoodsIdUp",upProMap);
    }
    //删除货品对应的图片
    @Override
    public void deleteProductImageByGoodsId(Map<String, String> map) {
        this.update("com.ningpai.goods.dao.GoodsProductMapper.deleteProductImageByGoodsId",map);
    }

    @Override
    public void deleteGoodsImageByInfoId(Map<String, String> map) {
        this.update("com.ningpai.goods.dao.GoodsProductMapper.deleteGoodsImageByInfoId",map);
    }
