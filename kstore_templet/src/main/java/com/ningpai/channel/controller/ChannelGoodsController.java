...
public class ChannelGoodsController {
    ...
    @ResponseBody
    public Map<String, Object> queryChannelGoodsByPageBeanAjax(PageBean pb, String tempId, String channelId, String storeyTagId) {
        // 设置容器
        Map<String, Object> map = new HashMap<String, Object>();
        // 设置集合
        map.put("pb", channelGoodsService.selectchannelStoreyGoodsByParam(pb, tempId, channelId, null));
        // 返回结果
        return map;
    }
    ...
    public int createChannelGoodsAjax(HttpServletRequest request, @Valid ChannelStoreyGoods channelStoreyGoods, BindingResult bindingResult, Long tempId, Long channelId) {
        ...
        try {
            ...
            // 设置频道id
            if (channelId != null) {
                channelStoreyGoods.setTemp2(channelId.toString());
            }
            // 插入
