...
<head>
<title>我的关注-${topmap.systembase.bsetName}</title>
            ...
            <div class="new_order_list">
                ...
                <div class="tagMenu order-menu">
                    <ul class="menu clearfix">
                        <li  <#if pb??&&pb.url=="customer/myfollw">class="current"</#if> onclick="gohref('myfollw.html');"><em></em><span></span>我关注的商品</li>
                        <li <#if pb??&&pb.url=="customer/sellermyfollw">class="current"</#if>onclick="gohref('sellermyfollw.html');"><em>&nbsp;</em><span>&nbsp;</span>我关注的商家</li>
                    </ul>
                </div>
                ...
                <div class="content">
                    <div class="layout">
                        <table class="bought-table mt10">
                                ...
                                <#list pb.list as follow>
                                    <#if follow.good??>
                                            <tr class="order-bd">
                                                <td class="baobei no-border-right">
                                                    ...
                                                    <div class="desc ml20">
                                                        ...
                                                        <div class="put" style="margin-left: 0;">
                                                                <span class="commstar clearfix" style="cursor: default;">
                                                ...
                                                <td class="no-border">
                                                    <span class="red fb f14">￥<#if follow.good.goodsPrice??>${follow.good.goodsPrice?string('0.00')}</#if></span>
                                                </td>
                                                <td class="no-border">
                                                ...
                                                <td class="no-border-left">
                                                    ...
                                                    <a href="javascript:void(0)" class="blue" onclick="cancelfollow2('${basePath}/customer/cancelfollow-${follow.followId}.html')">取消关注</a>
                                                </td>
                                            </tr>
                                    </#if>
                                </#list>
                            <#else>
                            <tr>
                                <td colspan="5" style="font-size:18px; height:60px;text-align: center;">暂无关注记录！</td>
                            </tr>
                            </#if>
                            </tbody>
            ...
            <div class="member-dialog-body">
                ...
                <div class="tc">
                    ...
                    <div class="que-delete clearfix">
                        <div class="fl tl">
                            <p class="f16 new_p">确定取消关注该商品吗？</p>
                            <div class="m-btn">
                                <a class="" href="javascript:cls();">取消</a>
                                <a  href="javascript:;" class="can-det bnt_ok">确定</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="member-dialog dia3">
            <div class="member-dialog-body">
                ...
                <div class="tc">
                    ...
                    <div class="que-delete clearfix">
                        <div class="fl tl">
                            <p class="f16 new_p">请重试...</p>
                            <div class="m-btn ">
                                <a  href="javascript:cls();" class="bnt_ok">确定</a>
                            </div>
                        </div>
                    </div>
