...
public class GoodsSpecDetailMapperImpl extends BasicSqlSupport implements
    ...
    /**
     * 更新‘货品信息与规格值关联表’与‘商品开启规格值表’中对应id的规格值信息
     *
     * @param goodsSpecDetail
     */
    @Override
    public int updateGoodsInfoReleSpecDetailBySpecDetailId(GoodsSpecDetail goodsSpecDetail) {
        return this
                .update("com.ningpai.goods.dao.GoodsSpecDetailMapper.updateGoodsInfoReleSpecDetailBySpecDetailId",
                        goodsSpecDetail);
    }

    @Override
    public int updateGoodsOpenspecvalue(GoodsSpecDetail goodsSpecDetail) {
        return this
                .update("com.ningpai.goods.dao.GoodsSpecDetailMapper.updateGoodsOpenspecvalue",
                        goodsSpecDetail);
    }
     ...
     * 标记商品开启规格值表中对应数据为删除
     *
     * @param goodsSpecDetailId
     * @return
     */
    @Override
    public int delGoodsOpenspecvalue(Long goodsSpecDetailId) {
        return this
                .update("com.ningpai.goods.dao.GoodsSpecDetailMapper.delGoodsOpenspecvalue",
                        goodsSpecDetailId);
    }
