...
public interface OrderMService {
     ...
     */
    @Transactional
    List<Order> newsubmitOrder(Long duiHuanJiFen, String invoiceType, String invoiceTitle,String taxpayerNumber ,HttpServletRequest request, Long[] shoppingCartId, Long typeId,
