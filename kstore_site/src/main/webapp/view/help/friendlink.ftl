...
<#assign basePath=request.contextPath>
    <meta charset="UTF-8">
    <!--<title>960</title>-->
    <title>${topmap.systembase.bsetName} - 友情链接</title>
    ...
    <#--<link rel="stylesheet" type="text/css" href="http://kstore.qianmi.com/index_two/css/base.min.css" />
    <link rel="stylesheet" type="text/css" href="http://kstore.qianmi.com/index_two/css/index.css" />-->
    ...
    <style type="text/css">
        ...
        .link_list li{padding-left:28px;float:left;width:157px;height:32px;line-height:32px; background:url(http://kstore.qianmi.com/index_two/images/sort_arrow.gif) no-repeat 8px 50%;border-bottom:1px dotted #ccc; white-space:nowrap; overflow:hidden}
        ...
        .link_list_img li:hover{border:1px solid #0d9901;}
        /*.link_list_img li img{width:157px;}*/
        .link_list_img li img{width:166px;height: 69px;}
        ...
        .link_list_img li:hover span{background:#0d9901;color:#fff;}
    </style>
...
<#if (topmap.temp)??>
    <#if (topmap.temp.tempId==1)>
        <#include "../index/newheader960.ftl">
