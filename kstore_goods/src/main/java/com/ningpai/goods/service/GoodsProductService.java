...
public interface GoodsProductService {
     ...
     * @return 更新的行数
     */
    int batchUploadProduct(String username, Long[] productIds, Integer status,Integer auditStatus);
     ...
     * @return
     */
    PageBean queryProductForApp(PageBean pb, Long catIds, String productName);
    /**
     * 根据分类ID和品牌Id查询货品列表
     *
     * @param pb
     ...
     */
    List<GoodsProductVo> queryProductsForPreview(Long goodsId);
     ...
     * @return
     */
    PageBean queryProductListForPresent(PageBean pb, Long thirdId,
            GoodsSearchBean searchBean, Long marketType);
     ...
     */
    boolean compare(GoodsProduct prePro, GoodsProduct newPro, String[] supportIds, String[] specDetailId);
     ...
     * @return
     */
    GoodsProduct selectByGoodsInfoItemNo(String code);
}
