...
public class IndexSiteService {
    ...
    private void getBoxAdvertList(Long tempId, IndexClassifyBar indexClassifyBar) {
        List<ChannelAdver> boxAdverList = this.channelAdverService.selectchannelAdverByParamForSite(null, tempId, null, null, ATID3, ADVERTTYPE, null, "1", null, null,null);
    ...
    private void getAdvertListForStorey(ChannelStorey s, IndexSiteStoreyBean storeys) {
        List<ChannelAdver> adverList = this.channelAdverService
                .selectchannelAdverByParamForSite(null, null, s.getChannelStoreyId(), null, ATID3, ADVERTTYPE, null, "0", null, null,null);
