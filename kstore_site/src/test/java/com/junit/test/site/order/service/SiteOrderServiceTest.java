...
//    }
    ...
    public void testGetEveryparamMap2()
    {
    	...
    	//assertEquals(7, siteOrderService.getEveryparamMap(shopCartIds, 1L, shoppingCart).size());
    }
    ...
    public void testNewsubmitOrder()
    {
    	...
    	try
    	{
        	assertEquals(1, siteOrderService.newsubmitOrder(request, shoppingCartId, "1", "1", "1", 0L).size());
		} catch (Exception e)
    	{
			e.printStackTrace();
		}
