...
public class ChannelStoreyTagGoodsController {
    ...
    public ModelAndView queryStoreyTagGoodsByPageBean(PageBean pb, Long storeyTagId) {
        ...
        /* 设置查询参数，获取查询后的pb */
        return new ModelAndView("jsp/channel/channel_storey_tag_goods_list", "pb", storeyGoodsService.selectchannelStoreyGoodsByParam(pb, null, storeyTagId, null,null,null)).addObject(
