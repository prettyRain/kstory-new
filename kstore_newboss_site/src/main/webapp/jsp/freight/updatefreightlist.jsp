                         ...
                         <c:forEach items="${freightTemplate.freightExpressList}" var="expresslist">
						  	<c:if test="${company.logComId==expresslist.logComId}">
						  		 <c:forEach items="${expresslist.freightExpressAll}" var="expressAll" varStatus="vstatus">
			                          ...
			                          <td>  <input type="hidden" value="${expressAll.minPrice }" name="${company.code }_min" id="${company.code }_min_n1" ><span>${expressAll.minPrice }</span></td>
			                          <td>  <input type="hidden" value="${expressAll.maxPrice }" name="${company.code }_max" id="${company.code }_max_n1" ><span>${expressAll.maxPrice }</span></td>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-16">
                        <div class="input-group w100">
                            <input type="text" class="form-control required  money" id="viewminprice" name="viewminprice">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-16">
                        <div class="input-group w100">
                            <input type="text" class="form-control required  money" id="viewmaxprice" name="viewmaxprice">
