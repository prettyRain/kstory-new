                        ...
                        <#if shop.marketingActivityId??&&shop.marketingList?size!=0&&shop.marketingActivityId!=0>
                            ...
                            <li <#if marNum2==0> style="display:none;"</#if>>
                                ...
                                <div class="list-item cart-pro-item">
                                    ...
                                    <input type="hidden" class="sell-type" value="${shop.goodsDetailBean.sellType!'0'}"/>
                                    ...
                                    <div class="prodesc">
                                        ...
                                        <p class="price">
                                            ...
                                            <span style="margin:8px;border:1px solid #dcbb19;border-radius: 4px;font-size:14px;padding:0px 3px;color:#dcbb19;line-height: 18px;">
                                                <#if shop.goodsDetailBean.sellType?? && shop.goodsDetailBean.sellType=='0'>零售</#if>
                                                <#if shop.goodsDetailBean.sellType?? && shop.goodsDetailBean.sellType=='1'>批发</#if>
                                            </span>
                                        </p>
                                        ...
                                        <div class="buy-num">
                                            ...
                                            <input type="text" class="goodsNum goods-num"
                        ...
                        <div class="prodesc">
                            <a href="${basePath}/item/${product.productDetail.goodsInfoId}.html">
                                ...
                                <p class="price">¥&nbsp;
                                    ...
                                    <span style="margin:8px;border:1px solid #dcbb19;border-radius: 4px;font-size:14px;padding:0px 3px;color:#dcbb19;line-height: 18px;">
                                        <#if product.productDetail.sellType?? && product.productDetail.sellType=='0'>零售</#if>
                                        <#if product.productDetail.sellType?? && product.productDetail.sellType=='1'>批发</#if>
                                    </span>
                                    <input type="hidden" class="sell-type" value="${product.productDetail.sellType!'0'}"/>
                                </p>
                        ...
                        <div class="list-item cart-pro-item">
                            ...
                            <div class="prodesc">
                                <h3 class="title">
                                    <a href="${basePath}/item/${shop.goodsDetailBean.productVo.goodsInfoId}.html"
                                       title="${shop.goodsDetailBean.productVo.productName}">
                                    ${shop.goodsDetailBean.productVo.productName!''}-${shop.goodsDetailBean.sellType}
                                    </a>
                                </h3>
                                <p class="price">¥&nbsp;<span
