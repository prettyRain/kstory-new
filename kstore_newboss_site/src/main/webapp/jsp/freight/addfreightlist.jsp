              ...
              <form class="form-horizontal"  action="addFreight.htm?CSRFToken=${token}" method="post" id="freightForm">
               <input type="hidden" name="freightTemplateId" id="freightTemplateId" value="${freightTemplate.freightTemplateId }" />
                <div class="form-group">
                  ...
                  <div class="col-sm-16">
                    <input type="text" class="form-control w200 required" name="freightTemplateName" id="freightTemplateName" maxlength="7">
                  </div>
                    ...
                    <div class="express_details p20" id="detail-express${company.logComId}">
                      <div class="mb10" style="display: none;">
							 ...
							 默认运费：
							    <input type="hidden" id="${company.code }_areas_n1" name="${company.code }_areas" value=""/>
						  		<input type="text" name="${company.code }_start"  value="1" id="${company.code }_start" class="w50 digits"><span class="methods">件内，</span>
					            <input type="text" name="${company.code }_postage" value="0" id="${company.code }_postage" class="w50 money">元，  每增加
					            <input type="text" name="${company.code }_plus" value="1" id="${company.code }_plus" class="w50 digits"><span class="methods">件， 增加运费</span>
                      ...
                      <table class="table table-bordered table-hover">
                        ...
                        <tr>
                          ...
                          <th>最低金额</th>
                          <th>最高金额</th>
                          <th class="methodslist">首件(g)</th>
                          <th>首费(元)</th>
                          <th class="methodslist">续件(g)</th>
                          <th>续费(元)</th>
                          <th width="120">操作</th>
                        </tr>
                        </thead>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form role="form" class="form-horizontal" id="cityForm">
              ...
              <div class="form-group">
                <label class="control-label col-sm-5">订单最小金额：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-16">
                  <div class="input-group w100">
                    <span class="input-group-addon">￥</span>
                    <input type="text" class="form-control required  number" id="viewminprice" name="viewminprice">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-5">订单最大金额：</label>
                <div class="col-sm-1"></div>
                <div class="col-sm-16">
                  <div class="input-group w100">
                    <span class="input-group-addon">￥</span>
                    <input type="text" class="form-control required  number" id="viewmaxprice" name="viewmaxprice">
                  </div><span style="color: red;">注：没有最大金额时，默认设置为0即可！</span>
                </div>
              </div>
              <div class="form-group">
