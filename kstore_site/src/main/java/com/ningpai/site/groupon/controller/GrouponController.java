...
public class GrouponController {
    ...
    public ModelAndView selectGrouponList(PageBean pb, HttpServletRequest request) {
        PageBean pb1 = pb;
        pb1.setPageSize(12);
        pb1 = goodsProductService.selectGrouponList(pb1, request);
        ...
        ModelAndView mav = new ModelAndView("groupon/grouponlist").addObject("pb", pb1).addObject("avs",
                channelAdverService.selectchannelAdverByParamForSite(null, Long.valueOf(tempId), null, null, ATID1, ADVERTTYPE, null, "0", null, "5",null));
        LOGGER.info("获取团购列表！");
