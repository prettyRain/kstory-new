...
<title>${map.detailBean.productVo.productName}所有评论-${topmap.systembase.bsetName}</title>
        ...
        <div class="content clearfix mt10">
            ...
            <div class="left_wp fl">
                <div class="left_box cmt_pro">
                    ...
                    <a class="add_cart"  product_id="${map.detailBean.productVo.goodsInfoId}" product_stock="${map.detailBean.productVo.goodsInfoStock}" distinct_id="${map.distinctId}" href="javascript:;">
                        <i></i>
                        加入购物车
                    </a>
