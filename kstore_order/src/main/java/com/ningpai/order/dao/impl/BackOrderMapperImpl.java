...
public class BackOrderMapperImpl extends BasicSqlSupport implements
    ...
    @Override
    public OrderGoods selectBackOrderGoods(Map map) {
        return  this.selectOne("com.ningpai.web.dao.BackOrderMapper.selectBackOrderGoods",map);
    }
    ...
    public BackOrder selectBackOrderByOrderCode(String orderCode) {
        return this.selectOne("com.ningpai.web.dao.BackOrderMapper.selectBackOrderByOrderCode",orderCode);
    }
    ...
    public List querySynBackOrder() {
        return this.selectList("com.ningpai.web.dao.BackOrderMapper.querySynBackOrder");
    }
    ...
    public int synBackOrderSuccess(String orderCode) {
        return this.update("com.ningpai.web.dao.BackOrderMapper.synBackOrderSuccess", orderCode);
    }
}
