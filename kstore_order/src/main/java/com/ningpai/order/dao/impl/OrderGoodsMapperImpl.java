...
public class OrderGoodsMapperImpl extends BasicSqlSupport implements
    ...
    @Override
    public int selectThirdselectOrderGoodsListListByTimeCount(Map<String, Object> paramMap) {
        return this.selectOne("com.ningpai.web.dao.OrderGoodsMapper.selectThirdselectOrderGoodsListListByTimeCount", paramMap);
    }

    @Override
    public List<Object> selectThirdOrderGoodsListByTime(Map<String, Object> map) {
        return this.selectList("com.ningpai.web.dao.OrderGoodsMapper.selectThirdOrderGoodsListByTime", map);
    }
    ...
    public int modifyGoodsBackPrice(Map<String, Object> map){
        return this.update("com.ningpai.web.dao.OrderGoodsMapper.modifyGoodsBackPrice", map);
    }
    ...
    public List<OrderGoods> queryOrderGoodsAndProductInfo(Long orderId) {
        return this.selectList(
                "com.ningpai.web.dao.OrderGoodsMapper.queryOrderGoodsAndProductInfo",
                orderId);
    }
    ...
    public int updateOrderGoodsBackNew(Map<String, Object> map) {
        return this.update(
                "com.ningpai.web.dao.OrderGoodsMapper.updateOrderGoodsBackNew",
                map);
    }
    ...
    public OrderGoods selectOrdersetBackGodds(Map<String, Object> map) {
        return this.selectOne(
                "com.ningpai.web.dao.OrderGoodsMapper.selectOrdersetBackGodds", map);
    }

    @Override
    public OrderGoods selectOrderGoodsByIds(Map<String, Object> map) {
        return this.selectOne(
                "com.ningpai.web.dao.OrderGoodsMapper.selectOrderGoodsByIds", map);
    }
     ...
     */
    @Override
    public OrderGoods selectOrderGoodsByOGId(Long orderGoodsId) {
        return this.selectOne("com.ningpai.web.dao.OrderGoodsMapper.selectOrderGoodsByOGId",orderGoodsId);
    }
     ...
     */
    @Override
    public int deleteOrderGoodsById(Long orderGoodsId) {
        return this.update("com.ningpai.web.dao.OrderGoodsMapper.deleteOrderGoodsById",
                orderGoodsId);
    }
}
