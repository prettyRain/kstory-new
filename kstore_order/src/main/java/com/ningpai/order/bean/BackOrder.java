...
public class BackOrder {
     ...
     * 实际退单金额
     */
    private BigDecimal actualBackPrice;
    /**
     * 退单审核
     */
     ...
     * 退单商品
     */
    private List<OrderGoods> backOrderGoodsList;
     ...
     * 订单佣金
     */
    private BigDecimal backOrderCatePrice;
    ...
    public List<OrderGoods> getBackOrderGoodsList() {
        return backOrderGoodsList;
    }

    public void setBackOrderGoodsList(List<OrderGoods> backOrderGoodsList) {
        this.backOrderGoodsList = backOrderGoodsList;
    }

    public BigDecimal getActualBackPrice() {
        return actualBackPrice;
    }

    public void setActualBackPrice(BigDecimal actualBackPrice) {
        this.actualBackPrice = actualBackPrice;
    }
    ...
    public BigDecimal getBackOrderCatePrice() {
        return backOrderCatePrice;
    }

    public void setBackOrderCatePrice(BigDecimal backOrderCatePrice) {
        this.backOrderCatePrice = backOrderCatePrice;
    }
}
