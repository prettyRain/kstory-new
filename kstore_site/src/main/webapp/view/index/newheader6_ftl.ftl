...
<div class="section-header">
    <div class="content">
        <h1 id="logo">
            ...
            <div class="logoBanner"><a href="${(topmap.logoAdv.adverHref)!'#'}"><img alt="" src="${(topmap.logoAdv.adverPath)!'${basePath}/index_six/images/logoImg.jpg'}"></a></div>
        </h1>
...
<#list topmap.classifyBar.classifyBarList as cBar>
                <div class="menuView hide" id="submenu-${cBar_index+1}">
                    ...
                    <div class="menuImg"><img src="../images/menuImg.png" alt="" /></div>
                </div><!--menuView-->
</#list>
 </#if> 
