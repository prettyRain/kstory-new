                            ...
                            <div class="amend-step">
                                ...
                                <div class="n_password">
                                    <form action="reirectpem.htm" method="post" id="reirectpem">
                                        ...
                                        <div class="n_item clearfix mb20">
                                            ...
                                            <div class="fl">
                                                <input tabindex="1"  id="pwd" name="ut" type="password"  class="short_text mr20">   &nbsp;&nbsp;
                                        ...
                                        <div class="n_item clearfix mb20">
                                            ...
                                            <input class="nw-submit sub_btn"  tabindex="3" onclick="modifyPwd('${type}')" value="提交" style="background-color:#999999;width: 130px;border-radius:4px;border:none;outline:medium;" readonly disabled="true"/>
                                            <script>
                                ...
                                <#elseif (ut == 'mobile')>
                                    <div class="n_password">
                                        ...
                                        <div class="n_item clearfix mb20">
                                            <span class="label fl">&nbsp;</span>
                                            <button class="nw-submit" tabindex="4"  onclick="modifyMobile('${type}')" style="background-color:#999999; " disabled="true">提交</button>
                                            <script>
                                                document.onkeydown=function(event){
                                                    var e = event || window.event || arguments.callee.caller.arguments[0];
                                                    if(e && e.keyCode==13){ // enter 键
                                ...
                                <#elseif (ut == 'email'&&cust.isEmail=='1'&&custInfo.infoEmail??)>
                                    <div class="n_password ml30">
                                        ...
                                        <div class="n_item clearfix mb20">
                                            <span class="label fl">&nbsp;</span>
                                            <div class="fl">
                                                <button class="send-mail-yj"  id="sendCode"onclick="sendCheckIdEmail('${type}')" disabled="true" style="background-color:#999999;">发送验证邮件</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="member-dialog-body">
                ...
                <div class="tc">
                    ...
                    <div class="que-delete clearfix">
                        <div class="fl tl">
                            <p class="f16 new_p">网络连接超时，请您稍后重试</p>
                            <div class="m-btn">
