...
public interface MarketingService {
     ...
     * @return Marketing对象
     */
    Marketing marketingDetailNew(Long marketingId, Long goodsInfoId, Long goodsNum, BigDecimal goodsInfoPrice);
     ...
     * @return
     */
    int doAddPresentMarketing(Marketing marketing, String codexType,
            HttpServletRequest request, String status);
    ...
    long queryByCreatimeMarketings(Long goodsId, Long groupId, Long cateId,
            Long brandId);
    long queryByCreatimeMarketings(Long goodsId, Long cateId,
                                   Long brandId);
    /**
     * 查询促销id
     * @param goodsId 货品id
     ...
     * @return 返回促销id
     */
    long queryByCreatimeMarketingsWithPanicBuying(Long goodsId, Long cateId,
                                   Long brandId);
     ...
     * @return int
     */
    int doUpdatePresentMarketing(Marketing marketing, String codexType, String status, HttpServletRequest request);
     ...
     * @return
     */
    int selectMarketingByGoodsInfoIdWithDay(Long goodsInfoId, Long brandId, Long cateId);

    /*
    *
    * 抢购已被占用的时间段
    * */
    List<Object> queryTDates();
     ...
     * @return
     */
    MarketingRushTime queryrushtimeById(Long tId);
}
