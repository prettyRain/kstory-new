...
public class CustomerAddressServiceImpl implements CustomerAddressService {
    ...
    public List<Object> queryCustomerAddressByType(Map<String, Object> map) {
        return customerAddressMapper.queryCustomerAddressByType(map);
    }
    ...
    public int setDefaultAddress(Map<String, Long> map) {
        customerAddressMapper.cancelDefaultAddress(map.get("customerId"));
        int n = customerAddressMapper.setDefaultAddress(map);
        return n;
    }
    ...
    public int addAddress(CustomerAddress address, Long customerId) {
        ...
        if("0".equals(address.getAddressType())){
            address.setCommunityStoreId(Long.valueOf(0));
        }
