...
public class CustomerMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public Long queryProvinceIdByProvinceName(String provinceName) {
        return this.selectOne("com.ningpai.site.customer.dao.CustomerMapper.queryProvinceIdByProvinceName",provinceName);
    }
    ...
    public Long checkexistsByIdAndCode(Map<String, Object> paramMap) {
        if(paramMap.get("orderCode").toString().indexOf("R")!=-1){
            //是预存款订单
            return this.selectOne("com.ningpai.site.customer.dao.CustomerMapper.checkexistsByIdAndCodeR",paramMap);
        }
        //商品订单
        return this
                .selectOne(
    ...
    public Customer selectCustomerByCustNameAndType(Map<String, Object> paramMap) {
        return this.selectOne("com.ningpai.site.customer.dao.CustomerMapper.selectCustomerByCustNameAndType",paramMap);
    }
    ...
    public Customer queryLoginInfoByCustomerId(Long costomerId) {
        return this.selectOne("com.ningpai.site.customer.dao.CustomerMapper.queryLoginInfoByCustomerId",costomerId);
    }
    ...
    public int updatePwdInfo(Customer customer) {
        return this.update("com.ningpai.site.customer.dao.CustomerMapper.updatePwdInfo",customer);
    }
    ...
    public List<CustomerPointLevel> queryPointLevel() {
        return this.selectList("com.ningpai.site.customer.dao.CustomerMapper.selectPointLevel");
    }

    /**
     * 根据用户id和地址id查询用户地址信息
     *
     * @param map@return 用户地址
     */
    @Override
    public CustomerAddress selectByAddrIdAndCusId(Map<String, Object> map) {
        return this.selectOne("com.ningpai.site.customer.dao.CustomerAddressMapper.selectByAddrIdAndCusId", map);
    }
}
