                                                ...
                                                <div class="img_item">
                                                    ...
                                                    <div class="img_link">
                                                        <div>
                                                            ...
                                                            <div class="app-select-bar">
                                                                <div v-if="e.action != 'Theme1'">
                                                                    <strong v-if="!e.action || e.action == ''  || !e.actionParam || (!e.actionParam.searchParam && !e.actionParam.goodsInfoId && !e.actionParam.urlinfo) || e.actionParam.searchParam.searchText" class="app-selected-text">请选择</strong>
                                                                </div>
                                                                <strong v-if="e.actionParam && e.actionParam.urlinfo" class="app-selected-text">自定义链接</strong>
                                                                ...
                                                                <ul class="app-select-box">
                                                                    ...
                                                                    <li v-bind:class="{'selected': e.actionParam && e.actionParam.urlinfo}">
                                                                        <a href="javascript:;" onClick="chooseAction(5, 'sliders['+ {{$index}} + ']')">自定义地址</a>
                                                                    </li>
                                                        ...
                                                        <p style="width:350px;">
                                                            ...
                                                            <template  v-if="e.actionParam && e.actionParam.urlinfo">
                                                                <span><font color='blue'>{{e.actionParam.urlinfo}}</font></span>
                                                            </template>
...
<script type="text/javascript">
    ...
    function chooseAction(val, dataPath) {
        ...
        if(val === 0){
            ...
            vm.$set(dataPath + '.action', 'GoodsBrand');
            ...
            vm.$set(dataPath+'.action','url');
            urlChooseWindow(dataPath);
        }
    }

    function urlChooseWindow(sourceId){
        art.dialog.open('<%=basePath%>writeUrlToAppBanner.htm?pageName=writeUrlToAppBanner&CSRFToken=${token}', {
            id: sourceId,
            lock: true,
            width: '400px',
            height: '200px',
    ...
    function saveChoooseCat(cats, sourceId){
        ...
        vm.$set(sourceId + '.actionParam', {"searchParam": { "cates": [cats[0].text.split("-")[0]]}});
    }
    ...
    //保存banner的地址
    function saveAppSliderUrl(strUrl,sourceId){
        console.log('------saveurl-------',strUrl,sourceId);
        vm.$set(sourceId + '.action',"url");
        vm.$set(sourceId + '.actionParam',{"urlinfo":strUrl});
    }
</script>
</body>
</html>
