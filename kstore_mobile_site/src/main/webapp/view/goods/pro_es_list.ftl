...
<div class="views">
    ...
    <#--头部搜索栏-->
        <div class="bar-top" style="position:absolute">
            ...
            <#--唤醒app-->
                ...
                <div class="search_box">
                    ...
                    <#-- <a  href="#" style="position: absolute; right: 0; top: 8px;">分类</a>-->
                    </div>
                </div>
            </div>
        ...
        <#--筛选弹出遮罩面板-->
            ...
            <div class="panel panel-right panel-cover "  style="overflow: hidden;">
                ...
                <div class="ui-btn-group " style="position:fixed;bottom: 0;height:49px; ">
    ...
    margin-top: -30px;">
            ...
            <div class="content scroll">
                <div class="content-prolist" >
                    <div class="prolist list-line" <#if map.pb??|| map.pb.data?? || map.pb.data?size==0> style="border-bottom: none;" </#if>>
                    <#if map.pb.data??>
                        ...
                        <#--新增-->
                            <#--<div class="shopping_cart status">-->
                                <#--<a href="javascript:;"  onclick="javascript:window.location.href='${basePath}/myshoppingmcart.html'" class="shoppingcart_item cart"><span id="cartNum">0</span></a>-->
                            <#--</div>-->
                        <#else>
...
<#include '../main/popup.ftl'>
     <script type="text/javascript">
         ...
         $(".ui-btn-s").on("touchstart",function (e) {
          ...
          $(" vvvvvvv ccccccccccccccccccccccccccccc.ui-btn-s").on("touchmove",function (e) {
              $(this).css("color","#666666");
              e.stopPropagation();
          })
    ...
    <script>
        ...
        function addShoppingCart(ele,goodsInfoId) {
            addCart(goodsInfoId,tip,ele,addFly);
...
//                            str += "<p class='comm'><span class='item-pnum'><span>" + commentCount +"</span>人评价</span></p></div></a>  <div style=' position: absolute;bottom:2px;right: 0px;width:50px; height: 50px;'><a href='javascript:;' class='addcar' onclick='addShoppingCart(this,"+ msg.pb.data[i].goodsInfoId +");'></a></div></div>";
                            if(commentCount<1){
...
//    }
    ...
    document.getElementById("muiscroll").addEventListener('touchstart',function (ev) {
        startX = ev.touches[0].pageX;
        startY = ev.touches[0].pageY;
    }, { passive: false });
    document.getElementById("muiscroll").addEventListener('touchend',function (ev) {
        var endX, endY;
