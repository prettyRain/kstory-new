...
public final class PathUtil {
     ...
     * 搜索关键字页面
     */
    public static final String GOODSSEARCH = "jsp/goods/goods_keywords";
    /*
     *查询所有搜索关键字列表的Controller
      */
    public static final String ALLSEARCHCONTROLLER = "findAllKeyword.htm";
