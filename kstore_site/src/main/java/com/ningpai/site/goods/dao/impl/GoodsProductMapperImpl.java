...
public class GoodsProductMapperImpl extends BasicSqlSupport implements GoodsProductMapper {
    ...
    public List<GoodsProduct> queryHotSalesByCatIdRandom(Map<String, Object> map) {
        return this.selectList("com.ningpaihsite.goods.dao.GoodsProductMapper.queryHotSalesByCatIdRandom", map);
    }
    ...
    public Long queryThirdIdByGoodsInfoId(Long goodsId) {
        return this.selectOne("com.ningpaihsite.goods.dao.GoodsProductMapper.queryThirdIdByGoodsInfoId", goodsId);
    }

    @Override
    public int saveGoodsBrowCookie(Map map) {
        return this.insert("com.ningpaihsite.goods.dao.GoodsProductMapper.saveGoodsBrowCookie",map);

    }

    @Override
    public Date getBrowerCreatTime(Map map) {
        return this.selectOne("com.ningpaihsite.goods.dao.GoodsProductMapper.getBrowerCreatTime",map);
    }
   //查找商品的352图片
    @Override
    public String queryProductImageBigName(Long goodsInfoId) {
        return  this.selectOne("com.ningpaihsite.goods.dao.GoodsProductMapper.queryProductImageBigName",goodsInfoId);
    }


    /**
     * 根据分类查询最近一月销量最高的同价位的商品 随机
     * 
     * @param map
     * @return
     */
    ...
    public List<ListFinalBuyVo> browCatFinalBuyAndPrecentRandom(Map<String, Object> map) {
        return this.selectList("com.ningpaihsite.goods.dao.GoodsProductMapper.browCatFinalBuyAndPrecentRandom", map);
    }

    /**
     * 根据货品ID查询最近一个月销量最高的几件货品
     * 
     * @see com.ningpai.site.goods.dao.GoodsProductMapper#queryTopSalesInfoByProductIdR
     *      (java.util.Map)
     */
