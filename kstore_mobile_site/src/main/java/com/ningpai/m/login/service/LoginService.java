...
public interface LoginService {
     ...
     */
    int checkCustomerExists(HttpServletRequest request, HttpServletResponse response, String username, String password, String code, String keeppwd) throws UnsupportedEncodingException;
