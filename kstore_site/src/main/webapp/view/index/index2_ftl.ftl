            ...
            <div class="fst_rig fl">
                ...
                <div class="r_notice">
                    <div class="notice_tit clearfix">
                        ...
                        <a class="n_more fr" href="information/list/" target="_blank">更多»</a>
                    </div><!--/notice_tit-->
                        ...
                        <ul class="notice_list">
                        	...
                        	<#list infoList as info>
                    			<#if (info_index >= 0 ) && (info_index < 5 )>
	                        		<li><a href="information/${info.infoId?c}" title="${info.title}" target="_blank">
                                ...
                                <ul class="brands_list clearfix fl">
                                	<#if (storeyTag.indexBrandList)?? && (storeyTag.indexBrandList?size>0)>
                                    	<#list storeyTag.indexBrandList as brand>
                                    		<#if (brand_index>=0) && (brand_index<24)>
		                                    <li>
		                                        <#--<a href="brandProductsList/${brand.trademarkId}"><img class="lazy" alt="" data-original="${brand.logoSrc}"  width="120" height="40"></a>-->
                                                <a href="javascript:;"><img class="lazy" alt="" data-original="${brand.logoSrc}"  width="120" height="40"></a>
		                                    </li>
                                    		</#if>
                                    	</#list>
                                    <#--<li>
