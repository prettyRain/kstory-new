...
public interface OrderGoodsMapper {
     ...
     * @return int
     */
    int selectThirdselectOrderGoodsListListByTimeCount(Map<String, Object> paramMap);
     ...
     * @return 结果
     */
    int modifyGoodsBackPrice(Map<String, Object> param);
     ...
     * @return
     */
    int updateOrderGoodsBackNew(Map<String, Object> param);
     ...
     * @return
     */
    OrderGoods selectOrderGoodsByOGId(Long orderGoodsId);

    /**
     * 删除订单货品
     * @param orderGoodsId
     */
    int deleteOrderGoodsById(Long orderGoodsId);
}
