...
public interface GoodsService {
    ...
    int updateGoods(Goods goods, Map<String, String[]> map,
            String isThirdAuditUsed, String username,String goodsAddFlag);
     ...
     * @author NINGPAI-LIH
     */
    void copyGoods(HttpServletRequest request,Long goodsId, Long thirdId, String thirdName);
     ...
     * @param goodsId
     * */
    int batchUpdateStock(HttpServletRequest request,Long[] goodsId,String stock);
     ...
     * @param goodsInfoId
     * */
    int updateArrivalNotice(HttpServletRequest request,Long goodsInfoId,Long wareId);

    /**
     * 到货通知 用于后台批量修改库存时，提醒买家
     *
     * @auhor   wangtp 2016/5/28
     * @param goodsInfoId
     * */
    int updateBatchArrivalNotice(HttpServletRequest request,Long goodsInfoId);
    ...
    int updateByPrimaryKeySelective(Goods record);
     //当有货品修改成待审核的时候 商品也为待审核
    int updateGoodsDescProduct(Goods goods);
    //查询拒绝审核理由
    String queryGoodsReasonById(Long goodsId);
}
