    		...
    		<div class="n_password">
    			<div class="n_item clearfix mb20">
    				...
    				<div class="fl">
    					...
    					<div class="ne_tips uesrname_tips hide"><img src="/images/ero.png" alt="">&nbsp;您输入的用户名有误</div>
    				</div>
    			</div>
    			<div class="n_item clearfix mb20">
    			...
    			<div class="n_item clearfix mb20">
    				...
    				<div class="fl">
    					<button class="n_nextstep" onclick="gofindcode();" disabled="true" style="background-color:#999999;">下一步</button>
    				</div>
    			</div>
    		</div>
    	</div><!--n_step-->
