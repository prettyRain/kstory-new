...
public class NewURLInterceptor extends HandlerInterceptorAdapter {
    ...
    private String[] getNoFilters() {
        return new String[] {
                ...
                // 应用市场
                "/startprocess.htm","/stopprocess.htm","/installprocess.htm",
                ...
                /*对接公有云的回调*/
                "/opencallback.htm","/noauthor.htm","/isbrandlinked.htm","/isauthcandelete.htm","/isspeccandelete.htm","/isspeccandeleteone.htm"
                ,"/isspecvaluecandelete.htm","/getmaxpoint.htm","/deleteallcustomerpointlevel.htm","/ispointenough.htm","/iswarecandelete.htm","/checkTypeName.htm","/deleteimagemanageactiontoformerbath.htm",
                /*设置正在修改订单地址*/
                ...
                /*查询社区店*/
                "/selectCommunityStoreVo.htm",
                /*查找省*/
                "/queryAllProvince.htm",
                /*查找市*/
                "/queryCityByProvinceId.htm",
                /*查找区县*/
                "/queryDistrictByCityId.htm",
                /*查看是否在配送范围之内*/
                "/isGualified.htm",
                 /*查询品牌*/
                 "/findBrands.htm",
                ...
                "/addKeywordsform.htm",
                /*删除关键字*/
                "/deleteGoodsSearch.htm",
                "/updateKeywordsform.htm",
                "/queryKeywordById.htm",
                "/checkedTitleVal.htm",
                /*添加订单备注*/
                "/addremarksajax.htm",
                 /*查看商品拒绝通过审核理由*/
                "/findReason.htm",
                /*app轮播图链接*/
                "/writeUrlToAppBanner.htm",
                /*地区管理里面 添加地址到地址列表*/
                "/addAddressToAddressList.htm",
                 /*地址列表*/
                 "/queryAddressList.htm",
                "/deleteAddress.htm",
                /*保存修改后的地址*/
                "/saveUpdateAddress.htm",
                /*添加抢购时间段*/
                "/addmarketrushtime.htm",
                /*加抢购时间段的时间*/
                "/queryTDates.htm",
                /*根据id查询抢购时间段*/
                "/queryrushtimeById.htm",
                /*根据抢购时间id修改抢购时间*/
                "/updatemarketrushtime.htm",
                /*删除抢购时间*/
                "/delrushtime.htm",
                /*批量删除抢购时间*/
                "/delrushtimes.htm",
                /*补入地址*/
                "/addprovincetoCustomerinfo.htm",
                /*测试用的保存订单修改后的地址*/
                //"/saveAddressAfterUpdate.htm",
                /*删除图片 测试用*/
                /*"/queryNotRelateImages.htm",
                "/ajaxQueryRetaleImag.htm",
                "/deleteImageManageRelate.htm",
                "/bachDeleteRelate.htm",
                "/deleteAllUrl.htm"*/
