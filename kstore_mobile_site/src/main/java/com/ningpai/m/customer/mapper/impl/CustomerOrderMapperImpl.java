...
public class CustomerOrderMapperImpl extends BasicSqlSupport implements CustomerOrderMapper {
    ...
    @Override
    public List<OrderInfoBean> searchTotalCountC(Map<String, Object> paramMap) {
        return this.selectList("com.ningpai.m.customer.mapper.CustomerMapper.searchTotalCountC", paramMap);
    }
