...
public interface ChannelAdverService {
     ...
     * @return
     */
    PageBean selectchannelAdverByParam(PageBean pb, Long channelId, Long tempId, Long floorId, Long floorTagId, Long atId, Long adverType, String temp1, String temp4,Long navId);
     ...
     * @return
     */
    List<ChannelAdver> selectchannelAdverByParamForSite(Long channelId, Long tempId, Long floorId, Long floorTagId, Long atId, Long adverType, String temp1, String temp3, String temp4, String temp5,Long navId);
}
