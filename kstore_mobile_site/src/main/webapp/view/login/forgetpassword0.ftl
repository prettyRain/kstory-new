...
<body>
<#assign vtitle="忘记密码" />
<#assign backUrl="${basePath}/loginm.html" />
...
<div class="content-login-forget-password mb50">
    ...
    <div class="in-box">
        ...
        <div class="list-item">
            <label for="">新密码</label>
            <input type="password" id="newpassword" name="newpassword" placeholder="6-16位数字、字母组合"/>
            <#--<i class="eye"></i>-->
        </div>
        <div class="list-item">
            <label for="">确认密码</label>
            <input type="password" id="repassword" name="rewpassword" placeholder="6-16位数字、字母组合"/>
            <#--<i class="eye"></i>-->
        </div>
    </div>
