...
public interface GoodsProductService {
     ...
     * @return
     */
    List<GoodsProduct> queryHotSalesTopSixRandom(GoodsCateVo cateVo, GoodsCateVo currentCateVo, Integer rowCount);
     ...
     * @return
     */
    GoodsDetailBean queryGoodsByproductIdAndDistinctId(Long productId, Long distinctId,Long marketingId,Long goodsGroupId);
     ...
     *            选择的地区ID
     */
    GoodsProductVo queryByProductIdForPresent(Long productId, Long distinctId);
     ...
     * @return
     */
    List<ListFinalBuyVo> browCatFinalBuyAndPrecentRandom(GoodsCateVo cateVo, GoodsCateVo currentCateVo, Integer rowCount);
     ...
     * @return
     */
    PageBean  selectGrouponList(PageBean pb, HttpServletRequest request);
     ...
     * @return
     */
    PageBean selectMarketingRushList(PageBean pb, HttpServletRequest request,Long tId,Long show);
    /**
     * 比较时间
     * @param begin
     * @param end
    ...
    List<GoodsProduct> queryRelatedByPid(Long goodsId);
}
