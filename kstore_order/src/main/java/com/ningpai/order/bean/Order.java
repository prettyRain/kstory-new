...
public class Order {
    ...
    /**
     * 订单出库状态 0:未拣货 1：已拣货 2：已装箱 3：已出库
     */
    ...
    public void setFinishSturts(String finishSturts) {
        this.finishSturts = finishSturts;
    }
    ...
    public void setAllGoodsNum() {
        ...
        for (OrderGoods orderGoods : orderGoodsList) {
            sumNum += orderGoods.getGoodsInfoNum();
        }

        this.allGoodsNum = sumNum;
    }

    /**
     * 判断该订单是否赠送了积分
     *
     * @return 如果赠送了返回true  否则返回false
     */
    public boolean isGivePoint() {
        return null != this.getOrderGetPoint() && this.getOrderGetPoint() > 0;
    }
    ...
    public BigDecimal getOrderCatePrice() {
        return orderCatePrice;
    }

    public void setOrderCatePrice(BigDecimal orderCatePrice) {
        this.orderCatePrice = orderCatePrice;
    }
