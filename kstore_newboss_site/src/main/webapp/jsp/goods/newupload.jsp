                  ...
                  <div class="add_good_item">
                    <h4>基本信息</h4>
						 ...
						 <div class="add_good_item_cont">
                          ...
                          <div class="add_good_item_cont">
                              <span class="label_text"><span class="text-danger">*</span>销售类型：</span>
                              <div class="add_good_form">
                                  <div class="input-group w600">
                                      <label class="radio-inline">
                                          <input type="radio" name="sellType" class="sellType" value="0" checked="checked" > 零售
                                      </label>
                                      <label class="radio-inline">
                                          <input type="radio" name="sellType" class="sellType" value="1"> 批发
                                      </label>
                                  </div>
                              </div>
                          </div>
                          ...
                          <%--<div class="add_good_item_cont">
                              <span class="label_text">单价：</span>
                              <div class="add_good_form">
                                  <div class="input-group w200">
                                      &lt;%&ndash;<span class="input-group-addon" style="line-height: 20px;" >￥</span>&ndash;%&gt;
                                      &lt;%&ndash;<input type="text" name="unitPrice" class="form-control sml_input unit_price " value="">&ndash;%&gt;
                                          &lt;%&ndash;stirng 类型的单价&ndash;%&gt;
                                         &lt;%&ndash; <input type="text" name="unitPriceStr" class="form-control sml_input unitPriceStr " value="">&ndash;%&gt;
                                  </div>
                              </div>
                          </div>--%>
                          <div class="add_good_item_cont">
                          ...
                          <div class="add_good_item_cont">
                              ...
                              <div class="add_good_form">
                                  <div class="input-group w600">
                                      <label class="radio-inline">
                                          <input type="radio" name="up" class="pro_status"  value="1" onclick="$('.up_yes').click();">审核上架
                                      </label>
                                      <label class="radio-inline">
                      ...
                      <div class="add_good_item_cont">
                          <span class="label_text">商品认证标识：</span>
                          <div class="add_good_form">
                              <div class="w500 inline_block">
                                  <c:forEach items="${auths }" var="tag">
                                      <label class="checkbox-inline"> <input type="checkbox" name="auths" style="margin-top:3px;" class="goods_auth" value="${tag.id }"><img src="${tag.authsrc}" style="width:20px;heigth:20px"></label>
                                  </c:forEach>
                      ...
                      <div class="add_good_item_cont">
                          ...
                          <form class="save_goods_desc" action="newUploadSaveGoodsDesc.htm?CSRFToken=${token }" method="post" target="hidden_frame" enctype="multipart/form-data">
                              ...
                              <input type="hidden" class="goods_specsification_desc" name="goodsSpecsificationDesc" value=""/>
                              <input type="hidden" class="goods_warp_desc" name="goodsWarpDesc" value=""/>
                              <input type="hidden" class="goods_brand_desc" name="goodsBrandDesc" value=""/>
                          </form>
                      </div>
                      <div class="add_good_item_cont">
                          <span class="label_text">PC版规格详情：</span>
                          <textarea name="specsification_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;"></textarea>
                          <textarea style="display:none" name="goodsSpecsificationDesc" id="saveGoodsSpecsificationDesc"></textarea>
                      </div>
                      <div class="add_good_item_cont">
                          <span class="label_text">PC版包装详情：</span>
                          <textarea name="warp_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;"></textarea>
                          <textarea style="display:none" name="goodsWarpDesc" id="saveGoodsWarpDesc"></textarea>
                      </div>
                      <div class="add_good_item_cont">
                          <span class="label_text">PC版品牌故事：</span>
                          <textarea name="brand_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;"></textarea>
                          <textarea style="display:none" name="goodsBrandDesc" id="saveGoodsBrandDesc"></textarea>
                      </div>
                      <div class="add_good_item_cont">
                ...
                <div class="demo_box" style="display:none;">
                  ...
                  <div role="tabpanel" class="tab-pane" id="">
                    <div class="common_form p20 common_form_max">
                      ...
                      <div class="form-group">
                          <label class="control-label col-sm-3"><span class="text-danger"> </span>商品单价：</label>
                          <div class="col-sm-1"></div>
                          <div class="col-sm-3">
                              <input type="text" class="form-control unitPriceStr "  />
                          </div>
                          <div class="col-sm-3"></div>
                      </div>
