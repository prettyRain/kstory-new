...
public interface GoodsProductService {
    ...
    GoodsProductVo findProductById(Long productId, Long districtId);
     ...
     *            选择的地区ID
     */
    GoodsDetailBean queryDetailBeanByProductId(Long productId, Long districtId);
    ...
    String getGoodsInfoMarketing(Long goodsInfoId,Long codexId,Long marketId);
