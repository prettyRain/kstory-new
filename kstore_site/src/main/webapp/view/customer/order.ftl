                ...
                <div class="order_list switch_border">
                	<div class="tagMenu tagMenu1">
                        <ul class="ods_tabs clearfix">
                           ...
                           <li <#if (type?? && type == '6')>class="cur"</#if> data-val="6"><a href="javascript:;" >退货订单</a></li>
                        </ul>
                    </div>
		                                ...
		                                <tr>
                                                ...
                                                <td>
                                                    <#if backorder.backCheck=="2" || backorder.backCheck=="4" || backorder.backCheck=="7" ||backorder.backCheck=="10"  >
                                                        <img  src="../images/delete_01.png" style="width:20px;height:20px;cursor: pointer;" onclick="showDialogs_back('${backorder.backOrderId}');">
                                                    </#if>
                                                </td>
                                             <tr>
                                        </#list>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <#if order.orderStatus=='3' || order.orderStatus=='4' || order.orderStatus=='13'|| order.orderStatus=='17'||order.orderStatus=='18' >
                                                        <img src="../images/delete_01.png" style="width:20px;height:20px;cursor: pointer;" onclick="showDialogs('${order.orderId}');">
                                                    </#if>
                                                </td>
                                            </tr>
                                           </#if>
