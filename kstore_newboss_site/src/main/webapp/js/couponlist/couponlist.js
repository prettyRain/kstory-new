        ...
        success:function(data){
            if(data!="") {
                ...
                if(coupon != "") {
                    ...
                    if(coupon.couponGetType=='0'){
                        $("#couponGetType").text("从商品页领取");
                    }else if(coupon.couponGetType=='1'){
                        $("#couponGetType").text("买商品赠");
                    }

                    $("#couponName").text(notNull(coupon.couponName));
                    $("#couponRemark").html(notNull(coupon.couponRemark));
                    ...
                    console.log(coupon.timeType);
                    if(coupon.timeType=='0'){
                        $("#timeType").text("起止时间");
                        $("#couponStartTime").text(timeObject(coupon.couponStartTime)).parent().parent().show();
                        $("#couponEndTime").text(timeObject(coupon.couponEndTime)).parent().parent().show();
                        $("#couponDays").parent().parent().hide();
                    }else if(coupon.timeType=='1'){
                        $("#timeType").text("固定时段");
                        $("#couponDays").text(coupon.couponDays+"天").parent().parent().show();
                        $("#couponStartTime").parent().parent().hide();
                        $("#couponEndTime").parent().parent().hide();
                    }
