...
public class MobHomePageMapperImpl extends BasicSqlSupport implements MobHomePageMapper {
    ...
    public int selectCount(MobHomePageVo mobHomePageVo) {
        return this.selectOne("com.ningpai.mobile.dao.MobHomePageMapper.selectCount",mobHomePageVo);
    }
    ...
    public List<Object> selectByPb(MobHomePageVo mobHomePageVo) {
        ...
        return this.selectList("com.ningpai.mobile.dao.MobHomePageMapper.selectByPb", mobHomePageVo);
    }

    @Override
    public String queryAllTitle() {
        return this.selectOne("com.ningpai.mobile.dao.MobHomePageMapper.queryAllTitle");
    }

    @Override
    public String getHomePageDocById(Long homepageId) {
        return this.selectOne("com.ningpai.mobile.dao.MobHomePageMapper.getHomePageDocById",homepageId);
    }
}
