...
public class OrderMServiceTest extends UnitilsJUnit3 {
    ...
    public void testNewsubmitOrder() {
        ...
        try {
            ...
            shoppingCartServiceMock.returns(map).getEveryThirdPriceMap(0l,0L, cartlist, 1L);
            ...
            assertNotNull(orderMService.newsubmitOrder(1L, "1", "djk","纳税人识别号",request, shoppingCartId, 1L, orderAddress, 1L,null,null));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
