...
public class HelpSiteController {
     ...
     */
    @RequestMapping("/help")
    public ModelAndView toHelpCenter(HttpServletRequest request, HttpServletResponse response) {
        ...
        return topAndBottomService.getTopAndBottom(new ModelAndView("help/newhelp", "map", map));
