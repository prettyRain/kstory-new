...
public interface CustomerServiceMapper {
     ...
     * @return 返回会员等级统计对象
     */
    List<Customer> queryCusLevleInfos(List<Customer> list,List<CustomerPointLevel> customerPointLevels);
     ...
     * @return
     */
    List<CustomerAllInfo> queryListForExportByCustomerIds(Long[] customerIds);
     ...
     * @return
     */
    boolean updatePwdInfo(Long customerId,String newpwd);
     ...
     * @return
     */
    Customer getCustomerByUsernameType(String username);
     ...
     * @return  用户地址
     */
    CustomerAddress  selectByCusIdAndAddrId(Long customerId, Long addressId);
    ...
    PageBean selectAllCustmerImg(PageBean pageBean);
     ...
     * @return
     */
    Map getDistinctByIP(HttpServletRequest request);
    /**
     * 根据IP地址获取所省份
     * @param request
     * @return
     */
    String  getProvinceByIP(HttpServletRequest request,String ip);
