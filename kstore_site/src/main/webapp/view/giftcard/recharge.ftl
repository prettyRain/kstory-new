    ...
    <div style="background: #f5f5f5;">
        <div class="container clearfix pt20 pb10">
            <div class="recharge-box">
                <div class="title">
                    <p class="h2">充值到礼品卡</p>
                    <p class="light">当前礼品卡账户总额：<strong>￥${totalDeposit?string('0.00')} </strong></p>
                </div>
                <div class="body">
                                    ...
                                    <#if (pay.payType=='1' && pay.isOpen=='1')>
                                        ...
                                        <a
                                            <#if pay.payDefault=="1">
                                                    ...
                                                    href="javascript:;">
                                            <img src="${basePath}/images/payment1.jpg"
                                        ...
                                        <li title="${pay.payName}">
                                            <a
                                                <#if pay.payDefault=="1">
                                                        ...
                                                        href="javascript:;">
                                                <img src="${basePath}/images/payment4.jpg"
                                                     onclick="changethis(this,${pay.payId});" alt="${pay.payName}">
                                            </a>
                                        </li>
                                    </#if>
                                        ...
                                        <li title="${pay.payName}">
                                            <a
                                                <#if pay.payDefault=="1">
                                                        ...
                                                        href="javascript:;">
                                                <img src="${basePath}/images/payment5.jpg"
                                                     onclick="changethis(this,${pay.payId});" alt="${pay.payName}">
                                            </a>
                                        </li>
                                    </#if>

                                        <#if (pay.payType=='5' && pay.isOpen=='1')><!-- 礼品卡 -->
                                        <li title="${pay.payName}">
                                            <a
                                                <#if pay.payDefault=="1">
                                                        class="selected"
                                                        ...
                                                        href="javascript:;">
                                                <img src="${basePath}/images/payment6.png" class="giftcard"
                                                     onclick="changethis(this,${pay.payId});" alt="${pay.payName}">
                                            </a>
                                        </li>
                                    </#if>
                ...
                <div class="charge-tips">
                    <p class="h4">充值提示</p>
                    <p>1.充值成功后，账户余额可能存在延迟现象，一般1到5分钟内到账，如有问题，请咨询客服；</p>
                    <p>2.充值金额必须大于0，且不得超过1,000,000元；</p>
                    <p>3.支付密码输错3次将锁定礼品卡账户，锁定后可充值，不可消费和提现，第二天系统自动解锁。</p>
                </div>
            </div>
        </div>
    </div>
    <div class="inputGiftcard" style="display: none;">
        <p class="h4">请输入礼品卡号：</p>
        <div class="charge-form">
            <input type="text" class="text" id="giftcardNo" name="giftcardNo"/>
        </div>
        <p class="h4">请输入礼品卡密码：</p>
        <div class="charge-form">
            <input type="password" class="text" id="giftcardPwd" name="giftcardPwd"/>
        </div>
    </div>
    <div class="inputMoney" style="display: none;">
        <p class="h4">充值金额：</p>
        <div class="charge-form">
    ...
    <div class="member-dialog dia1" id="dia1">
        <div class="member-dialog-body">
            ...
            <div class="dia-btn" style="margin-top: 40px;">
                <a class="btn new_order_active1" href="javascript:void(0)" onclick="showHelp()" id="payhelp">付款遇到问题</a>
            <a class="btn active new_order_active" href="${basePath}/deposit/mydeposit.htm">完成支付</a>

        </div>
        </div>
    </div>
    <div class="dialog dia2 agreement_dia" id="dia2">
        <div class="dia_tit clearfix" style="    background: #f5f5f5;color: #666;">
            支付问题描述
    ...
    <div class="member-dialog dia4">
        <div class="member-dialog-body">
            ...
            <div class="tc">
                ...
                <div class="que-delete clearfix">
                    <div class="fl tl">
                        <p class="f16 new_p">充值成功！</p>

                        <div class="m-btn">
                            <a href="${basePath}/deposit/mydeposit.htm" class="bnt_ok">确定</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="member-dialog-body">
            ...
            <div class="tc">
                <div class="que-delete clearfix">
                    ...
                    <div class="fl tl">
                        <p class="f14 red" id="errorContent2"></p>

                        <div class="m-btn mt20" style="text-align: center;">
                            <a class="dialogUrl" href="javascript:;" onclick="cls()">确定</a>
                        </div>
                    </div>
                </div>
...
<script>
    function changethis(obj, id) {
        ...
        if($(obj).hasClass("giftcard")){
            $(".inputForm").html($(".inputGiftcard").html());
        }else{
            $(".inputForm").html($(".inputMoney").html());
        }
    }
    ...
    function validateForm() {
        if ($form.valid()) {
            ...
            if(payId == 42){
                $.ajax({
                    url:"/deposit/giftcardRecharge.htm",
                    type:"POST",
                    data:"giftcardNo="+$("#giftcardNo").val() + "&giftcardPwd=" + $("#giftcardPwd").val(),
                    async:false,
                    success:function (data) {
                        if (data == 1) {
                            $("#errorContent2").html("卡号或密码错误，请核对后输入!");
                            dia(5);
                            return false;
                        }else if (data == 2) {
                            $("#errorContent2").html("礼品卡未激活或已失效!");
                            dia(5);
                            return false;
                        }else if (data == 3) {
                            $("#errorContent2").html("礼品卡余额不足!");
                            dia(5);
                            return false;
                        }else if (data == 4) {
                            $("#errorContent2").html("用户没有绑定礼品卡!");
                            $(".dialogUrl").attr("href","/deposit/mydeposit.htm");
                            dia(5);
                            return false;
                        }else if (data == 5) {
                            $("#errorContent2").html("请先登录!");
                            $(".dialogUrl").attr("href","/login.html");
                            dia(5);
                            return false;
                        }else{
                            dia(4);
