...
public class CustomerPointMapperIml extends BasicSqlSupport implements
     ...
     */
    @Override
    public Integer queryCustomerOrderSubtractPoint(String customerId) {
        return this.selectOne("com.ningpai.customer.dao.CustomerPointMapper.queryCustomerOrderSubtractPoint",customerId);
    }
