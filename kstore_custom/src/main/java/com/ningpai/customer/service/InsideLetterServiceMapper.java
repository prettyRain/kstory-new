...
public interface InsideLetterServiceMapper {
     ...
     * @return
     */
    List<Object> queryInsideLetters(Map<String, Object> paramMap);

    InsideLetterVo getUnReadAndNewNotice(Long customerId);

    void removeNoticeAll(Long customerId);

    Long getUnReadCounts(Long customerId);
}
