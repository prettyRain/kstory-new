...
<div class="tm-content">
    <h1 id="logo" style="display:inline-block">
    ...
    <div class="tm-content" style="height: 48px;">
        <div class="navLinks">
            <ul>
                ...
                <li><a class="navLink" onclick="clickNav('http://www.ge960.com/subject/79','3')"  href="javascript:;">狩猎时刻</a></li>
...
<#--<div class="container">-->
    ...
    <#--</div>-->
<#--</div>-->
<div class="n_login_bg" style="background-position:center center; background-repeat: no-repeat;height:420px;border:3px #e0e0e0 solid;width:1000px;margin:0 auto;">
