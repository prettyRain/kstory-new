...
public interface ShoppingCartService {
     ...
     * @return int
     */
    int delShoppingCartById(String[] cartIds,String[] goodsIds,HttpServletRequest request,HttpServletResponse response);
    /**
     * 修改购买数量
     ...
     * @return  int
     */
    int changeShoppingCartById(Long shoppingCartId, Long num,HttpServletResponse response,Long goodsInfoId);
     ...
     * @return
     */
    Map<String, Object> getPayorderThirdPriceMap(Long businessId, List<ShoppingCart> shopdata,Long distinctId,Long customerId);
     ...
     * @return
     */
    Map<String, Object> getEveryThirdPriceMap(Long customerId,Long businessId, List<ShoppingCart> shopdata,Long distinctId);
     ...
     * 查看已经添加的购物车中商品种类个数
     */
    int selectSumByCustomerId(Long cusId);
    /**
     * 查询购物车购买的商品信息
     * @param request
     * @param box
     ...
     * @return
     */
    Map<String ,Object>  getNewExpressPrice(List<ShoppingCart> shoppingCarts,Long cityId, List<Long> cartIds,Long cityInfoId);
    ...
    //查询购物车数量
    Long searchShopcartNum(HttpServletRequest request,Long customerId);
}
