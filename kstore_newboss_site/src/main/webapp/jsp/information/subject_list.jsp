    ...
    <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
            ...
            <div class="main_cont">
                ...
                <h2 class="main_title">${pageNameChild} <small>(共${pb.rows}条)</small><a href="javascript:void(0);" onclick="$('#helpSubjectTips').modal('show')" style="font-size:12px;float:right;">查看帮助<i class="icon iconfont">&#xe611;</i></a></h2>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" id="up_temp11"  name="temp1" id="inlineRadio1" value="1"> 是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" id="up_temp10" name="temp1" checked="checked" id="inlineRadio2" value="0"> 否
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="helpSubjectTips"  role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">专题页操作帮助</h4>
            </div>
            <div class="modal-body">
                <div class="modal-article">
                    <p><em>1.</em>添加专题</p>
                    <img src="./images/syshelp/zt1.jpg" alt="">
                    <img src="./images/syshelp/zt2.jpg" alt="">
                    <p><em>2.</em>专题添加成功后，自动生成专题地址</p>
                    <img src="./images/syshelp/zt3.jpg" alt="">
                    <p><em>3.</em>复制该地址，到模板配置里面将专题放到相关位置，例如：页面导航、轮播大广告等处</p>
                    <img src="./images/syshelp/zt4.jpg" alt="">
                    <p>修改完后点击确定，专题配置成功</p>
                </div>
            </div>
            <div class="modal-footer">
