...
public class MarketingScopeMapperImpl extends BasicSqlSupport implements
    ...
    public List<Long> selectgoodsInfoIdList() {
        ...
        return this.selectList("com.ningpai.marketing.dao.MarketingScopeMapper.selectgoodsInfoIdList");
    }
     ...
     */
    @Override
    public int selectMarketScopeByMapMay2(Map<String, Object> paramMap) {
        return this
                .selectOne(
                        "com.ningpai.marketing.dao.MarketingScopeMapper.selectMarketScopeByMapMay2",
                        paramMap);
    }
