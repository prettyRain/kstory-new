	    		...
	    		<div class="n_password">
	    			...
	    			<div class="n_item clearfix mb20">
	    				...
	    				<div class="fl">
	    					...
	    					<botton class="hq_code" id="sendCode" onclick="getCode()"  >获取短信验证码</botton>
	                        <div></div>
	    			...
	    			<div class="n_item clearfix mb20">
	    				...
	    				<div class="fl">
	    					<button class="n_nextstep sub_btn" onclick="tofindpwd()" disabled="true" style="background-color:#999999;">下一步</button>
	    				</div>
	    			</div><!--n_item-->
	    		</div><!--n_password-->
	    		<script>
    		...
    		<#else>
	    		...
	    		<div class="n_password">
	    			...
	    			<div class="n_item clearfix mb20">
	    				<span class="label fl">&nbsp;</span>
	    				<div class="fl">
	    					<button class="n_nextstep" onclick="sendEmail()" disabled="true" style="background-color:#999999;">发送验证邮件</button>
	    				</div>
	    			</div><!--n_item-->
	    		</div><!--n_password-->
	    		<script>
...
<div class="dialog s_dia dia2">
    ...
    <div class="dia_cont" style="text-align: center;">
        <div class="dia_intro no_tc pt30">
            ...
            <em class="info_tip_content2 info2">发送验证码失败,请稍后重试.</em>
...
<#--
<div&lt;#&ndash; class="dialog s_dia dia3"&ndash;&gt;>
    <div class="dia_tit clearfix">
        <h4 class="fl info1">提示</h4>
        <a class="dia_close fr" href="javascript:;" onclick="cls()"></a>
    </div><!--/dia_tit&ndash;&gt;
