   ...
   var isFollow=$("#isFollow").val();
	...
	$(".cllect_btn_list").click(function(){
		...
		$.post("../atte/"+$(this).attr("product_id")+".html",{districtId:districtId,goodsprice:goodsprice},function(data){
			...
			if(data=="-2"){
				/*初始化弹框样式*/
				$(".info_tip_content2").html("您还未登录不能关注该商品，是否跳转到登录页?");
