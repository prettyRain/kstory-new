      ...
      <div class="row">
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
          ...
          <div class="main_cont">
            ...
            <h2 class="main_title">添加${pageNameChild}&nbsp;<small><a href="javascript:void(0)"  onclick="$('#qgou').modal('show')" style="diaplay:block; float:right; padding-right: 12px">查看帮助<i class="icon iconfont">&#xe611;</i></a></small></h2>

            <div class="common_info common_tabs mt20">
            <ul class="nav nav-tabs" role="tablist">
              <li role="presentation" class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">抢购促销</a></li>
            </ul>
            <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="tab1">
              <div class="common_form common_form_lg p20">
              <!-- 单品促销选择 商品 -->
                <form class="form-horizontal" action="doaddmarketing.htm?CSRFToken=${token}"  id="addFormOne" method="post">
                 ...
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-1"></div>
                    <div class="col-sm-6">
                      <button type="button" class="btn btn-info" onclick="chooseProductWithClear();">选择参加促销的商品</button>
                      <span id="ps" class="spanweight"></span>
                    </div>
                      <div class="col-sm-8"><label class="control-label" style="font-size: 14px">抢购促销的货品不允许参加其他促销</label></div>
                  </div>
				<div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group date form_datetime w200" id="endpicker">
                            <input class="form-control required" type="text" value="" id="endTime" readonly
                                   name="eTime">
                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-6">
                            <select name="temp1" id="temp1"class="form-control">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-4"><span class="text-danger"></span>抢购时间段选择：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <input type="hidden" id="mobilerushImage" name="mobileRushImage">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
	                    ...
	                    <div class="col-sm-1"></div>
	                    <div class="col-sm-8">
	                        <input type="text" name="rushLimitation" id="rushLimitation" class="form-control required integer" maxlength="8">
	                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-5 col-sm-9">
                      <button type="button" class="btn btn-primary" onclick="subFormOne();">保存</button>
                    </div>
                  </div>
                </form>
              </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <table class="table table-striped table-hover table-bordered" id="productAddList">
              <thead>
              <tr>
                <th width="50"><input style="display: none" type="checkbox" onchange="chooseAllPro(this);" id="chooseAllPro"></th>
                <th width="100">货品图片</th>
                <th width="100">货品规格</th>
                <th width="150">货品编号</th>
                <th>货品名称</th>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="modal-article">
              ...
              <img src="<%=basePath %>/images/syshelp/qianggou.png" alt="">
          ...
          $.ajax({
              ...
              success:function(data) {
                  ...
                  for (var i = 0; i < list.length; i++) {
                      ...
                      productListHtml+="<td>" + list[i].goodsInfoPreferPrice + "</td></tr>";
                  }
