...
public class MarketingRushTimeMapperImpl extends BasicSqlSupport implements
    ...
    public List<Object> queryTDates() {
        return this.selectList("com.ningpai.marketing.dao.MarketingRushTimeMapper.queryTDates");
    }
    ...
    public MarketingRushTime queryrushtimeById(Long tId) {
        return this.selectOne("com.ningpai.marketing.dao.MarketingRushTimeMapper.queryrushtimeById",tId);
    }
