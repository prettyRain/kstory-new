...
public class OrderGoods {
    ...
    public Long getCountRush() {
        return countRush;
    }

    public void setCountRush(Long countRush) {
        this.countRush = countRush;
    }
    ...
    public void setCaRateProduc(BigDecimal caRateProduc) {
        this.caRateProduc = caRateProduc;
    }
    ...
    public void setProductGroupPrice(BigDecimal productGroupPrice) {
