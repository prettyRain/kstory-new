...
public interface CustomerService {
    ...
    public int updCustLevel(Long pointLelvelId,String pointLevelName,Long customerId);
     ...
     * @return
     */
    int queryPartByMobile(String mobile,String partType);

    Customer selectCustomerByCustNameAndType(Map map);

    Customer selectCustomermByPrimaryKey(Long threePartMemberId);
}
