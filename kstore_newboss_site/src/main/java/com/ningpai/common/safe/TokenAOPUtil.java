...
public class TokenAOPUtil {
    ...
    String[] urls = new String[] {
            ...
            "/startbossapp.htm",
            "/stopbossapp.htm",
            "/uninstallbossapp.htm",
            "/updatebossapp.htm",

            "/downloadthirdapp.htm",
            "/startthirdapp.htm",
            "/stopthirdapp.htm",
            "/uninstallthirdapp.htm",
            "/updatethirdapp.htm",

            "/downloadsiteapp.htm",
            "/startsiteapp.htm",
            "/stopsiteapp.htm",
            "/uninstallsiteapp.htm",
            "/updatesiteapp.htm",

            "/webdetails.htm",
            "/appStartedNotice.htm",
            "/queryAppMarketKeyState.htm",
            ...
            "/findAllGoodsArrival.htm",
            "/findGoodsAtteByProductIdArrival",
            //ERP相关
            "/synImportGoods.htm",//ERP导入商品
            "/synUpdateGoodsFromERP.htm",//同步ERP商品信息到kstore
            "/synUpdateGoodsToERP.htm",//更新kstore商品信息到ERP
            "/synUpdateOrderStatus.htm",//更新ERP订单状态到kstore
            "/synUpdateStocks.htm",//更新ERP商品库存到kstore
            "/synUpdateOrderToERP.htm",//推送订单到电商通
            // 系统部分
            "/basicset.htm",
            "/initSeoConf.htm",
            "/toAdvancedSet.htm",
            ...
            //移动版页面分类
            "/queryMobPageCateByPageBean.htm",
            ...
            "/newdomodifymarketing.htm", "/newqueryProductForCoupon.htm", "/newselectcouponnolistajax.htm", "/freightTemp.htm", "/batchUpGoods.htm", "/batchDownGoods.htm","/queryProductForFullbuyPresent.htm",
            // 店铺街 轮播大广告
            "/storeliststreetimage.htm","/storelistqianggouimage.htm", "/showtempadverajax.htm", "/updatetempadverajax.htm", "/deletetempadverajax.htm", "/setstore.htm",

            "/selectnewcustomer.htm", "/querystatistics.htm", "/operalogajax.htm", "/selectcountbyweek.htm",

            // 订单 退款
            "/newsavebackorderprice.htm", "/insertelasticgoods.htm","/checkbackprice.htm",
            // 导出订单
            "/exportallorder.htm",
            // 收款单列表
            ...
            "/checkusername.htm",
            "/selectlog.htm",
            "/queryLogisticsCompanyNew.htm",
            "/ajaxqueryprovincename",
            "/ajaxquerycityname",
            "/ajaxquerydistrictname",
            "/isbrandlinked.htm",
            "/isauthcandelete.htm",

            // app首页配置品牌与分类选择
            "/queryMobCateBarForChoose.htm",
            "/queryAllBrandForChoose.htm",
            "/isspeccandelete.htm",
            "/isspeccandeleteone.htm",
            "/isspecvaluecandelete.htm",
            "/getmaxpoint.htm",
            "/deleteallcustomerpointlevel.htm",
            "/ispointenough.htm",
            "/iswarecandelete.htm",
            "/checkTypeName.htm",
            ...
            // H5 移动端 专题页列表
            "/queryMobileInfoSubjectByPageBean.htm",

            //一键发货
            "/onekeydelivery.htm",
            //订单导出
            "/exportallorder.htm",
            "/deleteimagemanageactiontoformerbath.htm",
            //预存款
            "/initDepositInfoList.htm",
            "/selectDepositInfoById.htm",
            "/selectDepositInfoDetail.htm",
            "/initGiftcardInfoList.htm",
            "/toActiveGiftcard.htm",
            "/activeGiftcard.htm",
            "/toMakeGiftcard.htm",
            "/makeGiftcard.htm",
            "/selectCardSegmentAjax.htm",
            "/exportCardNo.htm",
            "/validaGiftcard.htm",
            "/sendGiftBindingSMS.htm",
            "/saveBindingGift.htm",
            "/saveRechargeGiftcard.htm",
            "/saveGuaShiGiftcard.htm",
            "/savetoNewGiftCard.htm",
            //会员提现
            "/initChargeWithdrawList.htm",
            "/updateChargeWithdrawStatus.htm",
            "/batchUpdateChargeWithdrawStatus.htm",
            "/selectChargeWithdrawById.htm",
            "/updateWithdrawPayStatus.htm",
            "/readQQ.htm",
            "/readKst.htm",
            //登录手机验证
            "/valilogincode.htm",
             /*修改订单地址状态*/
            "/updateOrderAddressState.htm",
                /*查看订单地址的修改状态*/
            "/queryUpdateStateByOrderId.htm",
                /*查看区县下面的社区店*/
            "/loadAllCommunityStores.htm",
            //移动端生成二维码
            "/qrcodeMob.htm",
            /*修改地址的时候查看地址是否能用*/
            "/isGualified.htm",
            ...
            "/noticeAdd.htm",
            "/noticeTags.htm",
            "/ajaxGetNoticeTags.htm",
            "/ajaxSaveNotice.htm",
            "/ajaxDeleteNotice.htm"
    };
    ...
    @Pointcut("execution(* com.ningpai.manager.controller.ManagerController.valilogincode(..))")
