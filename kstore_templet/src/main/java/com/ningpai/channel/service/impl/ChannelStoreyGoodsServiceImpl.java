...
public class ChannelStoreyGoodsServiceImpl implements ChannelStoreyGoodsService {
     ...
     * temp3 0:排行榜 1：罪行降价  2：新品
     */
    @Override
    public PageBean selectchannelStoreyGoodsByParam(PageBean pb, Long storeyId, Long storeyTagId, String isHot,Long navId,String temp3) {
        ...
        try {
            ...
            //最新降价
            if("1".equals(temp3)){
                pb.setListNew(this.storeyGoodsMapper.selectchannelStoreyGoodsByParam(map));
            }else{
                //推荐排行
