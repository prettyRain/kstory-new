			...
			$.ajax({
				...
				success : function(data){
					...
					for(var i=0;i<data.length;i++){
						...
						var t_cateId = $.trim(data[i].cateId);
						...
						if(data[i].childs.length>0){
							for(var j=0;j<data[i].childs.length;j++){
                                ...
                                html = html +'<td><span class="link" style="display: none">'+'listByCateBar/'+data[i].childs[j].cateId+'</span></td><td class="tr">';
                                ...
                                html = html +'</td></tr>';
                                  ...
                                  if(data[i].childs[j].childs.length>0){
                                      for(var h=0;h<data[i].childs[j].childs.length;h++){
                                          ...
                                          +'<td><span class="link" style="display: none">'+'listByCateBar/'+data[i].childs[j].childs[h].cateId+'</span></td>'
