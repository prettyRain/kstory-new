            ...
            for (int i = 0; i < customerFollows.size(); i++) {
                ...
                if(goodsProductVo!=null){
                    ...
                    if(goodsProductVo.getIsThird() !=null && !"".equals(goodsProductVo.getIsThird()) && "1".equals(goodsProductVo.getIsThird())){
                        ...
                        if(childCustomerFollow.getGood()!=null && productWare!=null){

                            childCustomerFollow.getGood().setGoodStock(productWare.getWareStock());
                        }else if(childCustomerFollow.getGood()!=null){
                            childCustomerFollow.getGood().setGoodStock(0l);
                        }*/
                        Long wareStock = 0l;
                        List<ProductWare> productWares = this.productWareService.queryGoodsStock(childCustomerFollow.getGoodsId());
                        ...
                        childCustomerFollow.getGood().setGoodStock(wareStock);
                    }
                    //获取货品好评度
                    ...
                    objectList.add(childCustomerFollow);
                }
            }
            pb.setList(objectList);
        }
        return pb;
    }
