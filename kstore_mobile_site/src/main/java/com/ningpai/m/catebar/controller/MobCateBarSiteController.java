...
public class MobCateBarSiteController {
     ...
     * @return
     */
    @RequestMapping("/queryJsonMobCateBar")
    @ResponseBody
    public List<MobCateBarVo> queryJsonMobCateBar(Long cateId) {
        List<MobCateBarVo> cateBarVos = mobCateBarService.queryUsingMobCateBar(cateId);
        return cateBarVos;
    }
