...
public interface SiteOrderService {
     ...
     * @return
     */
    Map<String, Object> getEveryparamMap(Long customerIds,Long[] shopCartIds, Long custAddress,ShoppingCart cart);
     ...
     * @throws IOException
     */
    List<Order> newsubmitOrder(HttpServletRequest request, Long[] shoppingCartId, String customerRemark, String chInvoiceTitle, String chInvoiceContent,Long isbuynow) throws IOException;
