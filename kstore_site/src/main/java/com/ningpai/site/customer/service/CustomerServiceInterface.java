...
public interface CustomerServiceInterface {
     ...
     * @return 1 失败 0网络连接超时 -1没过90秒
     */
    int newsendPost(HttpServletRequest request, String moblie);
     ...
     * @return
     */
    int updatePwdInfo(Long customerId,String password);
     ...
     */
    boolean isCustomerAddressNumLegal(Long customerId);
     ...
     * @return 用户地址
     */
    CustomerAddress selectByAddrIdAndCusId(Long cutomerId, Long addressId);
