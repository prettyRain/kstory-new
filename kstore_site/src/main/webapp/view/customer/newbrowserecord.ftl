                                                ...
                                                <#if brow.createTime?string('yyyy-MM-dd')==time&&brow.goods??>
                                                    <li>
                                                        <a href="${basePath}/item/${brow.goodsId}.html">
                                                            <img style="width:204px;height:204px;" alt="<#if brow.goods.goodsName??> ${brow.goods.goodsName}</#if>" src="<#if brow.goods.goodsImageList??><#list brow.goods.goodsImageList as image><#if image_index==0>${image.imageBigName!''}</#if></#list></#if>" />
                                                            ...
                                                            <p class="price">￥${brow.goods.goodsMarketPrice?string('0.00')}</p>
                                                        </a>
                                                        <div class="story-bg">
                                                            ...
                                                            <a href="javascript:void(0)" onclick="buy(this)" class="fr mr20"><img src="${basePath}/images/shop-car.png" width="21" height="17"></a>
                                                            <input type="hidden" value="${brow.goodsId}" />
                                                            <a href="javascript:void(0)" onclick="addattr(this,${brow.goodsId})" class="fr mr20"><img <#if goodsIds ?? && goodsIds?size!=0><#if goodsIds?seq_contains('${brow.goodsId?string}')>src="${basePath}/images/loved.png"<#else>src="${basePath}/images/love.png"</#if></#if> width="21" height="17"></a>
                                                        </div>
    ...
    <div class="member-dialog dia2">
        <div class="member-dialog-body">
            ...
            <div class="tc">
                ...
                <div class="que-delete clearfix">
                    <div class="fl tl">
                        <p class="f16 new_p" id="con_00">确定确认收货吗？</p>
                        <div class="m-btn ">
                            <a  id="go_pay_01" href="javascript:cls();" class="bnt_ok">确定</a>
                        </div>
                    </div>
