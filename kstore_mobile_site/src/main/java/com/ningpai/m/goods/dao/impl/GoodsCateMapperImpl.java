...
public class GoodsCateMapperImpl extends BasicSqlSupport implements GoodsCateMapper {
     ...
     * 查询所有的商品分类
     *
     * @return 分类列表 {@link List} {@link com.ningpai.goods.vo.GoodsCateVo}
     */
    ...
    public List<GoodsCateVo> queryCatesByCateIds(Map cateIdsMap){
        return this.selectList("com.ningpaimsite.goods.dao.GoodsCateMapper.queryCatesByCateIds",cateIdsMap);
    };
}
