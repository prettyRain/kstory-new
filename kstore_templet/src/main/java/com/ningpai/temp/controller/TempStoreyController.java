...
public class TempStoreyController {
    ...
    @ResponseBody
    public int createTempStoreyAjax(HttpServletRequest request, HttpServletResponse response, ChannelStorey channelStorey, BindingResult bindingResult, Long tempId) {
        // 判断是否符合规范
        if (bindingResult.hasErrors()) {
            // 返回
            return 0;
    ...
    @ResponseBody
    public int updatetempstoreyajax(HttpServletRequest request, HttpServletResponse response, ChannelStorey channelStorey, BindingResult bindingResult, Long tempId) {
        // 判断是否符规范
        if (bindingResult.hasErrors()) {
            // 返回结果
            return 0;
