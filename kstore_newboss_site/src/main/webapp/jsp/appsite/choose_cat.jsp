...
<head>
    ...
    <script>
        ...
        cats.forEach((cat)=>{
          if(cat.parentId === 0){
              var menu = {"id": ""+cat.cateBarId, "parent": '#', "text":cat.cateId+"-"+cat.name};
              menus_1.push(menu);
            }
        });
        ...
        menus_1.forEach((menu)=>{
            cats.forEach((cat)=>{
                if(cat.parentId+"" === menu.id){
                    menus_2.push({"id": ""+cat.cateBarId, "parent": menu.id, "text":cat.cateId+"-"+cat.name})
                }
            });
        });
        ...
        menus_2.forEach(menu=>{
            cats.forEach((cat)=>{
                if(cat.parentId+"" === menu.id && cat.parentId != 0){
                    menus_3.push({"id": ""+cat.cateBarId, "parent": menu.id, "text":cat.cateId+"-"+cat.name})
                }
            });
        });
