...
public class ChannelSiteController {
    ...
    public ModelAndView channelView(HttpServletRequest request, Long goodsCateId, GoodsSiteSearchBean searchBean, PageBean pageBean) {
        ...
        if (null == channel) {
            ...
            // 获取页面轮播大广告
            mav.addObject("avc",
                    channelAdverService.selectchannelAdverByParamForSite(channel.getChannelId(), channel.getTempId(), null, null, ATID1, ADVERTTYPE, null, "0", null, null,null));
            // 获取页面轮播小广告
            mav.addObject("avs",
                    channelAdverService.selectchannelAdverByParamForSite(channel.getChannelId(), channel.getTempId(), null, null, ATID2, ADVERTTYPE, null, "0", null, null,null));
            // 获取页面广告
            mav.addObject("pageAdvs",
                    channelAdverService.selectchannelAdverByParamForSite(channel.getChannelId(), channel.getTempId(), null, null, ATID3, ADVERTTYPE, null, "0", null, null,null));
