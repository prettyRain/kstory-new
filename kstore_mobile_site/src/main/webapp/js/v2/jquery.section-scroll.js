    ...
    $.fn.sectionScroll = function (options) {
      ...
      //修改s
        if($(".arouse-app").css("display") == "block"){
            $bullets = '<div class="bullets-container" style="top:54px;"><ul class="'+ $bullets_class +'"></ul></div>';
        }else{
      ...
      menuItems.click(function (e) {
          ...
          if($(".arouse-app").css("display") == "block"){
              ...
              offsetTop = href === "#" ? 0 : $(href).offset().top-51-54;
          }else{
              href = $(this).find('a').attr("href");
              offsetTop = href === "#" ? 0 : $(href).offset().top-51;
          }
      ...
      $(window).scroll(function () {
          ...
          var fromTop;
          if($(".arouse-app").css("display") == "block"){
              fromTop = $(this).scrollTop()+54+54;
          }else{
              fromTop = $(this).scrollTop()+54;
          }
