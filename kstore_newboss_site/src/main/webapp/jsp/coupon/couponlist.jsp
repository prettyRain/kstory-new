                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li><a href="javascript:void(0);" onclick="window.open('exportCouponCodeNo.htm?CSRFToken=${token}&couponId=${coupon.couponId }');">导出券码</a></li>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb20 container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-16">
                                            <p>固定时段: <span id="couponDays"></span></p>
                                        </div>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <p>活动时间：<span id="timeType"></span></p>
                                        </div>
                                        <div class="col-sm-8">
                                            <p>领取放式：<span id="couponGetType"></span></p>
                                        </div>
                                    </div>
                                </div>
                                <h4>优惠券使用范围</h4>
