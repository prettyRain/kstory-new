...
public interface ClassifyBarService {
     ...
     * @return
     */
    PageBean selectClassifyBarByParam(PageBean pb, Long tempId, Long channelId, String definedCate, String thirdId);
     ...
     * @return
     */
    List<ClassifyBarVo> selectClassifyBarByParamThirdSite(Long tempId, Long channelId, String thirdId);
     ...
     * @return
     */
    List<ClassifyBarVo> getClassifyBarByProvinceId(String id);
}
