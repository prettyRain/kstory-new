...
public class GoodsCateMapperImpl extends BasicSqlSupport implements
     ...
     * 查询三级分类的第一个
     *
     * @see com.ningpai.site.goods.dao.GoodsCateMapper#findCid(java.lang.Long)
     */
    @Override
    ...
    /**查询分类
     * @see com.ningpai.site.goods.dao.GoodsCateMapper#findCatGrade(java.lang.Long)
     */
    @Override
     ...
     *
     * @see
     * com.ningpai.goods.dao.GoodsCateMapper#queryCateVoByCatId(java.lang.Long)
     */
     ...
     */
    @Override
    public List<Channel> queryChannelByCatId(Long catParentId) {
        return this
                .selectList(
                        "com.ningpaihsite.goods.dao.GoodsCateMapper.queryChannelByCatId",
                        catParentId);
    }
