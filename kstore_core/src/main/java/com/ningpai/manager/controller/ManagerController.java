...
public class ManagerController {
    ...
    @ResponseBody
    public String ifLogin(HttpServletRequest request, String name, String password, String code, String patchaFlag) {
     ...
     * @return
     */
    @RequestMapping("/valilogincode")
    @ResponseBody
    public int valilogincode(HttpServletRequest request,String code) {
        String mobile = (String) request.getSession().getAttribute("loginUserMob");
        if(mobile == null || mobile == ""){
            return -2;
        }

        if(code == null || code == "" || !code.equals((int) request.getSession().getAttribute("mcCode") + "")) {
            //验证码错误
            return -1;
        }
        // 非空验证 手机号码
        ...
        return managerService.sendlogincode(request, mobile);
    }
