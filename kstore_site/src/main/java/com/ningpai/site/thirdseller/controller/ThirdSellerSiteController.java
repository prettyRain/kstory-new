...
public class ThirdSellerSiteController {
    ...
    public ModelAndView thirdStoreIndex(String top, HttpServletRequest request, Long thirdId, PageBean pb, ThirdGoodsSearchBean searchBean) {
        ...
        resultMap.put("channelAdvs",
                channelAdverService.selectchannelAdverByParamForSite(null, Long.valueOf(temp.getTempId()), null, null, 157L, 151L, null, null, thirdId.toString(), null,null));
        // 轮播小广告
        resultMap.put("channelSadvs",
                channelAdverService.selectchannelAdverByParamForSite(null, Long.valueOf(temp.getTempId()), null, null, 159L, 151L, null, null, thirdId.toString(), null,null));
        // 页面广告
        resultMap.put(PAGEADVS,
                channelAdverService.selectchannelAdverByParamForSite(null, Long.valueOf(temp.getTempId()), null, null, 161L, 151L, null, null, thirdId.toString(), null,null));
        // 热销推荐
    ...
    public ModelAndView thirdStoreIndexEs(String top, HttpServletRequest request, Long thirdId, SearchPageBean<EsGoodsInfo> pb, ThirdGoodsSearchBean searchBean) {
        ...
        // 导航
        resultMap.put(CLASSBAR, classifyBarService.selectClassifyBarByParamThirdSite(Long.valueOf(temp.getTempId()), null, thirdId.toString()));
        // 轮播图
        resultMap.put("channelAdvs",
                channelAdverService.selectchannelAdverByParamForSite(null, Long.valueOf(temp.getTempId()), null, null, 157L, 151L, null, null, thirdId.toString(), null,null));
        // 轮播小广告
