...
public class ShoppingCart {
    ...
    *商品重量
    ...
    /**
     * 是否显示,如果套装中有商品被设置为 移动端不显示,则该套装不显示
     */
     ...
     * 购物车选中的赠品list 优惠券
     */
    private List<Coupon> presentCoupon;

    public List<Coupon> getPresentCoupon() {
        return presentCoupon;
    }

    public void setPresentCoupon(List<Coupon> presentCoupon) {
    ...
    public String getPresentScopeIds() {
        return presentScopeIds;
    }

    public void setPresentScopeIds(String presentScopeIds) {
        this.presentScopeIds = presentScopeIds;
    }

    public List<GoodsProduct> getPresentGoodsProducts() {
        return presentGoodsProducts;
    }

    public void setPresentGoodsProducts(List<GoodsProduct> presentGoodsProducts) {
        this.presentGoodsProducts = presentGoodsProducts;
    }
}
