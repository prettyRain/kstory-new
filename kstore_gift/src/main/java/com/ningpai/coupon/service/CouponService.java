...
public interface CouponService {
    ...
    List<Coupon> selectGoodsDetailCouponListByIdsNew(List<ParamIds> list,Long thirdId,HttpServletRequest request);
    /**
    ...
    Coupon queryMZCoupon(Long customerId,Long couponId);

    void updateCouponNo(CouponNo couponNo);
    /**
     * 订单完成时修改优惠券状态
     */
    void modifyCouponByOrderIdAndCustomerId(Long orderId,Long customerId);
    /**
     * 取消与订单绑定的要赠送的优惠券
     */
     void cancelOrderCoupon(Long orderId);
}
