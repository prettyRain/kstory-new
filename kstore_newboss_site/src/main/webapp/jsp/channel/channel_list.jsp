                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach items="${pb.list}" var="channel" varStatus="sta">
                                <tr>
                                    ...
                                    <td>channel/${channel.channelId}.html</td>
                                        <%--   <td> ${goods.stock }</td> --%>
                                    <td>
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" id="channelForm" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-16">
                            <input type="text" class="form-control" name="channelName" id="up_channelName" value="" maxlength="50"><span
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-5">主题颜色：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <input type="text" name="keyword" id="keyword" class="text ui-widget-content ui-corner-all" style="height: 34px;" maxlength="25">
                            <%--<font id="keyword_tips">默认为频道名称</font>--%>
                        </div>
                    </div>
                    <div class="form-group" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <textarea name="temp2"   id="up_seoTitle" class="form-control specstr" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <textarea name="temp3"   id="up_seoKeyword" class="form-control specstr" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <textarea name="temp5" id="up_seoDesc" class="form-control specstr" rows="5"></textarea>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body">
                <form role="form" class="form-horizontal" id="updatechannelForm" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <input type="text" class="form-control" name="channelName" id="update_channelName" value="" maxlength="50"><span
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <input type="text" name="keyword" id="updatekeyword" class="text ui-widget-content ui-corner-all" style="height: 34px;" maxlength="25">
                            <%--<font id="updatekeyword_tips">默认为频道名称</font>--%>
                        </div>
                    </div>
                    <div class="form-group" style="display:none;">
                        <label class="control-label col-sm-5">频道描述：</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <textarea name="temp2"   id="update_seoTitle" class="form-control specstr" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-5">seo关键字：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <textarea name="temp3"   id="update_seoKeyword" class="form-control specstr" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-5">seo描述：</label>
                        <div class="col-sm-1"></div>
                        <div class="col-sm-16">
                            <textarea name="temp5" id="update_seoDesc" class="form-control specstr" rows="5"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
//        $(".modal-title").html("修改频道");
        $.ajax({
            ...
            success:function(date){
                ...
                $("#update_seoTitle").val(date.channel.temp2);
                $("#update_seoKeyword").val(date.channel.temp3);
                $("#update_seoDesc").val(date.channel.temp5);
                var selecthtml="";
    ...
    function checkKeyWord(inputobj,Tipobj){
        var regexp=new RegExp("[`~!@$^&*={}':;\\[\\]<>/?~！@￥……&*{}【】‘；：”“'。、？]");
        if (regexp.test( $("#"+inputobj).val() ) ) {
            $("#"+inputobj).addClass( "ui-state-error" );
            updateTips( "输入的内容包含特殊字符!", $("#"+Tipobj));
    ...
    $(function(){
        $('#update').click(function(){
            ...
            flag = checkKeyWord("updatekeyword","updatekeyword_tips") && flag;
            //验证频道描述
            if($("#updatedes").val()==""){
...
//                }
        ...
        $('#save').click(function() {
            ...
            flag = checkKeyWord("keyword","keyword_tips") && flag;
            //验证频道描述
            if($("#des").val()==""){
