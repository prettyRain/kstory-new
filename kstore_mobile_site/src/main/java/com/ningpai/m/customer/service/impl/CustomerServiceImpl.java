...
public class CustomerServiceImpl implements CustomerService {
    ...
    public CustomerAllInfo selectByPrimaryKey(Long customerId) {
        ...
        if (null != customerAllInfo) {
            ...
            CustomerPointLevel customerPointLevel = customerPointServiceMapper.getCustomerPointLevelByPoint(customerAllInfo.getInfoPointSum()-customerPointServiceMapper.getCustomerOrderSubtractPoint(customerId+""));
     ...
     */
    @Override
    public int queryPartByMobile(String mobile, String partType) {
        Map map = new HashMap();
        map.put("mobile",mobile);
        map.put("partType",partType);
        ThreePart threePart = this.threePartMapper.queryPartByMobile(map);
        if(threePart!=null){
            //已绑定
            return 5;
        }
    ...
    @Override
    public Customer selectCustomerByCustNameAndType(Map map) {
        return this.customerMapper.selectCustomerByCustNameAndType(map);
    }

    @Override
    public Customer selectCustomermByPrimaryKey(Long threePartMemberId) {
        return this.customerMapper.selectCustomermByPrimaryKey(threePartMemberId);
    }
