                            ...
                            <div class="layout">
                                <table class="complain-table">
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea id="complaincon" maxlength="250"></textarea><br/>
                                            <p>请您如实填写原因及商品情况，字数在10-250字内且不要包含特殊字符。</p>
                                            <a class="complain-submit new_hover" onclick="addcomplain()">提交</a>
                                        </td>
                                    </tr>
                                </table>
                            </div>
