...
//				$(".search_text").blur();
    ...
    $(".goods_contrast").css("left",($(window).width() * .5) - ($(".goods_contrast").width() *  .5));
		$(".hide_ct").click(function(){
			$(".goods_contrast").hide(600);
		});
		...
		var li_n = $(".thumb_scroll_wp li").length - 4;
		var li_step = 0;
		...
		if(li_n > 0) {
			$(".thumb_scroll_wp ul").width($(".thumb_scroll_wp li").length*66);
		...
		function ctabs(t1, t2, t3) {
			$("."+ t1).find("li:first").addClass("cur");
			$("."+ t2).find("."+ t3 +":first").show().addClass("show");
			//$("."+t2).find("."+t3+":last").show().addClass("show");
			$("."+ t1 +" li").each(function(n){
				var current = $(this);
		...
		ctabdesc('nav_tabs','product_detail','details_box');

        function ctabdesc(t1,t2,t3){
            $("."+ t1).find("li:first").addClass("cur");
            $("."+ t2).find("."+ t3 +":first").show().addClass("show");
            $("."+ t2).find("."+ t3 ).eq(1).show().addClass("show");
			$("."+ t2).find("."+ t3 ).eq(2).show().addClass("show");
			$("."+ t2).find("."+ t3 ).eq(3).show().addClass("show");
			$("."+t1+" li").each(function(index,item){
				if(index>=4){
                    $(this).find("a").click(function(){
                        offon=false;
                        $("."+ t1).find("li.cur").removeClass("cur");
                        ...
                        $("."+ t2).find("."+ t3 +".show").hide().removeClass("show");
                        $("."+ t2 +" ."+ t3 +":eq("+ index +")").show().addClass("show");
					})
				}else{
                   $(this).find("a").click(function(){
                   	   offon=false;
                       ...
                       $(".detail_nav").addClass("sticky");
                       $("."+ t2).find("."+ t3 +".show").hide().removeClass("show");
                       $("."+ t2).find("."+ t3 ).eq(0).show().addClass("show");
                       $("."+ t2).find("."+ t3 ).eq(1).show().addClass("show");
                       $("."+ t2).find("."+ t3 ).eq(2).show().addClass("show");
                       $("."+ t2).find("."+ t3 ).eq(3).show().addClass("show");
                       setTimeout(function(){
		...
		if($(".detail_nav").length > 0) {
			...
			function onScroll(_3y){
                if (($(document.body).scrollTop() >= _y && $(document.body).scrollTop() <= _3y) || ($(document.documentElement).scrollTop() >= _y && $(document.documentElement).scrollTop() <= _3y) || (window.scrollY >= _y && window.scrollY <= _3y)) {
                    $(".detail_nav").addClass("sticky");
                } else {
			...
			$(window).scroll(function(){
                var _3y = $(".footer_tab").offset().top - $(".detail_nav ").height() - 450;
				onScroll(_3y);
				if(offon){
                    downScroll();
				}
            ...
            function downScroll(){
                var _y = $(".detail_nav").offset().top;
            	var hdiv=$('.product_detail').height();
            	if($(document).scrollTop()>=(_y+hdiv)){
                    $(".detail_nav").removeClass("sticky");
				}
                $(".nav_tabs li").each(function(index,item){
                	if(index<=3){
                        var $top=$(document).scrollTop()+36;
                        var $boxtop=$('.details_box').eq(index).offset().top;
                        var _this=$(this);
                        if($top>=$boxtop){
				...
				if(index>=4){
					...
					(function fun(item,index){
                        $(item).find("a").click(function () {
                            var divtop = $(".product_detail").find(".details_box").eq(index).offset().top-36;
                            $("body,html").animate({scrollTop: divtop}, 500);
                        })
                    })(item,index);
				}
			});
