...
public class GoodsElasticMapperImpl extends BasicSqlSupport implements
     ...
     */
    @Override
    public String getGoodsInfoMarketing(Long goodsInfoId, Long codexId, Long marketingId) {
        return null;
    }
     ...
     */
    @Override
    public BigDecimal selectPriceOffMarketingByMarketingId(Long marketingId) {
        return this.selectOne(
                        "com.qianmi.web.dao.EsGoodsInfoMapper.selectPriceOffMarketingByMarketingId",
                        marketingId);
    }
     ...
     */
    @Override
    public BigDecimal selectGrouponByMarketId(Long marketingId) {
        return this.selectOne(
                        "com.qianmi.web.dao.EsGoodsInfoMapper.selectGrouponByMarketId",
                        marketingId);
    }
     ...
     */
    @Override
    public BigDecimal selectRushByMarketId(Long marketingId) {
        List<BigDecimal> objects = this.selectList("com.qianmi.web.dao.EsGoodsInfoMapper.selectRushByMarketId", marketingId);
     ...
     */
    @Override
    public BigDecimal selectDiscountByMarketId(Map<String, Object> param) {
        return this.selectOne( "com.qianmi.web.dao.EsGoodsInfoMapper.selectDiscountByMarketId",
                param);
    }
