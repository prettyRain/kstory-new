...
public interface CustomerPointServiceMapper {
     ...
     * @return
     */
    int addIntegralByType(Long customerId, String type, Double orderPrice, String orderId, Date createTime);
     ...
     */
    Integer getCustomerOrderSubtractPoint(String customerId);
    /**
     * 获得会员总的用掉的积分
     *
     * @param customerId 会员id
