                    ...
                    <div class="common_form">
                        <form class="form-horizontal" id="editEstoreForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 ">
                                    <div class="col-sm-35">
                                        <img alt="" src="${estore.image}" id="img" style="max-height: 200px;max-width: 250px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value" attr_id="server">${estore.url }&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="text" class="form-control w300 required" value="${estore.url }" name="url" id="server">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-6">Secret：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value" attr_id="appscret">${estore.secret }&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="text" class="form-control w300 required specstr" value="${estore.secret }" name="secret" id="appscret">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-6">SessionKey：</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-14 form_item">
                                    <span class="form_value" attr_id="token">${estore.sessionkey }&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="text" class="form-control w300 required specstr" value="${estore.sessionkey }" name="sessionkey" id="token">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
