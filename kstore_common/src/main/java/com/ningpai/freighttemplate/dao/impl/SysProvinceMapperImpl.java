...
public class SysProvinceMapperImpl extends BasicSqlSupport implements
    ...
    public List<SysProvince> selectAllProvince() {
        return this
                .selectList("com.kstore.web.dao.SysProvinceMapper.selectAllProvince");
    }
    ...
    public SysProvince selectProvinceById(Long provinceId) {
        return this.selectOne(
                "com.kstore.web.dao.SysProvinceMapper.selectByPrimaryKey",
                provinceId);
    }

    @Override
    public List<SysProvince> selectProvinceByIds(String provinceId) {
        return this
                .selectList("com.kstore.web.dao.SysProvinceMapper.selectProvinceByIds", provinceId);
    }
