...
public class ReceivablesMapperImpl extends BasicSqlSupport implements
    ...
    public int upDateReceivables(Receivables receivables) {
        return this.update("com.ningpai.system.dao.ReceivablesMapper.upDateReceivables",
                receivables);
    }
    ...
    public void deleteByCode(String orderCode) {
        this.delete("com.ningpai.system.dao.ReceivablesMapper.deleteByPrimaryKey",orderCode);
    }

    @Override
    public List<Receivables> getAllByOrderCode(Map<String,String> map) {
        return this.selectList(
                "com.ningpai.system.dao.ReceivablesMapper.queryReceivables",map);
    }
