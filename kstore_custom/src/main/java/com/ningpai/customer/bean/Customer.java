...
public class Customer implements Serializable {
    ...
    /**
     * 用户唯一code,当该用户为共有云同步用户时,值为公有云的userId
     * 否则为customerId
     */
    private String uniqueCode;

    public String toAuditImg;

    public String auditImgPerson;

    private Date auditImgTime;
    ...
    public Date getLoginLockTime() {
        return loginLockTime==null?null: (Date) loginLockTime.clone();
    }
    ...
    public Date getMaxtime() {
        return maxtime==null?null: (Date) maxtime.clone();
    }
    ...
    public void setAuditImgTime(Date auditImgTime) {
        if (createTime != null) {
    ...
    public String getToAuditImg() {
        return toAuditImg;
    }

    public void setToAuditImg(String toAuditImg) {
        this.toAuditImg = toAuditImg;
    }

    public String getAuditImgPerson() {
        return auditImgPerson;
    }

    public void setAuditImgPerson(String auditImgPerson) {
        this.auditImgPerson = auditImgPerson;
    }
