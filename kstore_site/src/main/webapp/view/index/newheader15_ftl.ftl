...
<div class="section-header">
        <div class="content">
            <h1 id="logo">
               ...
               <img alt="" src="${topmap.systembase.bsetLogo}" style="width: 165px;height: 70px;">
                </a>
            </h1>
            <div class="logoBanner"><a href="${(topmap.logoAdv.adverHref)!'#'}"><img src="${(topmap.logoAdv.adverPath)!'${basePath}/index_fifteen/images/ad.jpg'}" width="135" height="35"></a></div>
                ...
                <div class="miniCart hide" style="display: none;">
                    ...
                    <div class="mCartHandler clearfix">
                            <span class="mcCashier">
                                ...
                                <a href="${basePath}/myshoppingcart.html" class="mcGo" style="color:#fff;" target="_blank">结算</a><!-- no-mcGo置灰状态 -->
                            </span>
