...
<head>
    ...
    <link rel="stylesheet"
          href="<%=basePath%>js/kindeditor/plugins/code/prettify.css" />
    <script charset="utf-8" src="<%=basePath%>js/kindeditor/kindeditor.js"></script>
    <script charset="utf-8" src="<%=basePath%>js/My97DatePicker/WdatePicker.js"></script>
    ...
    <script charset="utf-8"
            src="<%=basePath%>js/kindeditor/plugins/code/prettify.js"></script>
    ...
    <style type="text/css">
        ...
        #updateGoodsDesc {visibility:hidden;}
        #updateGoodsMobileDesc {visibility:hidden;}
...
<script type="text/javascript">
        ...
        {
            editor2 = K.create('textarea[name="update_goods_desc"]',
                {
                    width:"692px",
                    height:"425px",
                    cssPath : '<%=basePath%>js/kindeditor/plugins/code/prettify.css', uploadJson : '<%=basePath%>js/kindeditor/jsp/upload_json.jsp',
                    fileManagerJson : '<%=basePath%>js/kindeditor/jsp/file_manager_json.jsp', allowFileManager : true,
        ...
        KindEditor.ready(function (K)
        {
            editor3 = K.create('textarea[name="update_goods_mobile_desc"]',
                {
                    width:"692px",
                    height:"425px",
                    cssPath : '<%=basePath%>js/kindeditor/plugins/code/prettify.css', uploadJson : '<%=basePath%>js/kindeditor/jsp/upload_json.jsp',
        ...
        KindEditor.ready(function (K)
        {
            editor4 = K.create('textarea[name="update_goodsSpecsification_desc"]',
                {
                    width:"692px",
                    height:"425px",
                    cssPath : '<%=basePath%>js/kindeditor/plugins/code/prettify.css', uploadJson : '<%=basePath%>js/kindeditor/jsp/upload_json.jsp',
        ...
        KindEditor.ready(function (K)
        {
            editor5 = K.create('textarea[name="update_goodsWarp_desc"]',
                {
                    width:"692px",
                    height:"425px",
                    cssPath : '<%=basePath%>js/kindeditor/plugins/code/prettify.css', uploadJson : '<%=basePath%>js/kindeditor/jsp/upload_json.jsp',
        ...
        KindEditor.ready(function (K)
        {
            editor6 = K.create('textarea[name="update_goodsBrand_desc"]',
                {
                    width:"692px",
                    height:"425px",
                    cssPath : '<%=basePath%>js/kindeditor/plugins/code/prettify.css', uploadJson : '<%=basePath%>js/kindeditor/jsp/upload_json.jsp',
        ...
        <div class="col-lg-20 col-md-19 col-sm-18 main">
            ...
            <div class="main_cont">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td id="spec_info${product.goodsInfoId}"  class="spec_info text-danger">
                                                                    <c:forEach items="${product.specVo}" var="specVo">
                                                                        ${specVo.spec.specName}:${specVo.specValueRemark}<br/>
                                                                    </c:forEach>
                                                                </td>
                                                                <td>
                                    ...
                                    <div class="goods_cate_choose">
                                        ...
                                        <div class="cate_choose_area">
                                            ...
                                            <div class="cate_set container-fluid">
                                                ...
                                                <div class="row form-horizontal">
                                                    <table class="table table-bordered table-hover" id="parameter">
                                                        <thead>
                                                        <!-- <tr>
                                                          <th>参数名</th>
                                                          <th>参数值</th>
                ...
                <form class="form-horizontal" id="goodsBaseForm" action="updateGoodsNew.htm?CSRFToken=${token}&pageNo=${pageNo}&pageSize=${pageSize}&goodsId=${goodsMoifiedVo.goodsId}&isThird=0" method="post" enctype="multipart/form-data">
                                ...
                                <div class="add_good_item">
                                    <div class="common_form common_form_lg">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="goodsAdded" class="sellType" value="1" checked> 审核上架
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="goodsAdded" class="sellType" value="0" > 下架
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-5"><span class="text-danger">*</span>销售类型：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <label class="radio-inline">
                                                        <input type="radio" name="sellType" class="sellType" value="0" <c:if test="${goodsMoifiedVo.sellType=='0'}">checked="checked"</c:if> > 零售
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="sellType" class="sellType" value="1" <c:if test="${goodsMoifiedVo.sellType=='1'}">checked="checked"</c:if>> 批发
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input type="text" class="form-control required cash" name="goodsPrice" value="${goodsMoifiedVo.goodsPrice}">
                                                </div>
                                            </div>
                                        </div>
                                      <%--  <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                   ...
                                                   &lt;%&ndash; <input type="text" name="unitPrice" class="form-control sml_input unit_price cash" value="${goodsMoifiedVo.unitPrice}">&ndash;%&gt;
                                                        &lt;%&ndash;<input type="text" name="unitPriceStr" class="form-control sml_input unitPriceStr " value="${goodsMoifiedVo.unitPriceStr}">&ndash;%&gt;
                                                </div>
                                            </div>
                                        </div>--%>
                                        <%--<div class="form-group">--%>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-5">商品认证标识：</label>
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-17">
                                                <c:forEach items="${auths }" var="auth">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="update_goods_auths" class="goods_tag" value="${auth.id}"
                                                        <c:forEach items="${authList}" var="authl">
                                                        <c:if test="${authl.id==auth.id}">
                                                               checked
                                                        </c:if>
                                                        </c:forEach>
                                                        >
                                                        <img src="${auth.authsrc}" height="30px;" style="vertical-align:middle" title=""/>
                                                    </label>
                                                </c:forEach>
                                            </div>
                                        </div>
                    ...
                    <input type="hidden" class="update_goodsSpecsification_desc" name="goodsSpecsificationDesc"  value="">
                    <input type="hidden" class="update_goodsWarp_desc" name="goodsWarpDesc" value="">
                    <input type="hidden" class="update_goodsBrand_desc" name="goodsBrandDesc"value="">
                    <input type="hidden" class="goodsSeoTitle" name="goodsSeoTitle" value="">
                    <input type="hidden" class="goodsSeoKeyword" name="goodsSeoKeyword" value="">
                    <input type="hidden" class="goodsSeoDesc" name="goodsSeoDesc" value="">
                </form>
                    <!-- end -->

                    <div class="panel form-horizontal" id="panel2" style="display:none;">
                        <div class="common_info">
                            <ul class="common_info_tabs">
                                ...
                                <div class="add_good_item">
                                    ...
                                    <div class="common_form common_form_lg">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-18">
                                                <textarea name="update_goods_desc" id="update_goods_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;">${goodsMoifiedVo.goodsDetailDesc}</textarea>
                                            </div>
                                        </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-3">PC版规格详情：</label>
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-18">
                                                    <textarea name="update_goodsSpecsification_desc" id="update_goodsSpecsification_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;">${goodsMoifiedVo.goodsSpecsificationDesc}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-3">PC版包装详情：</label>
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-18">
                                                    <textarea name="update_goodsWarp_desc" id="update_goodsWarp_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;">${goodsMoifiedVo.goodsWarpDesc}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-3">PC版品牌故事：</label>
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-18">
                                                    <textarea name="update_goodsBrand_desc" id="update_goodsBrand_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;">${goodsMoifiedVo.goodsBrandDesc}</textarea>
                                                </div>
                                            </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-1"></div>
                                            <div class="col-sm-18">
                                                <textarea name="update_goods_mobile_desc" id="update_goods_mobile_desc" cols="100" rows="8" style="width: 100%; height: 200px; visibility: hidden;">${goodsMoifiedVo.mobileDesc}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control ogoodsSeoTitle" rows="5" name="goodsSeoTitle">${goodsMoifiedVo.goodsSeoTitle}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control ogoodsSeoKeyword" rows="5" name="goodsSeoKeyword">${goodsMoifiedVo.goodsSeoKeyword}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-1"></div>
                                                <div class="col-sm-12">
                                                    <textarea class="form-control ogoodsSeoDesc" rows="5" name="goodsSeoDesc">${goodsMoifiedVo.goodsSeoDesc}</textarea>
                                                </div>
                                            </div>
                                    ...
                                    <c:forEach items="${goodsMoifiedVo.relaGoodsVo}" var="relGoodsVo">
                                        <c:forEach items="${relGoodsVo.releatedGoods}" var="relGoods">
                                            <tr id="rel_goods_tr${relGoods.goodsId}">
                                                ...
                                                <td>${relGoods.goodsName}<input type="hidden" class="oaboutGoodsId" name="aboutGoodsId" value="${relGoods.goodsId}"/> </td>
