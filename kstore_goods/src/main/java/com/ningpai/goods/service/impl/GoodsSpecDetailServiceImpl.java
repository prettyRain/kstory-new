...
public class GoodsSpecDetailServiceImpl implements GoodsSpecDetailService {
     ...
     */
    @Transactional
    public int updateOtherSpec(GoodsSpecDetail goodsSpecDetail) {
       this.goodsSpecDetailMapper.updateGoodsInfoReleSpecDetailBySpecDetailId(goodsSpecDetail);
       return this.goodsSpecDetailMapper.updateGoodsOpenspecvalue(goodsSpecDetail);
    }
     ...
     */
    @Transactional
    public int delGoodsOpenspecvalue(GoodsSpecDetail goodsSpecDetail) {
        return this.goodsSpecDetailMapper.delGoodsOpenspecvalue(goodsSpecDetail.getSpecDetailId());
    }
