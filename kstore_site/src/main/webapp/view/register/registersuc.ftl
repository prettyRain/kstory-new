...
<head>
    ...
    <style>
        ...
        .p_s_left{width:520px; float:left;}
        body,html{background: #f8f8f8;}
        .pt150{ padding-top: 150px;}
        .p_s_rig{width:520px; float:right; padding-top: 80px;}
        .p_s_rig .title{ font-family: "微软雅黑"; font-size: 30px; font-weight: bold; text-align: center; line-height: 60px; color: #5d5d5b; margin-bottom: 60px;}
        .p_s_rig .btn a{ display: block; width: 220px; height: 60px; background: #ca0928; border-radius:3px; color: #fff; font-family: "微软雅黑"; font-size: 24px; text-align: center; line-height: 60px; float: left; margin-right:40px; }
        .p_s_rig .btn a:hover{ text-decoration: none;}
        .p_s_rig .go_on { color: #666; font-family: "微软雅黑"; font-size: 18px; margin-top: 60px;}
...
<div class="container clearfix pt150">
    ...
    <div class="p_s_rig">
        ...
        <div class="btn clearfix">
            <#--<a href="${basePath}/index.html">立即购物</a>-->
                <p style="font-size: 14px;"><span class="timeleft">10</span>秒后将自动返回注册前页面，或者点击下方按钮立即返回</p>
                <a href="${beforeRegUrl}" class="btn">立即返回</a>
            <a href="javascript:;" onclick="showaDialog('${registerIntegral}','<#if couponId??>${couponId}</#if>')">查看礼包</a>
        </div>
