...
public interface OrderMapper {
     ...
     */
    void saveOrderOldAddress(OrderOldAddress orderOldAddress);
     ...
     * 修改订单地址
     */
    void updateOrderAddressState(Map map);
    ...
    List<Order> queryNoticeOrder();

    List<OrderNotice> queryNoticeOrders(Long orderId);
