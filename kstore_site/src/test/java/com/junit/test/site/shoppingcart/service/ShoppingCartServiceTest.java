...
public class ShoppingCartServiceTest  extends UnitilsJUnit3
{
    ...
    public void testGetNewExpressPrice()
    {
    	...
    	siteOrderServiceMock.returns(map).getEveryparamMap(null,cartIds, 1L, shoppingCart);
        goodsProductServiceMock.returns(goodsDetailBean).queryDetailBeanByProductId(1L,1L);
        ...
        assertEquals(9, shoppingCartService.getNewExpressPrice(null,request, 1L, 1L, cartIds, 0L).size());
    }
...
//    	shoppingCart.setFitId(1L);
    ...
    public void testAddShoppingCart()
    {
    	...
    	try
    	{
        	...
        	assertEquals(0, shoppingCartService.addShoppingCart(shoppingCart, request, new MockHttpServletResponse(),0L));
    	} catch (Exception e)
    	{
			e.printStackTrace();
		}
