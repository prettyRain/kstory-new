    ...
    <div class="content">
        <h1 id="logo">
            <a href="${topmap.systembase.bsetAddress}">
                <img alt="" src="${topmap.systembase.bsetLogo}" height="70px;" width="165px"/>
            </a>
            <div class="logoBanner">
                <a href="${(topmap.logoAdv.adverHref)!'#'}">
                    <img src="${(topmap.logoAdv.adverPath)!'${basePath}/index_eleven/images/ad.jpg'}" style="height:69px;"/>
                </a>
            </div>
        </h1>
                ...
                <div id="scroll_div" class="scroll_div">
					...
					<#if (topmap.infoList)?? && (topmap.infoList?size>0)>
						<#list topmap.infoList as info>
                            <a href="${basePath}/information/${info.infoId}">
							${info.title}。。。
                            </a>
						</#list>
					</#if>
		...
		<#--搜索提示-liangck-20151127-->
            <div class="ex_search pa">
                <ul>
                    ...
                    <#--<li><a href="javascript:;"><span style="display: block;">搜索历史</span>手机壳</a><a class="del_history"
                                                                                                  href="javascript:;"
                                                                                                  style="display: none;">删除</a>
                    </li>
                    <li><a href="javascript:;"><span style="display: block;">搜索历史</span>手机卡</a><a class="del_history"
                                                                                                  href="javascript:;"
                                                                                                  style="display: none;">删除</a>
                    </li>-->
                </ul>
				...
				<#if (topmap.navList)?? && (topmap.navList?size>0)>
					<#list topmap.navList as nav>
						<#if (nav.barName=="首页") || (nav.barUrl=="index.html")>
                            <li><a class="navLink on" onclick="clickNav('${(nav.barUrl)!''}','${nav_index+1}');"
                                   href="javascript:;">${(nav.barName)!''}</a></li>
						<#else>
							<#if (nav.openChannel)?? && (nav.openChannel=='0')>
                                <li><a class="navLink" onclick="clickNav('${(nav.barUrl)!''}','${nav_index+1}')"
                                       href="javascript:;">${(nav.barName)!''}</a></li>
							<#else>
                                <li><a class="navLink"
								...
								<#elseif bcate.cateId??>
                                    {
                                        ...
                                        "mhref": "${basePath}/list/${bcate.cateId?c}-${bcate.cateId?c}.html"
                                    }
								</#if>
