 ...
 <style>
     ...
     .ex_search {
         background: #fff;
         border: 1px solid #459d36 !important;
         border-top: none;
         position: absolute;
         top: 38px;
         width: 338px;
 ...
 <div class="section-header" style="background:url('${basePath}/index_twelve/images/cw.jpg') no-repeat top center #459d36;">
        <div class="content">
            <h1 id="logo"><a href="${topmap.systembase.bsetAddress}"><img alt="" src="${topmap.systembase.bsetLogo}" style="height:70px;width:165px;"/></a>
                <div class="logoBanner"><a href="${(topmap.logoAdv.adverHref)!'#'}"><img src="${(topmap.logoAdv.adverPath)!'${basePath}/index_twelve/images/ad.jpg'}" style="height:40px;width:165px;"/></a></div>
            </h1>
