...
(function($, window) {
    ...
    window.addEventListener($.EVENT_START, handleTouchEvent,{passive:false});
    window.addEventListener($.EVENT_MOVE, handleTouchEvent,{passive:false});
    window.addEventListener($.EVENT_END, handleTouchEvent,{passive:false});
    window.addEventListener($.EVENT_CANCEL, handleTouchEvent,{passive:false});
