...
public interface BackOrderMapper {
     ...
     * @return
     */
    OrderGoods selectBackOrderGoods(Map map);
     ...
     * @return int
     */
    int queryReportBackOrderByBusinessIdCount(Map<String, Object> paramMap);
     ...
     * @return 返回实际的退款金额
     */
    int queryActualBackPrice(Long orderId);
     ...
     * @return
     */
    int selectBackOrderRecodCount(String orderCode);
     ...
     * @return
     */
    BackOrder selectBackOrder(String orderCode);
     ...
     * @return
     */
    BackOrder selectBackOrderByOrderCode(String orderCode);

    /**
     * 查询需要推送的退货单、退款单
     * @return
     */
    List querySynBackOrder();
     ...
     * @return
     */
    int synBackOrderSuccess(String orderCode);
}
