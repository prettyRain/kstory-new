...
public class GoodsProductServiceTest extends UnitilsJUnit3 {
    ...
    public void testBatchUploadProduct(){
        ...
        assertEquals(1,goodsProductService.batchUploadProduct("1",new Long[]{1L},1,3));
    }
    ...
    public void testSelectByPrimaryKey(){
        ...
        goodsProductMapperMock.returns(goodsProductVo).selectByPrimaryKey(1L);
        assertNotNull(goodsProductService.selectByPrimaryKey(1L));
    }
