...
public class GoodsServiceImpl implements GoodsService {
    ...
    public Map<String, Object> thirdGoodsListEs(SearchPageBean<EsGoodsInfo> pb, ThirdGoodsSearchBean searchBean, Long distinctId, Long thirdId, String isThird) {
        ...
        String[] catIds = {searchBean.getCateId()+""};

        if (0 == searchBean.getCateId())
        {
            catIds = null;
        }
    ...
    @Override
    public Long  getPrductCommentCount(Long productId) {
        return this.goodsMapper.getPrductCommentCount(productId);
    }
