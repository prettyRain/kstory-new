...
public interface GoodsProductMapper {
    ...
    void updateProductAddedWithGoodsIdUp(Map<String, String> upProMap);
    // 根据商品ID删除货品对应的图片
    void deleteProductImageByGoodsId(Map<String, String> map);
    //根据货品ID删除
    void deleteGoodsImageByInfoId(Map<String, String> map);
}
