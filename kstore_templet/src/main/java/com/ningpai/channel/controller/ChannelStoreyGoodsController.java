...
public class ChannelStoreyGoodsController {
    ...
    public ModelAndView queryChannelStoreyGoodsByPageBean(PageBean pb, Long storeyId) {
        ...
        /* 设置查询参数，获取查询后的pb */
        return new ModelAndView("jsp/channel/channel_storey_goods_list", "pb", channelStoreyGoodsService.selectchannelStoreyGoodsByParam(pb, storeyId, null, null,null,null)).addObject(
    ...
    @ResponseBody
    public Map<String, Object> queryChannelStoreyGoodsByPageBeanAjax(PageBean pb, Long storeyId, Long storeyTagId,Long navId) {
        // 设置map容器
        Map<String, Object> map = new HashMap<String, Object>();
        // 设置楼层商品
        map.put(CHANNELSTOREY, this.channelStoreyService.getChannelStoreyById(storeyId));
        /* 设置查询参数，获取查询后的pb */
        map.put("pb", channelStoreyGoodsService.selectchannelStoreyGoodsByParam(pb, storeyId, storeyTagId, null,navId,null));
        // 返回集合
        return map;
    }
