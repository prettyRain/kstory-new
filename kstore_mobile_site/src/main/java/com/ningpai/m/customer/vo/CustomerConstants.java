...
public final class CustomerConstants {
    ...
    public static final String REGISTERSECOND = "register/registersecond";
    public static final String REGISTERTHIRD = "register/registerthird";
     ...
     * 地址列表页面
     */
    public static final String FORGETPASSWORDSECOND = "login/forgetpassword2";
    /**
     * 地址列表页面
     */
    public static final String FORGETPASSWORDTHIRE = "login/forgetpassword3";
    /**
     * 账号安全页面
     */
     ...
     * 修改邮箱页面
     */
    public static final String CHANGEEMAIL = "member/mailbox";
