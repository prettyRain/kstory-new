...
<script type="text/javascript">
	...
	function addToFavorite(){
		try {   
			window.external.AddFavorite('${basePath}/npstore_H_web/',"960");
	    } catch (e) {   
	        try {   
	            window.sidebar.addPanel('${basePath}/npstore_H_web/', "960", "");
	        } catch (e) {   
	...
	<div class="body_top">
		<div class="top_wp clearfix">
			<div class="top_left fl">
				<a class="collect_me mr10" href="javascript:;" onclick="addToFavorite()">收藏960</a>
				<input type="hidden" id="basePath" value="${basePath}"/> 
				<span class="t_line">|</span> 
				<span class="ml10">您好 <#if cust??>${cust.customerNickname!''}</#if>，欢迎来到960！</span>
				<#if cust?? >
			...
			<ul class="top_nav fr clearfix">
				...
				<li class="my_hao24 pr"><span class="t_line">|</span> <span class="outline"></span> <a href="javascript:;">我的960</a>
