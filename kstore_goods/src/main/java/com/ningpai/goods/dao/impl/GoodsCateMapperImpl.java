...
public class GoodsCateMapperImpl extends BasicSqlSupport implements
    ...
    @Override
    public int updateClassifybarCateByCateId(Map<String,Object> map) {
        return this.update("com.ningpai.goods.dao.GoodsCateMapper.updateClassifybarCateByCateId",
                map);
    }
    @Override
    public int updateClassifybarByCateId(Map<String,Object> map) {
        return this
                .update("com.ningpai.goods.dao.GoodsCateMapper.updateClassifybarByCateId",
                        map);
    }
