...
public class AliPay extends AbstractPayStrategy{
    ...
    public String pay() {
        ...
        String notifyUrl = pay.getPayUrl().substring(0,pay.getPayUrl().indexOf("com/")+3) + "/deposit/alipaycallback.htm";
        String paymentType = "1";
        String returnUrl = pay.getPayUrl().substring(0,pay.getPayUrl().indexOf("com/")+3) +"/deposit/synalipayresult.htm";
