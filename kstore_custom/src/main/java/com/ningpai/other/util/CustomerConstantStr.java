...
public final class CustomerConstantStr {
    ...
    public static final String GOENTERPAGESUCCEED = "/register/register_succeed";
    /**
     * initPointLevel.htm
     */
    ...
    public static final String INITGIFTCARDINFOLIST = "initGiftcardInfoList.htm";
    public static final String GIFTCARDINFOJSP = "jsp/customer/giftcardInfoList";
    /**
     * 会员资金列表页面
     */
