...
<input type="hidden" id="orderSum" value="${order.orderPrice?string("0.00")}" />
    ...
    <div class="container clearfix pt20 pb10" style="position: relative;">
        ...
        <div class="payment-box" >
            ...
            <#--如果订单货品中包含礼品卡商品则不能使用礼品卡账户进行支付-->
                <#if (dianziCard == 0)>
                    <h3 style="margin-bottom: 10px;margin-left: 40px;font-size: 16px;font-weight: normal;    color: #333333;"><input type="checkbox" id="isGiftCardPay" style="zoom: 150%;margin-right: 4px;" value="0" name="isgiftcard">使用商城礼品卡进行抵扣</h3>
                    ...
                    <div class="box for-pre-deposit">
                        <div class="alert-box" >
                            ...
                            <div id="payInput" style="display: none;">
                                <p class="h4"></p>
                                <div class="charge-form" style="margin-left: 55px;">
                                    请输入支付密码：
                                    <!--
                                    ...
                                    <a id="passhref" href="${basePath}/deposit/changepaypasswordview.htm" target="_blank" style="color:#0d9901;">忘记密码？</a>
                                </div>
                                <p class="error"></p>
                            </div>

                            <p class="error" id="errorMsg"  style="margin-left: 153px;width: 100%;"></p>
                        </div>
