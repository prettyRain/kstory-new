...
public class IndexSiteServiceTest extends UnitilsJUnit3
{
    ...
    public void testGetClassifyBar()
    {
    	...
    	channelAdverServiceMock.returns(boxAdverList).selectchannelAdverByParamForSite(null, 1L, null, null, 161L, 151L, null, "1", null, null,null);
    	...
    	channelAdverServiceMock.returns(adverList).selectchannelAdverByParamForSite(null, null, null, null, 161L, 151L, "1", null, null, null,null);
    ...
    public void testGetStoreys()
    {
    	...
    	channelAdverServiceMock.returns(adverList).selectchannelAdverByParamForSite(null, null, null, null, 161L, 151L, null, "0", null, null,null);
