...
import com.ningpai.m.goods.bean.GoodsBrand;
...
public class GoodsCateServiceImpl implements GoodsCateService {
    ...
    public List<Object> queryBranndByCateId(Long cid)
    {
        return this.goodsBrandMapper.queryBranndByCateId(cid);
    }

    //根据分类ID 查分类集合 xcy
    public List<GoodsCateVo> queryCatesByCateIds(Map cateIdsMap){
        return this.goodsCateMapper.queryCatesByCateIds(cateIdsMap);
    };
