            ...
            <div class="new_order_list">
                ...
                <div class="tagMenu order-menu">
                    <ul class="ods_tabs menu clearfix">
                        <li<#if (!type?? || type == '5') > class="current" </#if> data-val="5"><a href="${basePath}/customer/myorder.html"  onclick="_czc.push(['_trackEvent', '我的订单', '查看', '所有订单',  'all_orders']);" id="all_orders">所有订单</a></li>
                        <li<#if (type?? && type == '0')> class="current"</#if> data-val="0"><a href="javascript:;"  onclick="_czc.push(['_trackEvent', '我的订单', '查看', '待处理订单',  'pending_orders']);" id="pending_orders">待处理订单</a></li>
                        <li<#if (type?? && type == '3')> class="current"</#if> data-val="3"><a href="javascript:;"  onclick="_czc.push(['_trackEvent', '我的订单', '查看', '已完成订单',  'completed_orders']);" id="completed_orders">已完成订单</a></li>
                        <li<#if (type?? && type == '4')> class="current"</#if> data-val="4"><a href="javascript:;"  onclick="_czc.push(['_trackEvent', '我的订单', '查看', '已取消订单',  'cancelled_orders']);" id="cancelled_orders">已取消订单</a></li>
                        <li <#if (type?? && type == '6')>class="current"</#if> data-val="6"><a href="javascript:;"  onclick="_czc.push(['_trackEvent', '我的订单', '查看', '退货订单',  'return_of_the_orders']);" id="return_of_the_orders">退货订单</a></li>
                    </ul>
                </div>
                <div class="simple mt10 clearfix">
                <#if (!type?? || type != '6')>
                    <div class="filter_l fl">
                        <select class="select s1 ss" style="cursor: pointer;">
                        ...
                        <#if pb.list??&&(pb.list?size!=0)>
                            <#list pb.list as backorder>
                                ...
                                <tr class="order-bd">
                                    <td class="baobei">
                                        <#list backorder.orderGoodslistVo as good>
                                            <div style="height:110px;">
                                                ...
                                                <div class="desc ml20">
                                                    <a target="_blank" href="${basePath}/item/${good.goodsInfoId}.html" class="name"><#if good.isPresent?? && good.isPresent=="1"><span style="color: white;background-color: lightgrey;">&nbsp;赠品&nbsp;</span>&nbsp;</#if>${good.goodsInfoName!''}</a>
                                                    <p class="col9">
                                    ...
                                    <td>
                                        <#if backorder.orderCode?? && (backorder.orderCode)?length gt 15>
                                            ${backorder.orderCode[0..15]}
                                        <#else>
                                            ${backorder.orderCode}
                                        </#if>
                                    </td>
                                    ...
                                    <span class="red fb f14">
                                        <#if backorder.backCheck == '4' || backorder.backCheck == '10'>
                                                    ...
                                                    <#--订单商品状态为3退货成功、5退款成功-->
                                                        ...
                                                        <#if order.orderStatus??>
                                                            <div style="height:110px;">
                                                                ...
                                                                <div class="desc ml20">
                                                                    <a href="${basePath}/item/${good.goodsId}.html" class="name"><#if good.isPresent?? && good.isPresent=="1"><span style="color: white;background-color: lightgrey;">&nbsp;赠品&nbsp;</span>&nbsp;</#if>${good.goodsName!''}</a>
                                                                    <p class="col9">
                                                                        <#list good.specVo as specVo>
                                                                        ${specVo.spec.specName}:<#if specVo.specValueRemark??>${specVo.specValueRemark}<#else>${specVo.goodsSpecDetail.specDetailName!''} </#if>&nbsp;
                                                                        </#list>
...
<div class="member-dialog dia4" style="display: none">
    <div class="member-dialog-body">
        <div class="title"><a href="javascript:;" onclick="cls()">×</a></div>
        <div class="tc">
            <img src="${basePath}/images/btn_tips@2x.png" alt="" style="width: 45px;height: 45px;margin: 0 auto; margin-top:13px;display: block;">
            <div class="que-delete clearfix">
                <div class="fl tl">
                    <p class=" againbuytip new_p" style="padding-left: 10px;"></p>
                    <div class="m-btn">
                        <a href="javascript:cls();">取消</a>
                        <a  id="againbuyconfirm" href="javascript:;" class="bnt_ok">确定</a>
