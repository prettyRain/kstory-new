...
<div class="section_headerTop" style="background-color: #fff;border:none">
    ...
    <div class="slot slot_headerTop01">
            ...
            <div class="topmenu" id="3">
                ...
                <div id="menucontent3" class="toplinkmenu toplinkmenu2">
                    ...
                    <div style="padding-left: 25px;">
                        <a href="${basePath}/subject/85">茶馆</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/channel/247.html?navId=309">960大聚惠</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/marketingrushlist-1.html">狩猎时刻</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/channel/247.html?navId=313">展览馆</a> &nbsp;&nbsp;&nbsp;
                    </div>
                    <div><img src="${basePath}/index_960/images/sp.png" style="vertical-align: middle;"> <a href="${basePath}/channel/237.html" style="font-weight: bold;">食品荟萃</a></div>
                    <div style="padding-left: 25px;">
                        <a href="${basePath}/subject/85">茶馆</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/channel/237.html?navId=273">老字号</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/channel/237.html?navId=275">菌临天下</a> &nbsp;&nbsp;&nbsp;
                    </div>
                    <div><img src="${basePath}/index_960/images/yd.png" style="vertical-align: middle;"> <a href="${basePath}/channel/239.html" style="font-weight: bold;">饮品总汇</a></div>
                    <div style="padding-left: 25px;">
                        <a href="${basePath}/channel/239.html?navId=277">生命之源</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/channel/239.html?navId=279">红酒庄园</a> &nbsp;&nbsp;&nbsp;
                        <a href="${basePath}/channel/239.html?navId=281">国际名酒廊</a> &nbsp;&nbsp;&nbsp;
                    </div>
                    <div><img src="${basePath}/index_960/images/jd.png" style="vertical-align: middle;"> <a href="${basePath}/channel/241.html" style="font-weight: bold;">购物中心 </a></div>
                    <div style="padding-left: 25px;">
                    </div>
                    <div><img src="${basePath}/index_960/images/dd.png" style="vertical-align: middle;"> <a href="${basePath}/channel/243.html" style="font-weight: bold;">大药房 </a></div>
                    <div style="padding-left: 25px;">
                    </div>
                </div>
            </div>
        ...
        <#--<p>网站导航</p>-->
        <#--<div id="menucontent3" class="toplinkmenu toplinkmenu2">-->
        <#--<div><img src="${basePath}/index_960/images/sy.png" style="vertical-align: middle;"> <a href="${basePath}/" style="font-weight: bold;">首页</a></div>-->
        <#--<div style="padding-left: 25px;">-->
        <#--<a href="${basePath}/subject/85">茶馆</a> &nbsp;&nbsp;&nbsp;-->
        <#--<a href="${basePath}/channel/247.html?navId=309">960大聚惠</a> &nbsp;&nbsp;&nbsp;-->
        <#--<a href="${basePath}/marketingrushlist-1.html">狩猎时刻</a> &nbsp;&nbsp;&nbsp;-->
        ...
        <#--<a href="${basePath}/subject/85">茶馆</a> &nbsp;&nbsp;&nbsp;-->
        <#--<a href="${basePath}/channel/237.html?navId=273">老字号</a> &nbsp;&nbsp;&nbsp;-->
        <#--<a href="http://www.ge960.com:80/zhuanti.jsp?id=33">菌临天下</a> &nbsp;&nbsp;&nbsp;-->
        <#--</div>-->
        <#--<div><img src="${basePath}/index_960/images/yd.png" style="vertical-align: middle;"> <a href="#" style="font-weight: bold;">饮品总汇</a></div>-->
        <#--<div style="padding-left: 25px;">-->
        <#--<a href="http://www.ge960.com:80/zhuanti.jsp?id=28">生命之源</a> &nbsp;&nbsp;&nbsp;-->
        <#--<a href="http://www.ge960.com:80/zhuanti.jsp?id=28">红酒庄园</a> &nbsp;&nbsp;&nbsp;-->
        <#--<a href="http://www.ge960.com:80/zhuanti.jsp?id=30">国际名酒廊</a> &nbsp;&nbsp;&nbsp;-->
        <#--</div>-->
...
<#--<div class="navLinks">-->
<#--<ul>-->
<#--<li><a class="navLink" onclick="clickNav('${basePath}/subject/75','1')"  href="javascript:;">茶       馆</a></li>-->
<#--<li><a class="navLink" onclick="clickNav('${basePath}/subject/77','2')"  href="javascript:;">960大聚惠</a></li>-->
<#--<li><a class="navLink" onclick="clickNav('${basePath}/subject/79','3')"  href="javascript:;">狩猎时刻</a></li>-->
<#--<li><a class="navLink" onclick="clickNav('${basePath}/subject/81','4')"  href="javascript:;">展览馆</a></li>-->
<#--</ul>-->
<#--</div>-->
<#--<div class="showlist">-->
...
<div id="sectionHeader" class="section-header">
    ...
    <div class="mainnav">
        <div class="tm-content" style="height: 48px;">
            <div class="navLinks">
                <ul>
                    <li><a class="navLink" onclick="clickNav('http://www.ge960.com/subject/85','1')"  href="javascript:;">茶&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;馆</a></li>
                    <li><a class="navLink" onclick="clickNav('http://www.ge960.com/channel/247.html?navId=309','2')"  href="javascript:;">960大聚惠</a></li>
                    <li><a class="navLink" onclick="clickNav('http://www.ge960.com/marketingrushlist-1.html','3')"  href="javascript:;">狩猎时刻</a></li>
                    <li><a class="navLink" onclick="clickNav('http://www.ge960.com/channel/247.html?navId=313','4')"  href="javascript:;">展 览 馆</a></li>
                </ul>
            </div>
            ...
            <#--<div class="shopcarright_list headMiniShopcart">-->
            <#--<div class="form cart-goods">-->

            <#--</div>-->

            <#--&lt;#&ndash;<div class="li_btn" style="text-align: left;">&ndash;&gt;-->
            <#--&lt;#&ndash;<p style="float:left;padding-left:5px;">&ndash;&gt;-->
            <#--&lt;#&ndash;<span>共 <i class="li_g mcNumTotal">1</i> 件商品</span>&nbsp;&nbsp;&ndash;&gt;-->
            <#--&lt;#&ndash;<span>共计：<font style="font-weight: bold; color: #ff4e01;">¥<b class="li_m mcTotalFee">0.00</b></font></span>&nbsp;&nbsp;&ndash;&gt;-->
            <#--&lt;#&ndash;</p>&ndash;&gt;-->
            <#--&lt;#&ndash;<a style="color:#fff;" href="/myshoppingcart.html" class="login submit_btn1">去购物车</a>&ndash;&gt;-->
            <#--&lt;#&ndash;</div>&ndash;&gt;-->
            <#--</div>-->
            </div>
        <#--购物车-->
        <#--<div class="n_head" style="background-color: #555;padding: 0;">-->
        <#--<div class="container clearfix pr">-->
        <#--&lt;#&ndash;<div class="n_logo fl clearfix">&ndash;&gt;-->
        <#--&lt;#&ndash;&lt;#&ndash;<h1 class="ml10 fl"><a href="${topmap.systembase.bsetAddress}"><img src="${topmap.systembase.bsetLogo}"/></a></h1>&ndash;&gt;&ndash;&gt;-->
        <#--&lt;#&ndash;<div class="fl ml20">&ndash;&gt;-->
        <#--&lt;#&ndash;<a href="${basePath}/customer/index.html" class="fore1">我的${topmap.systembase.bsetName}</a>&ndash;&gt;-->
        <#--&lt;#&ndash;<a href="${basePath}/index.html" class="fore2">返回首页</a>&ndash;&gt;-->
        <#--&lt;#&ndash;</div>&ndash;&gt;-->
        <#--&lt;#&ndash;</div>&ndash;&gt;-->
        <#--&lt;#&ndash;<div class="n_menu fl">&ndash;&gt;-->
        <#--&lt;#&ndash;<ul class="clearfix">&ndash;&gt;-->
        <#--&lt;#&ndash;<li><a href="${basePath}/customer/index.html">首页</a></li>&ndash;&gt;-->
        <#--&lt;#&ndash;<li class="n_hover">&ndash;&gt;-->
        <#--&lt;#&ndash;<div class="pr">&ndash;&gt;-->
        <#--&lt;#&ndash;<a href="#">账户中心</a>&ndash;&gt;-->
        <#--&lt;#&ndash;<div class="n_menu_hide">&ndash;&gt;-->
        <#--&lt;#&ndash;<a href="${basePath}/customer/myinfo.html">账户信息</a>&ndash;&gt;-->
        <#--&lt;#&ndash;<a href="${basePath}/customer/securitycenter.html">账户安全</a>&ndash;&gt;-->
        <#--&lt;#&ndash;<a href="${basePath}/customer/address.html">收货地址</a>&ndash;&gt;-->
        <#--&lt;#&ndash;</div>&ndash;&gt;-->
        <#--&lt;#&ndash;</div></li>&ndash;&gt;-->
        <#--&lt;#&ndash;<li><a href="${basePath}/customer/insideletter.html">消息中心</a></li>&ndash;&gt;-->
        <#--&lt;#&ndash;</ul>&ndash;&gt;-->
        <#--&lt;#&ndash;</div><!--n_menu&ndash;&gt;&ndash;&gt;-->
        <#--<div class="cartfd-mem"><s class="cartBanner-mem"></s>-->
        <#--<div class="cartit-mem">-->

        <#--<span><a href="${basePath}/myshoppingcart.html"><img id="shopcartid" class="searchbuttonarea_gw" src="${basePath}/index_960/images/index2_08.png"></a></span>-->
        <#--&lt;#&ndash;<strong class="cartNum-mem" style="color:#35a400">0</strong></div>&ndash;&gt;-->
        ...
        <#--</span>-->
        <#--<span style="background-color: #35a400" class="mcGo-mem"><a href="/myshoppingcart.html">结算</a></span>-->
        <#--</span>-->
        <#--<h3>-->
        ...
        <#--</div>-->
            ...
            <div class="n_head" style="background-color: #666666">
                <div class="container pr">
                <#--<div class="n_logo fl clearfix">-->
                <#--&lt;#&ndash;<h1 class="ml10 fl"><a href="${topmap.systembase.bsetAddress}"><img src="${topmap.systembase.bsetLogo}"/></a></h1>&ndash;&gt;-->
                <#--<div class="fl ml20">-->
                ...
                <#--</div><!--n_menu&ndash;&gt;-->
                    <div class="cartfd-mem"><s class="cartBanner-mem"></s>
                        <div class="cartit-mem" style="margin-left: 18px;margin-bottom: 10px;">
                            <span><a href="javascript:;">
                                <img id="shopcartid" class="searchbuttonarea_gw" src="${basePath}/index_960/images/index2_08.png" style="cursor: pointer;">
                            </a></span>
                            <strong class="cartNum-mem" style="color:#35a400;display:none">0</strong></div>
                        <div class="miniCart-mem hide" style="top: 48px;">
                            <div class="mCartBox-mem">
                                <div class="mcBoxTop-mem clearfix"></div>
                                <div class="mcBoxList-mem"></div>
                                <div class="emCartBox-mem hide" style="display: block;">
        ...
        <#--购物车结束-->
            ...
            <script type="text/javascript" language="JavaScript" src="${basePath}/index_960/js/app.js"></script>
            <div class="showlist">
...
<#--<div class="rightbar_list2"><a href="${basePath}/channel/239.html">饮品总汇</a></div>-->
<#--<div class="rightbar_list3"><a href="${basePath}/channel/241.html">购物中心</a></div>-->
<#--<div class="rightbar_list4"><a href="${basePath}/channel/243.html">大药房</a></div>-->
...
<#--</p>-->
<#--<a style="color:#fff;" href="/myshoppingcart.html" class="login submit_btn1">去购物车</a>-->
<#--</div>-->
<#--</div>-->
<#--</div>-->
<#--</div>-->
