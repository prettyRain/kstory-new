...
public class ReceivablesController {
    ...
    public ModelAndView receivablesList(HttpServletRequest request,PageBean pageBean,String searchText,String condition,String status,String startTimeName,String endTimeName){
        ...
        return new ModelAndView(ReceivablesUtil.RECEIVABLESLIST,"pageBean",receivablesService.searchReceivables(pageBean, searchText, conditionNew,statusNew,startTimeName,endTimeName)).addObject("token",token).addObject("status",statusNew).addObject("searchText",searchText).addObject("condition",conditionNew).addObject("startTime",startTimeName).addObject("endTime",endTimeName);
    }
