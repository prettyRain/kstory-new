...
public class ReceivablesServiceImpl implements ReceivablesService {
    ...
    public PageBean searchReceivables(PageBean pageBean, String searchText,
            String condition, String status,String startTime,String endTime) {
    ...
    public void deleteByCode(String orderCode) {
        this.receivablesMapper.deleteByCode(orderCode);
    }

    @Override
    public List<Receivables> getAllByOrderCode(Map<String, String> map) {
        return this.receivablesMapper.getAllByOrderCode(map);
    }
}
