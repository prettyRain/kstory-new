...
<script>
    ...
    var checkDecimals=function(n){
        var decimalReg=/^([0-9]{1,2}(\.\d{0,2})?)$/;//test
        //var decimalReg=/^([1-9]{1,2}(\.\d{0,2})?)$/;//修改后的
        //var decimalReg=/^([0-9]{1,2}(\.[0-9]{0,2})?|0\.[1-9]{0,2})$/;//var decimalReg=/^[-\+]?\d{0,8}\.{0,1}(\d{1,2})?$/;
        if(n.value!=""&&decimalReg.test(n.value)) {
            ...
            if(n.value!=""){
                if (n.value.length ==1) {
                    n.value="";
                    $("#consumptionErr").text("请输入正确的积分金额");
                }else {
                    n.value=record.num;
                    $("#consumptionErr").text("");
                }
                        ...
                        <form class="form-horizontal" id="editPointForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" maxlength="8" value="${pointset.psetLogin}" id="psetLogin" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" maxlength="8" value="${pointset.psetEmail}" id="psetEmail" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            <%--<div class="form-group">--%>
                                ...
                                <%--<div class="col-sm-14 form_item">--%>
                                    ...
                                    <%--<div class="form_fill">--%>
                                        <%--<input type="text" class="form-control w100" maxlength="8" value="${pointset.psetPhone}" id="psetPhone" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">--%>
                                    <%--</div>--%>
                                <%--</div>--%>
                                <%--<div class="col-sm-3"></div>--%>
                            <%--</div>--%>
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" maxlength="8" value="${pointset.psetComment}" id="psetComment" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" maxlength="8" value="${pointset.psetUser}" id="psetUser" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-14 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" maxlength="8" value="${pointset.psetOnline}" id="psetOnline" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')">
                                    </div>
                                </div>
                                <div class="col-sm-3"></div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-6">积分获取规则：</label>
                                <label class="control-label col-sm-9" style="text-align: left;margin-left:24px;">每消费1元，可获得积分</label>
                                <div class="col-sm-1"></div>
                                <div class="col-sm-7 form_item">
                                    <span class="form_value orderPresent" attr_id="exchange">1<%--${pointset.exchange}--%>&nbsp;</span>
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" maxlength="8" value="${pointset.exchange}" id="exchange" clazz="required digits" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" >
                                    </div>
                                </div>
                                <div class="col-sm-1"></div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-6">积分使用规则：</label>
                                ...
                                <div class="col-sm-7 form_item">
                                    ...
                                    <div class="form_fill">
                                        <input type="text" class="form-control w100" value="${pointset.consumption}" id="consumption" onkeyup="checkDecimals(this)" onafterpaste="checkDecimals(this)">
                                        <span style="color: #a94442;" id="consumptionErr"></span>
                                    </div>
                                </div>
                                <div class="col-sm-1"></div>
                            </div>
