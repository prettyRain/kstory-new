...
public class CustomerMapperImpl extends BasicSqlSupport implements
    ...
    /**
     * 根据用户输入的账号名称查询用户信息
     * @param customerUsername 根据用户输入的账号名称
     * @return 用户信息
     */
    @Override
    public Customer getCustomerByInput(String customerUsername) {
        return this
                .selectOne(
                        "com.ningpai.customer.dao.CustomerMapper.getCustomerByInput",
                        customerUsername);
    }
...
//                    .selectOne("com.ningpai.customer.dao.CustomerMapper.selectLastId");
            ...
            //用户编号
            String userCode = customerinfo.getCustomerId().toString();
            //生成盐值
            String saltVal = SecurityUtil.getNewPsw();
            //生成加密后的登陆密码
            String pwd = SecurityUtil.getStoreLogpwd(userCode, customerinfo.getCustomerPassword(), saltVal);
            //设置用户的相关信息
            customerinfo.setUniqueCode(userCode);
            customerinfo.setSaltVal(saltVal);
            customerinfo.setCustomerPassword(pwd);
            //更新用户密码,usercode,salt值
            this.update("com.ningpai.customer.dao.CustomerMapper.updatePwdInfo",customerinfo);
...
//            customerinfo.setCustomerId(customerinfo.getCustomerId());
     ...
     * 按条件查询会员
     *
     * @param customerAllInfo {@link com.ningpai.customer.bean.CustomerAllInfo}
     * @return
     */
    @Override
     ...
     * 查询所有区县
     *
     * @param 城市编号 java.lang.Long {@link java.lang.Long}
     * @return
     */
     ...
     * 修改登录时间 IP
     *
     * @param {@link com.ningpai.customer.bean.Customer}
     * @return 0失败 1成功
     */
    @Override
     ...
     * 禁用用户
     *
     * @param custId 用户编号 flag :disable禁用 否则启用
     * @return 0 失败 1成功
     */
    @Override
     ...
     * 根据输入的用户名查询用户
     *
     * @param customerUsername 用户名{@link java.lang.String}
     * @return List
     */
    @Override
    ...
    @Override
    public List<String> queryAllCustomerIp() {
        return this.selectList("com.ningpai.customer.dao.CustomerMapper.queryAllCustomerIp");
    }
     ...
     */
    @Override
    public List<CustomerAllInfo> queryListForExportByCustomerIds(Map<String,Object> param) {
        return this
                .selectList("com.ningpai.customer.dao.CustomerMapper.queryListForExportByCustomerIds"
                        ,param);
    }
    ...
    public Customer selectCustomerByCustNameAndType(Map<String, Object> paramMap) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.selectCustomerByCustNameAndType", paramMap);
    }

    /**
     * 根据会员ID查询登录信息:username,password,salt,uniqueCode,用于密码验证
     *
     * @param costomerId 会员ID
     * @return {@link Customer}
     */
    @Override
    public Customer queryLoginInfoByCustomerId(Long costomerId) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.queryLoginInfoByCustomerId", costomerId);
    }
    ...
    public int updatePwdInfo(Customer customer) {
        return this.update("com.ningpai.customer.dao.CustomerMapper.updatePwdInfo", customer);
    }

    @Override
    public Customer getCustomerByUsernameMap(Map<String, String> param) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.selectCustomerByCustNameMap", param);
    }
    ...
    public int selectCustCount(Long customerId) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.selectCustCount",customerId);
    }
    ...
    public StreetBean queryStreetBeanById(String streetId) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.queryStreetBeanById", streetId);
    }
    ...
    public List<Customer> queryCustomerForPoint() {
        return this.selectList("com.ningpai.customer.dao.CustomerMapper.queryCustomerForPoint");
    }
    ...
    public int updateCustomerPointId(Customer customer) {
        return this.update("com.ningpai.customer.dao.CustomerMapper.updateCustomerPointId",customer);
    }

    @Override
    public int auditImg(Map<String, Object> paramMap) {
        return this.update("com.ningpai.customer.dao.CustomerMapper.auditImg",paramMap);
    }

    @Override
    public List<Object> queryAuditImg(Map<String, Integer> paramMap) {
        return this
                .selectList(
                        "com.ningpai.customer.dao.CustomerMapper.queryAuditImg",
                        paramMap);
    }

    @Override
    public int selectAuditImgCount() {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.selectAuditImgCount");
    }

    @Override
    public void addAvatarNatice(AvatarNotice avatarNotice) {
        this.insert("com.ningpai.customer.dao.CustomerMapper.addAvatarNatice",avatarNotice);
    }

    @Override
    public List<Integer> selectCustomerAllID(Map<String, Object> map) {
        return this
                .selectList(
                        "com.ningpai.customer.dao.CustomerMapper.selectCustomerAllID",
                        map);
    }

    @Override
    public int countCustomerAllID(Map<String, Object> map) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.countCustomerAllID",map);
    }

    @Override
    public List<CustomerAllInfo> selectAllCustmerinfo(Map map) {
        return this
                .selectList("com.ningpai.customer.dao.CustomerMapper.selectAllCustmerinfo",map);
    }

    @Override
    public Long getProvinceIdByName(String name) {
        return this.selectOne("com.ningpai.customer.dao.CustomerMapper.getProvinceIdByName",name);
    }
}
