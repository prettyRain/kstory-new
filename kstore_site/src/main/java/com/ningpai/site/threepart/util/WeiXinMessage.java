...
public final class WeiXinMessage {
    ...
    public static Map<String, String> getWeiXinMessage(String accessToken, String openid) throws IOException {
        ...
        try {
            ...
            String nickname = new String(jsonData.getString("nickname").getBytes("ISO-8859-1"), "UTF-8");
            userData.put("screen_name", nickname);
            userData.put("gender", jsonData.getString("sex").toString());
            userData.put("headimg", jsonData.getString("headimgurl").toString());
        } finally {
            userInfo = null;
        }
        return userData;
