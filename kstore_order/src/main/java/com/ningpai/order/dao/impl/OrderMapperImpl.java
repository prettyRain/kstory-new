...
public class OrderMapperImpl extends BasicSqlSupport implements OrderMapper {
    ...
    /**
     * 保存订单旧地址
     * @param orderOldAddress
     */
    @Override
    public void saveOrderOldAddress(OrderOldAddress orderOldAddress) {
            this.insert("com.ningpai.web.dao.OrderMapper.saveOrderOldAddress",orderOldAddress);
    }
    ...
    public OrderOldAddress queryOldOrder(Long orderId) {
        return this.selectOne("com.ningpai.web.dao.OrderMapper.queryOldOrder",orderId);
    }

    @Override
    public void updateOrderAddressState(Map map) {
        this.update("com.ningpai.web.dao.OrderMapper.updateOrderAddressState",map);
    }
    ...
    public String isOrderGargo(long l) {
        return this.selectOne("com.ningpai.web.dao.OrderMapper.isOrderGargo",l);
    ...
    public String queryUpdateStateByOrderId(Long orderId) {
        return this.selectOne("com.ningpai.web.dao.OrderMapper.queryUpdateStateByOrderId",orderId);
    }

    @Override
    public Long isOrderOldAddress(long l) {
        return this.selectOne("com.ningpai.web.dao.OrderMapper.isOrderOldAddress",l);
    }
    //根据 订单ID查找配送信息
    @Override
    public OrderDistribution queryOrderDistributionByOrderId(Long orderId) {
        return this.selectOne("com.ningpai.web.dao.OrderMapper.queryOrderDistributionByOrderId",orderId);
    }
    //修改配送信息
    @Override
    public void updateOrderDistribution(OrderDistribution orderDistribution) {
        this.update("com.ningpai.web.dao.OrderMapper.updateOrderDistribution",orderDistribution);
    }
    //保存配送信息
    @Override
    public void saveOrderDistribution(OrderDistribution orderDistribution) {
        this.insert("com.ningpai.web.dao.OrderMapper.saveOrderDistribution",orderDistribution);
    }

    @Override
    public String findOrderStatus(Map<String, Long> map) {
        return this.selectOne("com.ningpai.web.dao.OrderMapper.findOrderStatus",map);
    }
   //添加消息提醒
    @Override
    public void addNotive(OrderNotice notive) {
         this.insert("com.ningpai.web.dao.OrderMapper.addNotive",notive);
    }

    @Override
    public List<Order> queryNoticeOrder() {
        return selectList("com.ningpai.web.dao.OrderMapper.queryNoticeOrder");
    }

    @Override
    public List<OrderNotice> queryNoticeOrders(Long orderId) {
        return this.selectList("com.ningpai.web.dao.OrderMapper.queryNoticeOrders",orderId);
    }

    @Override
    public void updategiftcardPrice(Map<String, Object> map) {
        this.update("com.ningpai.web.dao.OrderMapper.updategiftcardPrice",map);
    }
    ...
    public List queryOrderIdByStatus(String status) {
        return this.selectList("com.ningpai.web.dao.OrderMapper.queryOrderIdByStatus",status);
    }
    ...
    public int synOrderSuccess(Long orderId) {
        return this.update("com.ningpai.web.dao.OrderMapper.synOrderSuccess",orderId);
    }
    ...
    public List querySynOrder() {
        return this.selectList("com.ningpai.web.dao.OrderMapper.querySynOrder");
    }
