...
public interface ShoppingCartService {
     ...
     * @return
     */
    Map<String, Object> getNewExpressPrice(ShoppingCartWareUtil wareUtil,HttpServletRequest request,Long addressId, Long cityId,
            Long[] cartIds,Long isbuynow);
    ...
    int addShoppingCart(ShoppingCart shoppingCart, HttpServletRequest request,
            HttpServletResponse response,Long mark) throws UnsupportedEncodingException;
    ...
    Map<String, Object> subBuyNowMap(HttpServletRequest request, ShoppingCart shoppingCart,ShoppingCartWareUtil wareUtil,PointSet pointSet);
}
